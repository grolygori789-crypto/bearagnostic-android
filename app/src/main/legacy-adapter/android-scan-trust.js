(() => {
  ...
  "en": {
    ...
    "issues": "Access/read issues",
    "types": "File types reviewed",
    "photo": "Photos",
    "video": "Videos",
    "audio": "Audio",
    "document": "Documents",
    ...
    "whyTitle": "Why did this finish so fast?",
    "truthFooter": "Time is not proof. The work actually performed is.",
  ...
  "th": {
    "title": "หลักฐานการสแกน",
    "files": "ไฟล์ที่ตรวจ",
    "folders": "โฟลเดอร์ที่ตรวจ",
    "data": "ข้อมูลที่อ่าน",
    "duration": "ระยะเวลา",
    ...
    "full": "ยืนยันครบ",
    "partial": "ไม่ครบ",
    "metadata": "ตรวจ Metadata",
    "issues": "ปัญหาการเข้าถึง/อ่าน",
    "types": "ประเภทไฟล์ที่ตรวจ",
    "photo": "รูปภาพ",
    "video": "วิดีโอ",
    "audio": "เสียง",
    "document": "เอกสาร",
    ...
    "whyTitle": "ทำไมสแกนครั้งนี้จบเร็ว?",
    "truthFooter": "เราไม่ใช้เวลาที่นานเป็นหลักฐาน — ใช้งานที่ตรวจจริงเป็นหลักฐาน",
  ...
  "ja": {
    ...
    "whyTitle": "なぜこんなに早く終わった？",
    "truthFooter": "時間ではなく、実際に行った作業を証拠にします。",
  ...
  "es": {
    "title": "Evidencia del análisis",
    "files": "Archivos revisados",
    "folders": "Carpetas visitadas",
    "data": "Datos leídos",
    "duration": "Duración",
    "coverage": "Cobertura",
    "hashed": "Hasheado",
    ...
    "issues": "Problemas de acceso/lectura",
    "types": "Tipos de archivo revisados",
    "photo": "Fotos",
    "video": "Vídeos",
    "audio": "Audio",
    "document": "Documentos",
    ...
    "quick": "Quick revisa metadatos en el almacenamiento compartido accesible. Bearagnostic nunca añade esperas falsas.",
    "smart": "Smart toma una muestra de hasta 256 KB de cada archivo legible no vacío y verifica candidatos de duplicados enfocados.",
    "deep": "Deep lee por streaming cada archivo legible no vacío. FULL solo se muestra cuando los bytes esperados coinciden con los realmente leídos.",
    "custom": "Custom revisa solo las ubicaciones seleccionadas y verifica duplicados exactos únicamente cuando esa opción está activada.",
    "truthTitle": "Rápido por diseño. Nunca alargado artificialmente.",
    "truthBody": "Sin esperas artificiales: cada modo termina cuando acaba su trabajo real. Los resultados muestran lo que realmente se revisó.",
    "whyTitle": "¿Por qué terminó tan rápido?",
    "truthFooter": "El tiempo no es una prueba. El trabajo realizado sí lo es.",
    "whyQuick": "Quick analiza metadatos en el almacenamiento compartido accesible y omite intencionalmente la lectura de contenido y el hashing de duplicados. Es normal que tarde muy poco.",
    "whySmart": "Smart lee una muestra real y limitada —hasta 256 KB de cada archivo legible no vacío— y calcula hashes solo de candidatos relevantes a duplicados. Mantiene la profundidad prometida sin perder tiempo.",
    "whyDeepFull": "Este Deep Scan no terminó antes de tiempo. Completó la lectura prevista y la evidencia coincidió. La velocidad del almacenamiento y la cantidad y distribución de archivos pueden hacer que un análisis completo termine mucho antes de lo esperado.",
    "whyDeepPartial": "Este Deep Scan terminó rápido, pero parte del trabajo previsto no se verificó por completo. El resultado sigue siendo PARCIAL; revisa la evidencia de acceso/lectura anterior.",
    "whyCustom": "Custom revisa las ubicaciones seleccionadas con análisis de metadatos y realiza verificación de duplicados exactos solo si la activaste. El tiempo depende mucho del ámbito elegido."
  },
  "pt-BR": {
    "title": "Evidências do scan",
    "files": "Arquivos revisados",
    "folders": "Pastas visitadas",
    "data": "Dados lidos",
    "duration": "Duração",
    "coverage": "Cobertura",
    "hashed": "Hasheado",
    ...
    "issues": "Problemas de acesso/leitura",
    "types": "Tipos de arquivo revisados",
    "photo": "Fotos",
    "video": "Vídeos",
    "audio": "Áudio",
    "document": "Documentos",
    ...
    "quick": "O Quick verifica metadados no armazenamento compartilhado acessível. O Bearagnostic nunca adiciona espera falsa.",
    "smart": "O Smart coleta até 256 KB de cada arquivo legível e não vazio e verifica candidatos focados a duplicados.",
    "deep": "O Deep lê por streaming cada arquivo legível e não vazio. FULL só é exibido quando os bytes esperados correspondem aos realmente lidos.",
    "custom": "O Custom verifica apenas os locais selecionados e verifica duplicados exatos somente quando essa opção está ativada.",
    "truthTitle": "Rápido por design. Nunca prolongado artificialmente.",
    "truthBody": "Sem espera artificial: cada modo termina quando o trabalho real é concluído. Os resultados mostram o que foi realmente verificado.",
    "whyTitle": "Por que terminou tão rápido?",
    "truthFooter": "Tempo não é prova. O trabalho realmente executado é.",
    "whyQuick": "O Quick analisa metadados no armazenamento compartilhado acessível e pula intencionalmente a leitura de conteúdo e o hash de duplicados. Tempos muito curtos são normais.",
    "whySmart": "O Smart lê uma amostra real e limitada — até 256 KB de cada arquivo legível e não vazio — e calcula hash apenas dos candidatos relevantes a duplicados. Mantém a profundidade prometida sem desperdiçar tempo.",
    "whyDeepFull": "Este Deep Scan não parou antes da hora. A leitura prevista foi concluída e as evidências corresponderam. A velocidade do armazenamento e a quantidade e distribuição dos arquivos podem fazer um scan completo terminar muito antes do esperado.",
    "whyDeepPartial": "Este Deep Scan terminou rápido, mas parte do trabalho previsto não foi totalmente verificada. O resultado permanece PARCIAL; revise as evidências de acesso/leitura acima.",
    "whyCustom": "O Custom verifica os locais selecionados com análise de metadados e faz verificação de duplicados exatos apenas quando você a ativa. O tempo depende muito do escopo escolhido."
  }
};
