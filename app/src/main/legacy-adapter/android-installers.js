(() => {
  ...
  "en": {
    ...
    "refresh": "Refresh",
    "filterAll": "All",
    "filterOlder": "Older installer",
    "filterInstalled": "Installed",
    "filterNewer": "Newer installer",
    "filterNotInstalled": "Not installed",
    "filterContext": "Needs context",
    ...
    "noFilter": "No installer files match this filter.",
    "showMore": "Show more installers",
    ...
    "resultTitle": "APK installer cleanup complete",
    "reclaimed": "verified space reclaimed",
    "removed": "files removed",
    "protected": "kept by safety",
    "failed": "not removed",
    "resultBody": "Only APK files Android confirmed as gone are counted as removed or reclaimed.",
    "reviewRemaining": "Review remaining",
    "done": "Done",
    "errorTitle": "APK Installers could not continue",
    "retry": "Try again",
    "scanFailed": "The Quick Scan could not start.",
    "anotherScan": "Another checkup is already running. APK Installers will refresh when it finishes.",
    "statusLoading": "Checking…",
    "statusOlder": "Older installer",
    "statusOlderSub": "The installed app is newer than this APK.",
    "statusSame": "Installed",
    "statusSameSub": "The installed app matches this APK version.",
    "statusNewer": "Newer installer",
    "statusNewerSub": "This APK is newer than the installed app and may be an update package.",
    "statusInstalled": "Installed",
    "statusInstalledSub": "An installed package with verified signing identity was found.",
    "statusUnverified": "Installed package found",
    "statusUnverifiedSub": "Package name matched, but signing identity could not be verified.",
    "statusMismatch": "Identity mismatch",
    "statusMismatchSub": "Package name matched an installed app, but the signing identity differs.",
    "statusNotInstalled": "Not installed",
    "statusNotInstalledSub": "No installed package was found on this Android version.",
    "statusUnknown": "Not confirmed",
    "statusUnknownSub": "Android package visibility may prevent a definitive installed-app check.",
    "statusUnavailable": "Metadata unavailable",
    "statusUnavailableSub": "Bearagnostic could not read reliable APK package metadata.",
    "packageLabel": "Package",
    "versionLabel": "APK version",
  ...
  "th": {
    ...
    "installers": "ไฟล์ติดตั้ง",
    "totalSize": "ขนาดรวม",
    "installed": "ยืนยันว่าติดตั้งแล้ว",
    "older": "ตัวติดตั้งเวอร์ชันเก่า",
    ...
    "refresh": "ตรวจใหม่",
    "filterAll": "ทั้งหมด",
    "filterOlder": "ตัวติดตั้งเก่า",
    "filterInstalled": "ติดตั้งแล้ว",
    "filterNewer": "ตัวติดตั้งใหม่กว่า",
    "filterNotInstalled": "ยังไม่ได้ติดตั้ง",
    "filterContext": "ต้องตรวจบริบท",
    "sortStatus": "เรียงตามสถานะ",
    ...
    "noFilter": "ไม่มีไฟล์ติดตั้งในตัวกรองนี้",
    ...
    "resultTitle": "จัดการไฟล์ติดตั้ง APK เสร็จแล้ว",
    "reclaimed": "พื้นที่ที่คืนได้จริง",
    "removed": "ไฟล์ที่ลบแล้ว",
    "protected": "ไฟล์ที่ระบบป้องกันไว้",
    "failed": "ไฟล์ที่ลบไม่สำเร็จ",
    "resultBody": "นับเฉพาะไฟล์ APK ที่ Android ยืนยันว่าหายไปแล้วเท่านั้น ทั้งจำนวนไฟล์และพื้นที่ที่คืนได้",
    "reviewRemaining": "ตรวจไฟล์ที่เหลือ",
    "done": "เสร็จสิ้น",
    "errorTitle": "ไม่สามารถดำเนินการตรวจไฟล์ติดตั้ง APK ต่อได้",
    "retry": "ลองอีกครั้ง",
    "scanFailed": "ไม่สามารถเริ่ม Quick Scan ได้",
    "anotherScan": "มีการตรวจอื่นกำลังทำงานอยู่ APK Installers จะอัปเดตเมื่อการตรวจนั้นเสร็จ",
    "statusLoading": "กำลังตรวจ…",
    "statusOlder": "ตัวติดตั้งเวอร์ชันเก่า",
    "statusOlderSub": "แอปที่ติดตั้งอยู่เป็นเวอร์ชันใหม่กว่าไฟล์ APK นี้",
    "statusSame": "ติดตั้งแล้ว",
    "statusSameSub": "แอปที่ติดตั้งอยู่ตรงกับเวอร์ชันของไฟล์ APK นี้",
    "statusNewer": "ตัวติดตั้งใหม่กว่า",
    "statusNewerSub": "ไฟล์ APK นี้ใหม่กว่าแอปที่ติดตั้งอยู่ และอาจเป็นแพ็กเกจอัปเดต",
    "statusInstalled": "ติดตั้งแล้ว",
    "statusInstalledSub": "พบแพ็กเกจที่ติดตั้งอยู่และยืนยัน signing identity ตรงกัน",
    "statusUnverified": "พบแพ็กเกจที่ติดตั้งอยู่",
    "statusUnverifiedSub": "ชื่อแพ็กเกจตรงกัน แต่ยังยืนยัน signing identity ไม่ได้",
    "statusMismatch": "ตัวตนไม่ตรงกัน",
    "statusMismatchSub": "ชื่อแพ็กเกจตรงกับแอปที่ติดตั้งอยู่ แต่ signing identity ต่างกัน",
    "statusNotInstalled": "ยังไม่ได้ติดตั้ง",
    "statusNotInstalledSub": "ไม่พบแพ็กเกจที่ติดตั้งอยู่บน Android เวอร์ชันนี้",
    "statusUnknown": "ยังยืนยันไม่ได้",
    "statusUnknownSub": "กฎ package visibility ของ Android อาจจำกัดการตรวจสถานะแอปที่ติดตั้งอยู่",
    "statusUnavailable": "อ่านข้อมูลแพ็กเกจไม่ได้",
    "statusUnavailableSub": "Bearagnostic ไม่สามารถอ่านข้อมูลแพ็กเกจ APK ที่เชื่อถือได้",
    "packageLabel": "แพ็กเกจ",
    "versionLabel": "เวอร์ชัน APK",
    "installedVersionLabel": "เวอร์ชันที่ติดตั้ง"
  },
  "ja": {
    ...
    "refresh": "再確認",
    "filterAll": "すべて",
    "filterOlder": "古いインストーラー",
    "filterInstalled": "インストール済み",
    "filterNewer": "新しいインストーラー",
    ...
    "noFilter": "このフィルターに一致するインストーラーはありません。",
    "showMore": "さらに表示",
    "dateUnknown": "日付情報なし",
    ...
    "resultTitle": "APK インストーラーの整理が完了しました",
    "reclaimed": "確認済み空き容量",
    "removed": "削除済み",
    "protected": "安全保護",
    "failed": "未削除",
    "resultBody": "Android が実際に消えたと確認した APK だけを、削除件数と回収容量に数えます。",
    "reviewRemaining": "残りを確認",
    "done": "完了",
    "errorTitle": "APK Installers を続行できません",
    "retry": "再試行",
    "scanFailed": "Quick Scan を開始できませんでした。",
    "anotherScan": "別のチェックが実行中です。完了後に APK Installers を更新します。",
    "statusLoading": "確認中…",
    "statusOlder": "古いインストーラー",
    "statusOlderSub": "インストール済みアプリのほうがこの APK より新しいバージョンです。",
    "statusSame": "インストール済み",
    "statusSameSub": "インストール済みアプリとこの APK のバージョンが一致します。",
    "statusNewer": "新しいインストーラー",
    "statusNewerSub": "この APK はインストール済みアプリより新しく、更新パッケージの可能性があります。",
    "statusInstalled": "インストール済み",
    "statusInstalledSub": "署名 ID が一致するインストール済みパッケージを確認しました。",
    "statusUnverified": "インストール済みパッケージを確認",
    "statusUnverifiedSub": "パッケージ名は一致しましたが、署名 ID を確認できませんでした。",
    "statusMismatch": "ID 不一致",
    "statusMismatchSub": "パッケージ名は一致しましたが、インストール済みアプリと署名 ID が異なります。",
    "statusNotInstalled": "未インストール",
    "statusNotInstalledSub": "この Android バージョンではインストール済みパッケージが見つかりませんでした。",
    "statusUnknown": "未確認",
    "statusUnknownSub": "Android の package visibility によりインストール状態を確定できない場合があります。",
    "statusUnavailable": "メタデータ利用不可",
    "statusUnavailableSub": "信頼できる APK パッケージ情報を読み取れませんでした。",
    "packageLabel": "パッケージ",
    "versionLabel": "APK バージョン",
    "installedVersionLabel": "インストール済みバージョン"
  },
  "es": {
    "toolTitle": "Instaladores APK",
    "toolSub": "Revisar archivos de instalación",
    "kicker": "INSTALADORES APK",
    "title": "Comprende para qué sirve cada archivo de instalación.",
    "lead": "Un APK es un archivo de instalación, no la app instalada. Eliminar un APK no desinstala una app que ya está instalada.",
    "close": "Cerrar",
    "source": "FUENTE",
    "coverage": "COBERTURA",
    "safety": "SEGURIDAD",
    ...
    "accessBody": "Android debe permitir el acceso al almacenamiento compartido antes de que Bearagnostic pueda revisar archivos instaladores APK.",
    "openSettings": "Abrir ajustes de Android",
    "noSnapshotTitle": "Busca instaladores APK primero",
    "noSnapshotBody": "Ejecuta un Quick Scan para localizar archivos APK en el almacenamiento compartido accesible. Quick solo lee metadatos del sistema de archivos y no elimina nada.",
    "runQuick": "Ejecutar Quick Scan",
    "scanningTitle": "Buscando instaladores APK",
    ...
    "scanningHint": "Los detalles de los instaladores aparecerán cuando termine la revisión actual.",
    "installers": "Instaladores",
    "totalSize": "Tamaño total",
    "installed": "Instalado",
    "older": "Instaladores antiguos",
    "metadataProgress": "Leyendo metadatos locales del paquete · {done}/{total}",
    "metadataDone": "Metadatos del paquete revisados localmente",
    "cautionTitle": "APK no significa basura",
    "cautionBody": "Los instaladores pueden ser copias de seguridad, paquetes de actualización o archivos que aún necesites. Bearagnostic nunca selecciona archivos APK automáticamente.",
    "visibilityTitle": "Desconocido no significa no instalado",
    "visibilityBody": "En Android 11 y versiones posteriores, las reglas de visibilidad de paquetes pueden impedir que Bearagnostic confirme algunas apps instaladas. “No confirmado” es deliberadamente conservador.",
    "partialTitle": "La lista de revisión es parcial",
    "partialBody": "La instantánea de seguridad actual alcanzó el límite de detalle de revisión. Solo se pueden seleccionar los archivos instaladores representados aquí.",
    "customTitle": "Ámbito personalizado",
    "customBody": "Esta instantánea proviene de ubicaciones seleccionadas en Custom Scan. Los archivos APK fuera de ellas no están representados.",
    ...
    "refresh": "Actualizar",
    "filterAll": "Todos",
    "filterOlder": "Instalador antiguo",
    "filterInstalled": "Instalado",
    "filterNewer": "Instalador más reciente",
    "filterNotInstalled": "No instalado",
    "filterContext": "Necesita contexto",
    "sortStatus": "Estado primero",
    "sortLargest": "Más grandes primero",
    "sortNewest": "Más recientes primero",
    "sortOldest": "Más antiguos primero",
    "sortName": "Nombre A–Z",
    "selectionTitle": "Elige solo archivos de instalación que reconozcas y ya no necesites",
    "showing": "Mostrando {shown} de {total}",
    "selected": "{count} seleccionados · {bytes}",
    "clear": "Limpiar",
    "reviewSelected": "Revisar seleccionados",
    "noFilesTitle": "No se detectaron instaladores APK en esta instantánea",
    "noFilesBody": "No hay identidades de instaladores APK disponibles en la instantánea de revisión actual. No se eliminó nada.",
    "noFilter": "Ningún archivo instalador coincide con este filtro.",
    "showMore": "Mostrar más instaladores",
    ...
    "finalTitle": "¿Eliminar los archivos instaladores APK seleccionados?",
    "finalBody": "Esto elimina permanentemente solo los archivos APK seleccionados. No desinstala apps instaladas. Conserva cualquier instalador que aún quieras como copia de seguridad.",
    "protection": "La seguridad de eliminación nativa sigue activa. Si un APK seleccionado también forma parte de un grupo de duplicados verificado, la protección de conservar una copia sigue aplicándose.",
    ...
    "resultTitle": "Limpieza de instaladores APK completada",
    ...
    "resultBody": "Solo se cuentan como eliminados o recuperados los APK que Android confirmó que ya no existen.",
    "reviewRemaining": "Revisar restantes",
    "done": "Listo",
    "errorTitle": "La revisión de instaladores APK no pudo continuar",
    "retry": "Intentar de nuevo",
    "scanFailed": "No se pudo iniciar Quick Scan.",
    "anotherScan": "Ya hay otra revisión en curso. APK Installers se actualizará cuando termine.",
    "statusLoading": "Comprobando…",
    "statusOlder": "Instalador antiguo",
    "statusOlderSub": "La app instalada es más reciente que este APK.",
    "statusSame": "Instalado",
    "statusSameSub": "La app instalada coincide con la versión de este APK.",
    "statusNewer": "Instalador más reciente",
    "statusNewerSub": "Este APK es más reciente que la app instalada y puede ser un paquete de actualización.",
    "statusInstalled": "Instalado",
    "statusInstalledSub": "Se encontró un paquete instalado con identidad de firma verificada.",
    "statusUnverified": "Paquete instalado encontrado",
    "statusUnverifiedSub": "El nombre del paquete coincide, pero no se pudo verificar la identidad de firma.",
    "statusMismatch": "Identidad no coincidente",
    "statusMismatchSub": "El nombre del paquete coincide con una app instalada, pero la identidad de firma es distinta.",
    "statusNotInstalled": "No instalado",
    "statusNotInstalledSub": "No se encontró ningún paquete instalado en esta versión de Android.",
    "statusUnknown": "No confirmado",
    "statusUnknownSub": "La visibilidad de paquetes de Android puede impedir una comprobación definitiva de apps instaladas.",
    "statusUnavailable": "Metadatos no disponibles",
    "statusUnavailableSub": "Bearagnostic no pudo leer metadatos fiables del paquete APK.",
    "packageLabel": "Paquete",
    "versionLabel": "Versión del APK",
    "installedVersionLabel": "Versión instalada"
  },
  "pt-BR": {
    "toolTitle": "Instaladores APK",
    "toolSub": "Revisar arquivos de instalação",
    "kicker": "INSTALADORES APK",
    "title": "Entenda para que serve cada arquivo de instalação.",
    "lead": "Um APK é um arquivo de instalação, não o app instalado. Remover um APK não desinstala um app que já esteja instalado.",
    "close": "Fechar",
    "source": "FONTE",
    "coverage": "COBERTURA",
    "safety": "SEGURANÇA",
    ...
    "accessBody": "O Android precisa permitir acesso ao armazenamento compartilhado antes que o Bearagnostic possa revisar arquivos instaladores APK.",
    "openSettings": "Abrir configurações do Android",
    "noSnapshotTitle": "Verifique instaladores APK primeiro",
    "noSnapshotBody": "Execute um Quick Scan para localizar arquivos APK no armazenamento compartilhado acessível. O Quick lê apenas metadados do sistema de arquivos e não exclui nada.",
    "runQuick": "Executar Quick Scan",
    "scanningTitle": "Procurando instaladores APK",
    ...
    "scanningHint": "Os detalhes dos instaladores aparecerão quando a verificação atual terminar.",
    "installers": "Instaladores",
    "totalSize": "Tamanho total",
    "installed": "Instalado",
    "older": "Instaladores antigos",
    "metadataProgress": "Lendo metadados locais do pacote · {done}/{total}",
    "metadataDone": "Metadados do pacote verificados localmente",
    "cautionTitle": "APK não significa lixo",
    "cautionBody": "Instaladores podem ser backups, pacotes de atualização ou arquivos que você ainda precisa. O Bearagnostic nunca seleciona arquivos APK automaticamente.",
    "visibilityTitle": "Desconhecido não significa não instalado",
    "visibilityBody": "No Android 11 e versões mais recentes, as regras de visibilidade de pacotes podem impedir o Bearagnostic de confirmar alguns apps instalados. “Não confirmado” é intencionalmente conservador.",
    "partialTitle": "A lista de revisão é parcial",
    "partialBody": "O snapshot de segurança atual atingiu o limite de detalhes da revisão. Apenas arquivos instaladores representados aqui podem ser selecionados.",
    "customTitle": "Escopo personalizado",
    "customBody": "Este snapshot veio de locais selecionados no Custom Scan. Arquivos APK fora desses locais não estão representados.",
    ...
    "refresh": "Atualizar",
    "filterAll": "Todos",
    "filterOlder": "Instalador antigo",
    "filterInstalled": "Instalado",
    "filterNewer": "Instalador mais recente",
    "filterNotInstalled": "Não instalado",
    "filterContext": "Precisa de contexto",
    "sortStatus": "Status primeiro",
    "sortLargest": "Maiores primeiro",
    "sortNewest": "Mais recentes primeiro",
    "sortOldest": "Mais antigos primeiro",
    "sortName": "Nome A–Z",
    "selectionTitle": "Escolha apenas arquivos de instalação que você reconhece e não precisa mais",
    "showing": "Mostrando {shown} de {total}",
    "selected": "{count} selecionados · {bytes}",
    "clear": "Limpar",
    "reviewSelected": "Revisar selecionados",
    "noFilesTitle": "Nenhum instalador APK apareceu neste snapshot",
    "noFilesBody": "Nenhuma identidade de instalador APK está disponível no snapshot de revisão atual. Nada foi removido.",
    "noFilter": "Nenhum arquivo instalador corresponde a este filtro.",
    "showMore": "Mostrar mais instaladores",
    ...
    "finalTitle": "Remover os arquivos instaladores APK selecionados?",
    "finalBody": "Isso remove permanentemente apenas os arquivos APK selecionados. Não desinstala apps instalados. Mantenha qualquer instalador que ainda queira como backup.",
    "protection": "A segurança de exclusão nativa permanece ativa. Se um APK selecionado também fizer parte de um grupo de duplicados verificado, a proteção de manter uma cópia continua valendo.",
    ...
    "resultTitle": "Limpeza de instaladores APK concluída",
    "reclaimed": "espaço recuperado verificado",
    "removed": "arquivos removidos",
    "protected": "mantidos por segurança",
    "failed": "não removidos",
    "resultBody": "Somente arquivos APK que o Android confirmou como removidos contam como excluídos ou espaço recuperado.",
    "reviewRemaining": "Revisar restantes",
    "done": "Concluído",
    "errorTitle": "A revisão de instaladores APK não pôde continuar",
    "retry": "Tentar novamente",
    "scanFailed": "Não foi possível iniciar o Quick Scan.",
    "anotherScan": "Outra verificação já está em andamento. A revisão de APKs será atualizada quando ela terminar.",
    "statusLoading": "Verificando…",
    "statusOlder": "Instalador antigo",
    "statusOlderSub": "O app instalado é mais recente que este APK.",
    "statusSame": "Instalado",
    "statusSameSub": "O app instalado corresponde à versão deste APK.",
    "statusNewer": "Instalador mais recente",
    "statusNewerSub": "Este APK é mais recente que o app instalado e pode ser um pacote de atualização.",
    "statusInstalled": "Instalado",
    "statusInstalledSub": "Foi encontrado um pacote instalado com identidade de assinatura verificada.",
    "statusUnverified": "Pacote instalado encontrado",
    "statusUnverifiedSub": "O nome do pacote corresponde, mas não foi possível verificar a identidade da assinatura.",
    "statusMismatch": "Identidade divergente",
    "statusMismatchSub": "O nome do pacote corresponde a um app instalado, mas a identidade da assinatura é diferente.",
    "statusNotInstalled": "Não instalado",
    "statusNotInstalledSub": "Nenhum pacote instalado foi encontrado nesta versão do Android.",
    "statusUnknown": "Não confirmado",
    "statusUnknownSub": "A visibilidade de pacotes do Android pode impedir uma verificação definitiva de apps instalados.",
    "statusUnavailable": "Metadados indisponíveis",
    "statusUnavailableSub": "O Bearagnostic não conseguiu ler metadados confiáveis do pacote APK.",
    "packageLabel": "Pacote",
    "versionLabel": "Versão do APK",
  ...
  function ensureSurface() {
    ...
    surface.innerHTML = `
      <header class="ba-installers-head">
        ...
        <button class="ba-installers-close" type="button" data-installer-action="close" aria-label="${esc(window.BearagnosticLaunchLocales?.a11y?.('close') || c().close)}">×</button>
      </header>
  ...
  function renderResults() {
    ...
    return `${baseIntro()}
      ...
      <div class="ba-installers-controls">
        <select class="ba-installers-select" data-installer-control="filter" aria-label="${esc(window.BearagnosticLaunchLocales?.a11y?.('filter') || 'Filter')}">
        ...
        <select class="ba-installers-select" data-installer-control="sort" aria-label="${esc(window.BearagnosticLaunchLocales?.a11y?.('sort') || 'Sort')}">
