(() => {
  ...
  "es": {
    "toolTitle": "Descargas",
    "toolSub": "Revisar archivos descargados",
    "kicker": "REVISIÓN DE DESCARGAS",
    "title": "Mira qué se ha acumulado en Descargas.",
    "lead": "Descargas es una ubicación, no una sentencia de basura. Revisa cada archivo antes de decidir qué eliminar.",
    "close": "Cerrar",
    "source": "FUENTE",
    "coverage": "COBERTURA",
    "safety": "SEGURIDAD",
    "sourceSnapshot": "Revisión actual",
    "fullCoverage": "Descargas accesibles",
    "customCoverage": "Ámbito Custom seleccionado",
    "reviewFirst": "Revisar primero",
    "accessTitle": "Se necesita acceso al almacenamiento",
    "accessBody": "Android debe permitir el acceso al almacenamiento compartido antes de que Bearagnostic pueda revisar archivos en Descargas.",
    "openSettings": "Abrir ajustes de Android",
    "noSnapshotTitle": "Revisa Descargas primero",
    "noSnapshotBody": "Ejecuta un Quick Scan para crear una instantánea local de revisión actual. Quick solo lee metadatos de archivos y no elimina nada.",
    "runQuick": "Ejecutar Quick Scan",
    "scanningTitle": "Revisando Descargas",
    "scanningBody": "Bearagnostic utiliza el trabajo real del escáner sobre el sistema de archivos. No se añade tiempo de espera ni progreso falso.",
    "scanningHint": "Los resultados aparecerán cuando termine la revisión actual.",
    "files": "Archivos",
    ...
    "justNow": "ahora mismo",
    "minAgo": "min atrás",
    "cautionTitle": "Un archivo descargado puede seguir siendo importante",
    "cautionBody": "Documentos, fotos, vídeos, instaladores y archivos comprimidos pueden estar aquí con motivo. Nada en Descargas se selecciona automáticamente.",
    "partialTitle": "La lista de revisión es parcial",
    "partialBody": "La instantánea de seguridad actual alcanzó el límite de detalle de revisión. Solo se pueden seleccionar los archivos representados en esta instantánea.",
    "customTitle": "Ámbito personalizado",
    "customBody": "Esta instantánea proviene de ubicaciones seleccionadas en Custom Scan. Los archivos fuera de esas ubicaciones no están representados.",
    "checkAll": "Revisar todo el almacenamiento accesible",
    "filterAll": "Todos",
    "filterPhotos": "Fotos",
    "filterVideos": "Vídeos",
    "filterDocs": "Documentos",
    "filterPackages": "APK y archivos comprimidos",
    "filterAudio": "Audio",
    "filterOther": "Otros",
    ...
    "sortName": "Nombre A–Z",
    "selectionTitle": "Elige solo archivos que reconozcas y ya no necesites",
    "showing": "Mostrando {shown} de {total}",
    "selected": "{count} seleccionados · {bytes}",
    "clear": "Limpiar",
    "reviewSelected": "Revisar seleccionados",
    "noFilesTitle": "No se detectaron archivos de Descargas en esta instantánea",
    "noFilesBody": "No hay identidades de archivos descargados disponibles en la instantánea de revisión actual. No se eliminó nada.",
    "noFilter": "Ningún archivo coincide con este filtro.",
    "showMore": "Mostrar más archivos",
    ...
    "finalTitle": "¿Eliminar los archivos descargados seleccionados?",
    "finalBody": "Esto elimina permanentemente solo los archivos seleccionados. Estar en Descargas no significa que un archivo sea seguro de eliminar.",
    ...
    "resultTitle": "Limpieza de Descargas completada",
    ...
    "done": "Listo",
    "errorTitle": "La revisión de Descargas no pudo continuar",
    "retry": "Intentar de nuevo",
    "scanFailed": "No se pudo iniciar Quick Scan.",
    "anotherScan": "Ya hay otra revisión en curso. La revisión de Descargas se actualizará cuando termine.",
    "kindImage": "Foto",
    "kindVideo": "Vídeo",
    "kindAudio": "Audio",
  ...
  "pt-BR": {
    "toolTitle": "Downloads",
    "toolSub": "Revisar arquivos baixados",
    "kicker": "REVISÃO DE DOWNLOADS",
    "title": "Veja o que se acumulou em Downloads.",
    "lead": "Downloads é um local, não um veredito de lixo. Revise cada arquivo antes de decidir o que remover.",
    "close": "Fechar",
    "source": "FONTE",
    "coverage": "COBERTURA",
    "safety": "SEGURANÇA",
    "sourceSnapshot": "Verificação atual",
    "fullCoverage": "Downloads acessíveis",
    "customCoverage": "Escopo Custom selecionado",
    "reviewFirst": "Revisar primeiro",
    "accessTitle": "É necessário acesso ao armazenamento",
    "accessBody": "O Android precisa permitir acesso ao armazenamento compartilhado antes que o Bearagnostic possa revisar arquivos em Downloads.",
    "openSettings": "Abrir configurações do Android",
    "noSnapshotTitle": "Verifique Downloads primeiro",
    "noSnapshotBody": "Execute um Quick Scan para criar um snapshot local de revisão atual. O Quick lê apenas metadados dos arquivos e não exclui nada.",
    "runQuick": "Executar Quick Scan",
    "scanningTitle": "Verificando Downloads",
    "scanningBody": "O Bearagnostic usa o trabalho real do scanner no sistema de arquivos. Nenhum tempo de espera ou progresso falso é adicionado.",
    "scanningHint": "Os resultados aparecerão quando a verificação atual terminar.",
    "files": "Arquivos",
    ...
    "justNow": "agora mesmo",
    "minAgo": "min atrás",
    "cautionTitle": "Um arquivo baixado ainda pode ser importante",
    "cautionBody": "Documentos, fotos, vídeos, instaladores e arquivos compactados podem estar aqui por bons motivos. Nada em Downloads é selecionado automaticamente.",
    "partialTitle": "A lista de revisão é parcial",
    "partialBody": "O snapshot de segurança atual atingiu o limite de detalhes da revisão. Apenas os arquivos representados neste snapshot podem ser selecionados.",
    "customTitle": "Escopo personalizado",
    "customBody": "Este snapshot veio de locais selecionados no Custom Scan. Arquivos fora desses locais não estão representados.",
    "checkAll": "Verificar todo o armazenamento acessível",
    "filterAll": "Todos",
    "filterPhotos": "Fotos",
    "filterVideos": "Vídeos",
    "filterDocs": "Documentos",
    "filterPackages": "APK e arquivos compactados",
    "filterAudio": "Áudio",
    "filterOther": "Outros",
    ...
    "sortName": "Nome A–Z",
    "selectionTitle": "Escolha apenas arquivos que você reconhece e não precisa mais",
    "showing": "Mostrando {shown} de {total}",
    "selected": "{count} selecionados · {bytes}",
    "clear": "Limpar",
    "reviewSelected": "Revisar selecionados",
    "noFilesTitle": "Nenhum arquivo de Downloads apareceu neste snapshot",
    "noFilesBody": "Nenhuma identidade de arquivo baixado está disponível no snapshot de revisão atual. Nada foi removido.",
    "noFilter": "Nenhum arquivo corresponde a este filtro.",
    "showMore": "Mostrar mais arquivos",
    ...
    "finalTitle": "Remover os arquivos baixados selecionados?",
    "finalBody": "Isso remove permanentemente apenas os arquivos selecionados. Estar em Downloads não significa que um arquivo seja seguro para excluir.",
    ...
    "resultTitle": "Limpeza de Downloads concluída",
    ...
    "reviewRemaining": "Revisar restantes",
    "done": "Concluído",
    "errorTitle": "A revisão de Downloads não pôde continuar",
    "retry": "Tentar novamente",
    "scanFailed": "Não foi possível iniciar o Quick Scan.",
    "anotherScan": "Outra verificação já está em andamento. A revisão de Downloads será atualizada quando ela terminar.",
    "kindImage": "Foto",
    "kindVideo": "Vídeo",
    "kindAudio": "Áudio",
    "kindDocument": "Documento",
  ...
  function ensureSurface() {
    ...
    surface.innerHTML = `
      <header class="ba-downloads-head">
        ...
        <button class="ba-downloads-close" type="button" data-download-action="close" aria-label="${esc(window.BearagnosticLaunchLocales?.a11y?.('close') || c().close)}">×</button>
      </header>
  ...
  function renderResults() {
    ...
    return `${baseIntro()}${triad()}
      ...
      <div class="ba-downloads-controls">
        <select class="ba-downloads-select" data-download-control="filter" aria-label="${esc(window.BearagnosticLaunchLocales?.a11y?.('filter') || 'Filter')}">
        ...
        <select class="ba-downloads-select" data-download-control="sort" aria-label="${esc(window.BearagnosticLaunchLocales?.a11y?.('sort') || 'Sort')}">
