(() => {
  ...
  "en": {
    ...
    "noFilter": "No zero-byte files match this filter.",
    "showMore": "Show more empty files",
    ...
    "resultTitle": "Zero-byte cleanup complete",
    "reclaimed": "verified space reclaimed",
    "removed": "files removed",
    "protected": "kept by safety",
    "failed": "not removed",
    "resultBody": "Only zero-byte files Android confirmed as gone are counted as removed.",
    "reviewRemaining": "Review remaining",
    "done": "Done",
    "errorTitle": "Zero-byte review could not continue",
    "retry": "Try again",
    "scanFailed": "The Quick Scan could not start.",
    "anotherScan": "Another checkup is already running. Zero-byte files will refresh when it finishes.",
    "kindDocuments": "DOC",
    "kindMedia": "MEDIA",
    "kindApk": "APK",
    "kindArchives": "ARCHIVE",
    "kindOther": "OTHER"
  },
  "th": {
    ...
    "noFilter": "ไม่มีไฟล์ 0 ไบต์ในตัวกรองนี้",
    "showMore": "แสดงไฟล์ว่างเพิ่ม",
    ...
    "resultTitle": "จัดการไฟล์ 0 ไบต์เสร็จแล้ว",
    "reclaimed": "พื้นที่ที่คืนได้จริง",
    "removed": "ไฟล์ที่ลบแล้ว",
    "protected": "ไฟล์ที่ระบบป้องกันไว้",
    "failed": "ไฟล์ที่ลบไม่สำเร็จ",
    "resultBody": "นับเฉพาะไฟล์ 0 ไบต์ที่ Android ยืนยันว่าหายไปแล้วเท่านั้น",
    "reviewRemaining": "ตรวจไฟล์ที่เหลือ",
    "done": "เสร็จสิ้น",
    "errorTitle": "ไม่สามารถดำเนินการตรวจไฟล์ 0 ไบต์ต่อได้",
    "retry": "ลองอีกครั้ง",
    "scanFailed": "ไม่สามารถเริ่ม Quick Scan ได้",
    "anotherScan": "มีการตรวจอื่นกำลังทำงานอยู่ รายการไฟล์ 0 ไบต์จะอัปเดตเมื่อการตรวจนั้นเสร็จ",
    "kindDocuments": "DOC",
    "kindMedia": "MEDIA",
    "kindApk": "APK",
    "kindArchives": "ARCHIVE",
  ...
  "ja": {
    ...
    "noFilter": "このフィルターに一致する 0 バイトファイルはありません。",
    "showMore": "空のファイルをさらに表示",
    "dateUnknown": "日付情報なし",
    ...
    "finalKicker": "最終確認",
    "finalTitle": "選択した 0 バイトファイルを削除しますか？",
    "finalBody": "選択した 0 バイトファイルだけを完全に削除します。Bearagnostic は 0 B だから不要だとは判断しません。",
    "selectedFiles": "選択ファイル",
    "selectedBytes": "選択サイズ",
    "protection": "Native の削除保護は引き続き有効です。選択した空ファイルが検証済み重複グループに属する場合は、1 つを残す保護も維持されます。",
    "back": "戻る",
    "deleteVerify": "削除して確認",
    "deleting": "削除して確認中…",
    "resultKicker": "検証済みクリーンアップ",
    "resultTitle": "0 バイトファイルの整理が完了しました",
    "reclaimed": "確認済み空き容量",
    "removed": "削除済み",
    "protected": "安全保護",
    "failed": "未削除",
    "resultBody": "Android が実際に消えたと確認した 0 バイトファイルだけを削除件数に数えます。",
    "reviewRemaining": "残りを確認",
    "done": "完了",
    "errorTitle": "0 バイトファイルを続行できません",
    "retry": "再試行",
    "scanFailed": "Quick Scan を開始できませんでした。",
    "anotherScan": "別のチェックが実行中です。完了後に 0 バイトファイルを更新します。",
    "kindDocuments": "DOC",
    "kindMedia": "MEDIA",
    "kindApk": "APK",
    "kindArchives": "ARCHIVE",
  ...
  "es": {
    "toolTitle": "Archivos de cero bytes",
    "toolSub": "Revisar archivos vacíos",
    "kicker": "ARCHIVOS DE CERO BYTES",
    "title": "Revisa los archivos vacíos antes de eliminarlos.",
    "lead": "Un archivo de cero bytes está vacío, pero puede ser un marcador intencional, un archivo auxiliar de exportación o un indicador de sincronización. Bearagnostic trata cada archivo de cero bytes como elemento que debe revisarse primero.",
    "close": "Cerrar",
    "source": "FUENTE",
    "coverage": "COBERTURA",
    "safety": "SEGURIDAD",
    ...
    "accessBody": "Android debe permitir el acceso al almacenamiento compartido antes de que Bearagnostic pueda revisar archivos de cero bytes.",
    "openSettings": "Abrir ajustes de Android",
    "noSnapshotTitle": "Busca archivos de cero bytes primero",
    "noSnapshotBody": "Ejecuta un Quick Scan para localizar archivos de cero bytes en el almacenamiento compartido accesible. Quick solo lee metadatos del sistema de archivos y no elimina nada.",
    "runQuick": "Ejecutar Quick Scan",
    "scanningTitle": "Buscando archivos de cero bytes",
    ...
    "scanningHint": "Los archivos de cero bytes aparecerán cuando termine la revisión actual.",
    "files": "Archivos de cero bytes",
    "totalSize": "Tamaño total",
    "largest": "Más grande",
    "checked": "Comprobado",
    "justNow": "ahora mismo",
    "minAgo": "min atrás",
    "cautionTitle": "Un archivo vacío puede ser intencional",
    "cautionBody": "Marcadores, archivos auxiliares de exportación, indicadores de sincronización o archivos centinela creados por apps pueden tener legítimamente 0 B. Nada se selecciona automáticamente.",
    "partialTitle": "La lista de revisión es parcial",
    "partialBody": "La instantánea de seguridad actual alcanzó el límite de detalle de revisión. Solo se pueden seleccionar los archivos de cero bytes representados aquí.",
    "customTitle": "Ámbito personalizado",
    "customBody": "Esta instantánea proviene de ubicaciones seleccionadas en Custom Scan. Los archivos de cero bytes fuera de esas ubicaciones no están representados.",
    "checkAll": "Revisar todo el almacenamiento accesible",
    "filterAll": "Todos",
    "filterDocuments": "Documentos",
    "filterMedia": "Multimedia",
    "filterApk": "APK",
    ...
    "selectionTitle": "Elige solo archivos vacíos que reconozcas y ya no necesites",
    "showing": "Mostrando {shown} de {total}",
    "selected": "{count} seleccionados · {bytes}",
    "clear": "Limpiar",
    "reviewSelected": "Revisar seleccionados",
    "noFilesTitle": "No se detectaron archivos de cero bytes en esta instantánea",
    "noFilesBody": "No hay identidades de archivos de cero bytes disponibles en la instantánea de revisión actual. No se eliminó nada.",
    "noFilter": "Ningún archivo de cero bytes coincide con este filtro.",
    "showMore": "Mostrar más archivos vacíos",
    ...
    "finalTitle": "¿Eliminar los archivos vacíos seleccionados?",
    "finalBody": "Esto elimina permanentemente solo los archivos vacíos seleccionados. Bearagnostic no supone que todos los archivos de 0 B sean desechables.",
    "selectedFiles": "archivos seleccionados",
    "selectedBytes": "tamaño seleccionado",
    "protection": "La seguridad de eliminación nativa sigue activa. Si un archivo vacío seleccionado también forma parte de un grupo de duplicados verificado, la protección de conservar una copia sigue aplicándose.",
    "back": "Atrás",
    "deleteVerify": "Eliminar y verificar",
    "deleting": "Eliminando y verificando…",
    "resultKicker": "LIMPIEZA VERIFICADA",
    "resultTitle": "Limpieza de archivos de cero bytes completada",
    ...
    "resultBody": "Solo se cuentan como eliminados los archivos de cero bytes que Android confirmó que ya no existen.",
    "reviewRemaining": "Revisar restantes",
    "done": "Listo",
    "errorTitle": "La revisión de archivos de cero bytes no pudo continuar",
    "retry": "Intentar de nuevo",
    "scanFailed": "No se pudo iniciar Quick Scan.",
    "anotherScan": "Ya hay otra revisión en curso. Los archivos de cero bytes se actualizarán cuando termine.",
    "kindDocuments": "DOC",
    "kindMedia": "MULTIMEDIA",
    "kindApk": "APK",
    "kindArchives": "ARCHIVO",
    "kindOther": "OTROS"
  },
  "pt-BR": {
    "toolTitle": "Arquivos de zero bytes",
    "toolSub": "Revisar arquivos vazios",
    "kicker": "ARQUIVOS DE ZERO BYTES",
    "title": "Revise arquivos vazios antes de removê-los.",
    "lead": "Um arquivo de zero bytes está vazio, mas ainda pode ser um marcador intencional, um stub de exportação ou um marcador de sincronização. O Bearagnostic trata cada arquivo de zero bytes como item que deve ser revisado primeiro.",
    "close": "Fechar",
    "source": "FONTE",
    "coverage": "COBERTURA",
    "safety": "SEGURANÇA",
    ...
    "accessBody": "O Android precisa permitir acesso ao armazenamento compartilhado antes que o Bearagnostic possa revisar arquivos de zero bytes.",
    "openSettings": "Abrir configurações do Android",
    "noSnapshotTitle": "Verifique arquivos de zero bytes primeiro",
    "noSnapshotBody": "Execute um Quick Scan para localizar arquivos de zero bytes no armazenamento compartilhado acessível. O Quick lê apenas metadados do sistema de arquivos e não exclui nada.",
    "runQuick": "Executar Quick Scan",
    "scanningTitle": "Procurando arquivos de zero bytes",
    ...
    "scanningHint": "Os arquivos de zero bytes aparecerão quando a verificação atual terminar.",
    "files": "Arquivos de zero bytes",
    "totalSize": "Tamanho total",
    "largest": "Maior",
    "checked": "Verificado",
    "justNow": "agora mesmo",
    "minAgo": "min atrás",
    "cautionTitle": "Um arquivo vazio ainda pode ser intencional",
    "cautionBody": "Marcadores, stubs de exportação, marcadores de sincronização ou arquivos sentinela criados por apps podem ter legitimamente 0 B. Nada é selecionado automaticamente.",
    "partialTitle": "A lista de revisão é parcial",
    "partialBody": "O snapshot de segurança atual atingiu o limite de detalhes da revisão. Apenas arquivos de zero bytes representados aqui podem ser selecionados.",
    "customTitle": "Escopo personalizado",
    "customBody": "Este snapshot veio de locais selecionados no Custom Scan. Arquivos de zero bytes fora desses locais não estão representados.",
    "checkAll": "Verificar todo o armazenamento acessível",
    "filterAll": "Todos",
    "filterDocuments": "Documentos",
    "filterMedia": "Mídia",
    "filterApk": "APK",
    "filterArchives": "Arquivos compactados",
    "filterOther": "Outros",
    "sortNewest": "Mais recentes primeiro",
    "sortOldest": "Mais antigos primeiro",
    "sortName": "Nome A–Z",
    "sortLocation": "Local A–Z",
    "selectionTitle": "Escolha apenas arquivos vazios que você reconhece e não precisa mais",
    "showing": "Mostrando {shown} de {total}",
    "selected": "{count} selecionados · {bytes}",
    "clear": "Limpar",
    "reviewSelected": "Revisar selecionados",
    "noFilesTitle": "Nenhum arquivo de zero bytes apareceu neste snapshot",
    "noFilesBody": "Nenhuma identidade de arquivo de zero bytes está disponível no snapshot de revisão atual. Nada foi removido.",
    "noFilter": "Nenhum arquivo de zero bytes corresponde a este filtro.",
    "showMore": "Mostrar mais arquivos vazios",
    ...
    "finalTitle": "Remover os arquivos vazios selecionados?",
    "finalBody": "Isso remove permanentemente apenas os arquivos vazios selecionados. O Bearagnostic não presume que todo arquivo de 0 B seja descartável.",
    "selectedFiles": "arquivos selecionados",
    "selectedBytes": "tamanho selecionado",
    "protection": "A segurança de exclusão nativa permanece ativa. Se um arquivo vazio selecionado também fizer parte de um grupo de duplicados verificado, a proteção de manter uma cópia continua valendo.",
    "back": "Voltar",
    "deleteVerify": "Excluir e verificar",
    "deleting": "Excluindo e verificando…",
    "resultKicker": "LIMPEZA VERIFICADA",
    "resultTitle": "Limpeza de arquivos de zero bytes concluída",
    "reclaimed": "espaço recuperado verificado",
    "removed": "arquivos removidos",
    "protected": "mantidos por segurança",
    "failed": "não removidos",
    "resultBody": "Somente arquivos de zero bytes que o Android confirmou como removidos contam como excluídos.",
    "reviewRemaining": "Revisar restantes",
    "done": "Concluído",
    "errorTitle": "A revisão de arquivos de zero bytes não pôde continuar",
    "retry": "Tentar novamente",
    "scanFailed": "Não foi possível iniciar o Quick Scan.",
    "anotherScan": "Outra verificação já está em andamento. Os arquivos de zero bytes serão atualizados quando ela terminar.",
    "kindDocuments": "DOC",
    "kindMedia": "MÍDIA",
    "kindApk": "APK",
    "kindArchives": "ARQUIVO",
    "kindOther": "OUTROS"
  }
};
  ...
  function ensureSurface() {
    ...
    surface.innerHTML = `
      <header class="ba-zero-head">
        ...
        <button class="ba-zero-close" type="button" data-zero-action="close" aria-label="${esc(window.BearagnosticLaunchLocales?.a11y?.('close') || c().close)}">×</button>
      </header>
  ...
  function renderResults() {
    ...
    return `${baseIntro()}${triad()}
      <div class="ba-zero-stats">
        ...
        <div class="ba-zero-stat"><b>${typeCount}</b><span>${esc(language() === 'th' ? 'ประเภท' : language() === 'ja' ? '種類' : language() === 'es' ? 'Tipos' : language() === 'pt-BR' ? 'Tipos' : 'Types')}</span></div>
      ...
      <div class="ba-zero-controls">
        <select class="ba-zero-select" data-zero-control="filter" aria-label="${esc(window.BearagnosticLaunchLocales?.a11y?.('filter') || 'Filter')}">
        ...
        <select class="ba-zero-select" data-zero-control="sort" aria-label="${esc(window.BearagnosticLaunchLocales?.a11y?.('sort') || 'Sort')}">
