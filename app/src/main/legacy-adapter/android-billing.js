(() => {
  ...
  "en": {
    ...
    "activeSub": "Google Play ownership is recognized for this installation.",
    "activeButton": "PRO ACTIVE",
    "debugTitle": "Development Pro override is active",
    "debugSub": "This is a debug-only entitlement override, not a Google Play purchase.",
    "debugButton": "PRO TEST MODE",
    "readyTitle": "Unlock Bearagnostic Pro",
    "readySub": "One-time lifetime purchase through Google Play. No subscription, no ads, no Bearagnostic account.",
    "buy": "Unlock Pro",
    "restore": "Restore purchase",
    "retry": "Retry Google Play",
    "connectingTitle": "Connecting to Google Play",
    "connectingSub": "Checking the local Play product and ownership state. No price is guessed or hard-coded.",
    "unavailableTitle": "Purchase is not available in this install yet",
    "unavailableSub": "The Play product or test-track setup is not available here yet. This is expected before Play Console integration is completed.",
    "pendingTitle": "Purchase pending",
    "pendingSub": "Google Play has not completed the payment yet. Pro unlocks only after Play reports PURCHASED.",
    "openingTitle": "Opening Google Play",
    "openingSub": "Complete or cancel the purchase in the Google Play sheet.",
    "errorTitle": "Google Play could not confirm billing",
    "errorSub": "Nothing was charged by Bearagnostic. Retry when Google Play is available, or restore an existing purchase.",
    ...
    "sandboxScenario": "Test outcome",
    "sandboxSuccess": "Successful purchase",
    "sandboxPending": "Pending payment",
    "sandboxCancel": "User cancels",
    "sandboxError": "Payment error",
    "sandboxAlreadyOwned": "Already owned",
    "sandboxNetwork": "Network error",
    "sandboxUnavailable": "Billing unavailable",
    "sandboxUsePlay": "Use Google Play path",
    "sandboxEnable": "Enable test purchase",
    "sandboxCompletePending": "Complete pending payment",
    "sandboxForgetLocal": "Clear local Pro access",
    "sandboxReset": "Erase mock purchase",
    "sandboxTestPrice": "TEST PRICE",
    "sandboxActiveTitle": "Test purchase verified · Pro unlocked",
    "sandboxActiveSub": "The sandbox returned a PURCHASED-style confirmation. Bearagnostic granted Pro through the same entitlement gates used by the app.",
    "sandboxReadyTitle": "Test the Pro purchase flow",
    "sandboxReadySub": "Run a realistic one-time purchase simulation. The sandbox is isolated to Debug builds and never charges money.",
    "sandboxPendingTitle": "Test payment is pending",
    "sandboxPendingSub": "Pro stays locked until you explicitly complete this pending test payment.",
    "sandboxProcessingTitle": "Confirming test payment",
    "sandboxProcessingSub": "The sandbox is moving through the same client-visible states used by the real billing flow.",
    "sandboxErrorTitle": "Test purchase did not complete",
    "sandboxErrorSub": "No Pro access was granted. Change the test outcome or try again.",
    "sandboxRestore": "Restore test purchase",
    "sandboxBuy": "Buy Pro (test)",
    "checkoutTitle": "Test purchase",
    "checkoutBody": "This is a simulated Google Play purchase for QA. No card, account or real money is involved.",
    "checkoutConfirm": "Confirm test purchase",
    "checkoutCancel": "Cancel",
    "checkoutPaymentLabel": "TEST PAYMENT METHOD",
    "checkoutTestCard": "Test card ·•••• 4242",
    "checkoutNoRecurring": "No subscription · No recurring charge",
    "stateReady": "Ready",
    "stateCheckout": "Checkout open",
    "stateProcessing": "Processing",
    "stateOwned": "Owned",
    "statePending": "Pending",
    "stateCancelled": "Cancelled",
    "stateError": "Error",
    "stateChecking": "Checking ownership",
    "stateNotOwned": "Not owned"
  },
  "th": {
    "activeTitle": "Bearagnostic Pro เปิดใช้งานแล้ว",
    "activeSub": "ระบบรับรู้สิทธิ์จาก Google Play สำหรับการติดตั้งนี้แล้ว",
    "activeButton": "PRO เปิดใช้งาน",
    "debugTitle": "กำลังใช้สิทธิ์ Pro สำหรับ Development",
    "debugSub": "นี่เป็นสิทธิ์ทดสอบเฉพาะ Debug ไม่ใช่การซื้อผ่าน Google Play",
    "debugButton": "โหมดทดสอบ PRO",
    "readyTitle": "ปลดล็อก Bearagnostic Pro",
    "readySub": "ซื้อครั้งเดียว ใช้ได้ตลอดชีพผ่าน Google Play ไม่มีรายเดือน ไม่มีโฆษณา และไม่ต้องมีบัญชี Bearagnostic",
    "buy": "ปลดล็อก Pro",
    "restore": "กู้คืนการซื้อ",
    "retry": "ลองเชื่อม Google Play อีกครั้ง",
    "connectingTitle": "กำลังเชื่อมต่อ Google Play",
    "connectingSub": "กำลังตรวจสินค้า ราคาในประเทศ และสถานะสิทธิ์จริง โดยไม่เดาหรือกำหนดราคาเอง",
    "unavailableTitle": "ยังซื้อไม่ได้จากการติดตั้งนี้",
    "unavailableSub": "สินค้าใน Play หรือ test track ยังไม่พร้อมสำหรับ build นี้ ซึ่งเป็นสถานะที่คาดไว้ก่อนเชื่อม Play Console เสร็จสมบูรณ์",
    "pendingTitle": "การซื้อกำลังรอดำเนินการ",
    "pendingSub": "Google Play ยังชำระเงินไม่เสร็จ Pro จะปลดล็อกเมื่อ Play รายงานสถานะ PURCHASED เท่านั้น",
    "openingTitle": "กำลังเปิด Google Play",
    "openingSub": "ดำเนินการซื้อหรือยกเลิกได้จากหน้าต่างของ Google Play",
    "errorTitle": "Google Play ยังยืนยัน Billing ไม่ได้",
    "errorSub": "Bearagnostic ไม่ได้เรียกเก็บเงิน ลองใหม่เมื่อ Google Play พร้อม หรือกู้คืนการซื้อเดิม",
    "ownershipCached": "เครื่องนี้มีสิทธิ์จาก Play ที่เคยตรวจยืนยันไว้ ระบบจะตรวจใหม่เมื่อเชื่อม Google Play ได้",
    "pricePrefix": "ตลอดชีพ · ",
    "localPrice": "ราคาจริงจาก Google Play",
    "testTrack": "การทดสอบซื้อจริงต้องให้สินค้าและ build ของแอปพร้อมใช้งานผ่าน Google Play test track ก่อน",
    "sandboxLabel": "การซื้อทดสอบ · DEBUG เท่านั้น",
    "sandboxTitle": "Billing Sandbox",
    ...
    "sandboxScenario": "ผลลัพธ์ที่ต้องการทดสอบ",
    "sandboxSuccess": "ซื้อสำเร็จ",
    "sandboxPending": "รอชำระเงิน",
    "sandboxCancel": "ผู้ใช้ยกเลิก",
    "sandboxError": "ชำระเงินไม่สำเร็จ",
    "sandboxAlreadyOwned": "ซื้อไว้แล้ว",
    "sandboxNetwork": "เครือข่ายขัดข้อง",
    "sandboxUnavailable": "Billing ใช้งานไม่ได้",
    "sandboxUsePlay": "ใช้เส้นทาง Google Play",
    "sandboxEnable": "เปิดระบบซื้อทดสอบ",
    "sandboxCompletePending": "ชำระรายการ Pending ให้เสร็จ",
    "sandboxForgetLocal": "ล้างสิทธิ์ Pro ในเครื่อง",
    "sandboxReset": "ล้างข้อมูลซื้อจำลองทั้งหมด",
    "sandboxTestPrice": "ราคาทดสอบ",
    "sandboxActiveTitle": "ยืนยันการซื้อทดสอบแล้ว · ปลดล็อก Pro สำเร็จ",
    "sandboxActiveSub": "Sandbox ส่งสถานะแบบ PURCHASED แล้ว Bearagnostic จึงเปิด Pro ผ่าน entitlement gate เดียวกับที่แอปใช้งานจริง",
    "sandboxReadyTitle": "ทดสอบขั้นตอนซื้อ Bearagnostic Pro",
    "sandboxReadySub": "จำลองการซื้อแบบครั้งเดียวให้ใกล้เคียงการใช้งานจริง ระบบนี้อยู่เฉพาะ Debug build และไม่มีการเรียกเก็บเงินจริง",
    "sandboxPendingTitle": "รายการทดสอบกำลังรอชำระ",
    "sandboxPendingSub": "Pro จะยังไม่ถูกปลดล็อก จนกว่าจะสั่งให้การชำระเงินทดสอบรายการนี้เสร็จสมบูรณ์",
    "sandboxProcessingTitle": "กำลังยืนยันการชำระเงินทดสอบ",
    "sandboxProcessingSub": "Sandbox กำลังจำลองลำดับสถานะที่ฝั่งแอปจะได้รับจาก Billing จริง",
    "sandboxErrorTitle": "การซื้อทดสอบไม่สำเร็จ",
    "sandboxErrorSub": "ยังไม่มีการปลดล็อก Pro สามารถเปลี่ยนผลลัพธ์ที่ต้องการทดสอบแล้วลองใหม่ได้",
    "sandboxRestore": "กู้คืนการซื้อทดสอบ",
    "sandboxBuy": "ซื้อ Pro (ทดสอบ)",
    "checkoutTitle": "การซื้อทดสอบ",
    "checkoutBody": "นี่คือการจำลอง Google Play purchase สำหรับ QA เท่านั้น ไม่มีบัตร ไม่มีบัญชีที่ถูกเรียกเก็บ และไม่มีเงินจริงถูกตัด",
    "checkoutConfirm": "ยืนยันการซื้อทดสอบ",
    "checkoutCancel": "ยกเลิก",
    "checkoutPaymentLabel": "วิธีชำระเงินทดสอบ",
    "checkoutTestCard": "บัตรทดสอบ ·•••• 4242",
    "checkoutNoRecurring": "ไม่มีรายเดือน · ไม่มีการเรียกเก็บซ้ำ",
    "stateReady": "พร้อมทดสอบ",
    "stateCheckout": "เปิดหน้าชำระแล้ว",
    "stateProcessing": "กำลังดำเนินการ",
    "stateOwned": "เป็นเจ้าของแล้ว",
    "statePending": "รอดำเนินการ",
    "stateCancelled": "ยกเลิกแล้ว",
    "stateError": "เกิดข้อผิดพลาด",
    "stateChecking": "กำลังตรวจสิทธิ์",
    "stateNotOwned": "ยังไม่มีสิทธิ์"
  },
  "ja": {
    "activeTitle": "Bearagnostic Pro は有効です",
    "activeSub": "このインストールで Google Play の所有権を確認しています。",
    "activeButton": "PRO 有効",
    "debugTitle": "Development 用 Pro オーバーライドが有効です",
    "debugSub": "Debug 専用のテスト権限で、Google Play の購入ではありません。",
    "debugButton": "PRO TEST MODE",
    "readyTitle": "Bearagnostic Pro を解除",
    "readySub": "Google Play で一度購入すれば買い切り。サブスク・広告・Bearagnostic アカウントは不要です。",
    "buy": "Pro を解除",
    "restore": "購入を復元",
    "retry": "Google Play を再確認",
    "connectingTitle": "Google Play に接続中",
    "connectingSub": "商品、地域価格、所有権を確認しています。価格を推測・固定表示しません。",
    "unavailableTitle": "このインストールではまだ購入できません",
    "unavailableSub": "Play の商品または test track がまだ利用できません。Play Console 連携前は想定された状態です。",
    "pendingTitle": "購入処理中",
    "pendingSub": "支払いはまだ完了していません。Play が PURCHASED を返した後にだけ Pro を有効化します。",
    "openingTitle": "Google Play を開いています",
    "openingSub": "Google Play の画面で購入を完了またはキャンセルしてください。",
    "errorTitle": "Google Play で Billing を確認できません",
    "errorSub": "Bearagnostic から請求は行われていません。後で再試行するか、既存の購入を復元してください。",
    "ownershipCached": "以前確認した Play 所有権を端末内に保持しています。Google Play に接続できた時点で再確認します。",
    "pricePrefix": "買い切り · ",
    "localPrice": "Google Play の地域価格",
    "testTrack": "実際の購入テストには、商品とアプリ build を Google Play test track で利用可能にする必要があります。",
    "sandboxLabel": "テスト購入 · DEBUG専用",
    "sandboxTitle": "購入シミュレーター",
    "sandboxBody": "Google Play 購入時にアプリ側で見える状態遷移を再現し、Pro の解除、Pending、復元、エラー処理を Play 連携前に確認できます。実際の決済は行いません。",
    "sandboxScenario": "テスト結果",
    "sandboxSuccess": "購入成功",
    "sandboxPending": "支払い保留",
    "sandboxCancel": "ユーザーがキャンセル",
    "sandboxError": "支払いエラー",
    "sandboxAlreadyOwned": "購入済み",
    "sandboxNetwork": "ネットワークエラー",
    "sandboxUnavailable": "Billing 利用不可",
    "sandboxUsePlay": "Google Play 経路を使う",
    "sandboxEnable": "テスト購入を有効化",
    "sandboxCompletePending": "保留中の支払いを完了",
    "sandboxForgetLocal": "端末内の Pro 権限を消去",
    "sandboxReset": "模擬購入をすべてリセット",
    "sandboxTestPrice": "テスト価格",
    "sandboxActiveTitle": "テスト購入を確認 · Pro を解除しました",
    "sandboxActiveSub": "Sandbox が PURCHASED 相当の確認を返したため、実際のアプリと同じ entitlement gate を通して Pro を有効化しました。",
    "sandboxReadyTitle": "Bearagnostic Pro の購入フローをテスト",
    "sandboxReadySub": "買い切り購入を本番に近い流れで再現します。Debug build 専用で、実際の請求は発生しません。",
    "sandboxPendingTitle": "テスト支払いは保留中です",
    "sandboxPendingSub": "この保留中のテスト支払いを完了するまで Pro は解除されません。",
    "sandboxProcessingTitle": "テスト支払いを確認中",
    "sandboxProcessingSub": "実際の Billing でアプリ側が受け取る状態遷移に沿って処理しています。",
    "sandboxErrorTitle": "テスト購入は完了しませんでした",
    "sandboxErrorSub": "Pro 権限は付与されていません。テスト結果を変更してもう一度確認できます。",
    "sandboxRestore": "テスト購入を復元",
    "sandboxBuy": "Pro を購入（テスト）",
    "checkoutTitle": "テスト購入",
    "checkoutBody": "QA 用の Google Play 購入シミュレーションです。カード、アカウント、実際のお金は使用しません。",
    "checkoutConfirm": "テスト購入を確定",
    "checkoutCancel": "キャンセル",
    "checkoutPaymentLabel": "テスト用支払い方法",
    "checkoutTestCard": "テストカード ·•••• 4242",
    "checkoutNoRecurring": "サブスクなし · 継続課金なし",
    "stateReady": "準備完了",
    "stateCheckout": "購入画面を表示中",
    "stateProcessing": "処理中",
    "stateOwned": "購入済み",
    "statePending": "保留中",
    "stateCancelled": "キャンセル済み",
    "stateError": "エラー",
    "stateChecking": "所有権を確認中",
    "stateNotOwned": "未購入"
  },
  "es": {
    "activeTitle": "Bearagnostic Pro está activo",
    "activeSub": "La propiedad de Google Play se reconoce para esta instalación.",
    "activeButton": "PRO ACTIVO",
    "debugTitle": "La anulación Pro de desarrollo está activa",
    "debugSub": "Es una anulación de acceso solo para depuración, no una compra de Google Play.",
    "debugButton": "MODO DE PRUEBA PRO",
    "readyTitle": "Desbloquear Bearagnostic Pro",
    "readySub": "Compra única de por vida mediante Google Play. Sin suscripción, sin anuncios y sin cuenta de Bearagnostic.",
    "buy": "Desbloquear Pro",
    "restore": "Restaurar compra",
    "retry": "Reintentar Google Play",
    "connectingTitle": "Conectando con Google Play",
    "connectingSub": "Comprobando el producto local de Play y el estado de propiedad. No se adivina ni se fija ningún precio.",
    "unavailableTitle": "La compra aún no está disponible en esta instalación",
    "unavailableSub": "El producto de Play o la configuración de la pista de pruebas aún no está disponible aquí. Es normal antes de completar la integración con Play Console.",
    "pendingTitle": "Compra pendiente",
    "pendingSub": "Google Play todavía no ha completado el pago. Pro se desbloquea solo cuando Play informa PURCHASED.",
    "openingTitle": "Abriendo Google Play",
    "openingSub": "Completa o cancela la compra en la hoja de Google Play.",
    "errorTitle": "Google Play no pudo confirmar la facturación",
    "errorSub": "Bearagnostic no realizó ningún cargo. Reintenta cuando Google Play esté disponible o restaura una compra existente.",
    "ownershipCached": "La propiedad de Play verificada anteriormente está guardada en caché en este dispositivo. Bearagnostic la actualizará cuando Google Play esté disponible.",
    "pricePrefix": "De por vida · ",
    "localPrice": "Precio local de Play",
    "testTrack": "Las pruebas de compra reales requieren que el producto y la compilación de la app estén disponibles mediante una pista de pruebas de Google Play.",
    "sandboxLabel": "COMPRA DE PRUEBA · SOLO DEBUG",
    "sandboxTitle": "Sandbox de facturación",
    "sandboxBody": "Simula el ciclo de compra de Google Play visible para el cliente para probar desbloqueo Pro, pendiente, restauración y fallos antes de integrar Play. No se realiza ningún pago real.",
    "sandboxScenario": "Resultado de la prueba",
    "sandboxSuccess": "Compra correcta",
    "sandboxPending": "Pago pendiente",
    "sandboxCancel": "El usuario cancela",
    "sandboxError": "Error de pago",
    "sandboxAlreadyOwned": "Ya adquirido",
    "sandboxNetwork": "Error de red",
    "sandboxUnavailable": "Facturación no disponible",
    "sandboxUsePlay": "Usar flujo de Google Play",
    "sandboxEnable": "Activar compra de prueba",
    "sandboxCompletePending": "Completar pago pendiente",
    "sandboxForgetLocal": "Borrar acceso Pro local",
    "sandboxReset": "Borrar compra simulada",
    "sandboxTestPrice": "PRECIO DE PRUEBA",
    "sandboxActiveTitle": "Compra de prueba verificada · Pro desbloqueado",
    "sandboxActiveSub": "El sandbox devolvió una confirmación tipo PURCHASED. Bearagnostic concedió Pro mediante las mismas reglas de acceso usadas por la app.",
    "sandboxReadyTitle": "Probar el flujo de compra Pro",
    "sandboxReadySub": "Ejecuta una simulación realista de compra única. El sandbox está aislado en builds Debug y nunca cobra dinero.",
    "sandboxPendingTitle": "El pago de prueba está pendiente",
    "sandboxPendingSub": "Pro permanece bloqueado hasta que completes explícitamente este pago de prueba pendiente.",
    "sandboxProcessingTitle": "Confirmando pago de prueba",
    "sandboxProcessingSub": "El sandbox recorre los mismos estados visibles para el cliente que usa el flujo real de facturación.",
    "sandboxErrorTitle": "La compra de prueba no se completó",
    "sandboxErrorSub": "No se concedió acceso Pro. Cambia el resultado de la prueba o inténtalo de nuevo.",
    "sandboxRestore": "Restaurar compra de prueba",
    "sandboxBuy": "Comprar Pro (prueba)",
    "checkoutTitle": "Compra de prueba",
    "checkoutBody": "Esta es una compra simulada de Google Play para QA. No intervienen tarjetas, cuentas ni dinero real.",
    "checkoutConfirm": "Confirmar compra de prueba",
    "checkoutCancel": "Cancelar",
    "checkoutPaymentLabel": "MÉTODO DE PAGO DE PRUEBA",
    "checkoutTestCard": "Tarjeta de prueba ·•••• 4242",
    "checkoutNoRecurring": "Sin suscripción · Sin cobro recurrente",
    "stateReady": "Listo",
    "stateCheckout": "Checkout abierto",
    "stateProcessing": "Procesando",
    "stateOwned": "Adquirido",
    "statePending": "Pendiente",
    "stateCancelled": "Cancelado",
    "stateError": "Error",
    "stateChecking": "Comprobando propiedad",
    "stateNotOwned": "No adquirido"
  },
  "pt-BR": {
    "activeTitle": "Bearagnostic Pro está ativo",
    "activeSub": "A propriedade do Google Play foi reconhecida para esta instalação.",
    "activeButton": "PRO ATIVO",
    "debugTitle": "A substituição Pro de desenvolvimento está ativa",
    "debugSub": "Esta é uma substituição de acesso somente para debug, não uma compra do Google Play.",
    "debugButton": "MODO DE TESTE PRO",
    "readyTitle": "Desbloquear o Bearagnostic Pro",
    "readySub": "Compra única vitalícia pelo Google Play. Sem assinatura, sem anúncios e sem conta do Bearagnostic.",
    "buy": "Desbloquear Pro",
    "restore": "Restaurar compra",
    "retry": "Tentar Google Play novamente",
    "connectingTitle": "Conectando ao Google Play",
    "connectingSub": "Verificando o produto local do Play e o status de propriedade. Nenhum preço é estimado ou fixado no código.",
    "unavailableTitle": "A compra ainda não está disponível nesta instalação",
    "unavailableSub": "O produto do Play ou a configuração da faixa de testes ainda não está disponível aqui. Isso é esperado antes da conclusão da integração com o Play Console.",
    "pendingTitle": "Compra pendente",
    "pendingSub": "O Google Play ainda não concluiu o pagamento. O Pro só é desbloqueado quando o Play informa PURCHASED.",
    "openingTitle": "Abrindo Google Play",
    "openingSub": "Conclua ou cancele a compra na tela do Google Play.",
    "errorTitle": "O Google Play não conseguiu confirmar a cobrança",
    "errorSub": "O Bearagnostic não fez nenhuma cobrança. Tente novamente quando o Google Play estiver disponível ou restaure uma compra existente.",
    "ownershipCached": "A propriedade do Play verificada anteriormente está armazenada neste dispositivo. O Bearagnostic a atualizará quando o Google Play estiver acessível.",
    "pricePrefix": "Vitalício · ",
    "localPrice": "Preço local do Play",
    "testTrack": "Testes de compra reais exigem que o produto e a build do app estejam disponíveis por uma faixa de testes do Google Play.",
    "sandboxLabel": "COMPRA DE TESTE · SOMENTE DEBUG",
    "sandboxTitle": "Sandbox de cobrança",
    "sandboxBody": "Simula o ciclo de compra do Google Play visível ao cliente para testar desbloqueio Pro, pendência, restauração e falhas antes da integração com o Play. Nenhum pagamento real é feito.",
    "sandboxScenario": "Resultado do teste",
    "sandboxSuccess": "Compra bem-sucedida",
    "sandboxPending": "Pagamento pendente",
    "sandboxCancel": "Usuário cancela",
    "sandboxError": "Erro de pagamento",
    "sandboxAlreadyOwned": "Já adquirido",
    "sandboxNetwork": "Erro de rede",
    "sandboxUnavailable": "Cobrança indisponível",
    "sandboxUsePlay": "Usar fluxo do Google Play",
    "sandboxEnable": "Ativar compra de teste",
    "sandboxCompletePending": "Concluir pagamento pendente",
    "sandboxForgetLocal": "Limpar acesso Pro local",
    "sandboxReset": "Apagar compra simulada",
    "sandboxTestPrice": "PREÇO DE TESTE",
    "sandboxActiveTitle": "Compra de teste verificada · Pro desbloqueado",
    "sandboxActiveSub": "O sandbox retornou uma confirmação no estilo PURCHASED. O Bearagnostic concedeu Pro pelas mesmas regras de acesso usadas pelo app.",
    "sandboxReadyTitle": "Testar o fluxo de compra Pro",
    "sandboxReadySub": "Execute uma simulação realista de compra única. O sandbox fica isolado em builds Debug e nunca cobra dinheiro.",
    "sandboxPendingTitle": "O pagamento de teste está pendente",
    "sandboxPendingSub": "O Pro permanece bloqueado até que você conclua explicitamente este pagamento de teste pendente.",
    "sandboxProcessingTitle": "Confirmando pagamento de teste",
    "sandboxProcessingSub": "O sandbox percorre os mesmos estados visíveis ao cliente usados pelo fluxo real de cobrança.",
    "sandboxErrorTitle": "A compra de teste não foi concluída",
    "sandboxErrorSub": "Nenhum acesso Pro foi concedido. Altere o resultado do teste ou tente novamente.",
    "sandboxRestore": "Restaurar compra de teste",
    "sandboxBuy": "Comprar Pro (teste)",
    "checkoutTitle": "Compra de teste",
    "checkoutBody": "Esta é uma compra simulada do Google Play para QA. Nenhum cartão, conta ou dinheiro real está envolvido.",
    "checkoutConfirm": "Confirmar compra de teste",
    "checkoutCancel": "Cancelar",
    "checkoutPaymentLabel": "MÉTODO DE PAGAMENTO DE TESTE",
    "checkoutTestCard": "Cartão de teste ·•••• 4242",
    "checkoutNoRecurring": "Sem assinatura · Sem cobrança recorrente",
    "stateReady": "Pronto",
    "stateCheckout": "Checkout aberto",
    "stateProcessing": "Processando",
    "stateOwned": "Adquirido",
    "statePending": "Pendente",
    "stateCancelled": "Cancelado",
    "stateError": "Erro",
    "stateChecking": "Verificando propriedade",
    "stateNotOwned": "Não adquirido"
  }
};
...
(() => {
  ...
  const lang = () => { const v=(document.documentElement.lang||'en').toLowerCase(); return v.startsWith('th') ? 'th' : v.startsWith('ja') ? 'ja' : v.startsWith('es') ? 'es' : (v === 'pt-br' || v.startsWith('pt-br') || v.startsWith('pt_')) ? 'pt-BR' : 'en'; };
  const state = () => {
    try { return parse(NATIVE.getDebugBillingSandboxState?.(), {available:false}); }
  ...
  const fmtTime=(ms)=>{if(!Number(ms))return '—';try{return new Intl.DateTimeFormat(lang()==='th'?'th-TH':lang()==='ja'?'ja-JP':lang()==='es'?'es-ES':lang()==='pt-BR'?'pt-BR':'en-US',{hour:'2-digit',minute:'2-digit',second:'2-digit'}).format(new Date(Number(ms)));}catch(_){return '—';}};
