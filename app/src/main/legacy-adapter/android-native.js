(() => {
  ...
  "en": {
    "eyebrow": "SCAN DEPTH",
    "title": "Choose how deeply to scan",
    "lead": "The original Bearagnostic experience stays unchanged. Choose only how much native analysis to perform.",
    "smart": "Smart Scan",
    "smartSub": "All accessible shared storage, content sampling and focused verified duplicates.",
    "smartBadge": "RECOMMENDED",
    "quick": "Quick Scan",
    "quickSub": "All accessible shared storage using metadata and lightweight rules. Fast by design.",
    "deep": "Deep Scan",
    "deepSub": "All accessible shared storage, full streaming content read and exact duplicate verification.",
    "custom": "Custom Scan",
    "customSub": "Choose shared-storage categories and duplicate verification.",
    "cancel": "Cancel",
    "customTitle": "Custom Scan",
    "downloads": "Downloads",
    "photos": "Photos",
    "videos": "Videos",
    "documents": "Documents",
    "music": "Music",
    "verify": "Verify exact duplicates",
    "start": "Start Custom Scan",
    "permission": "Allow storage access in Android settings to start this scan.",
    "busy": "A scan is already running.",
    "failed": "Bearagnostic could not finish this checkup.",
    "cancelled": "Checkup cancelled.",
    "ready": "READY",
    "scanning": "SCANNING",
    "complete": "COMPLETE",
    "idleTitle": "Ready for a checkup",
    "idleSub": "Choose a scan mode. Dr. Bear checks only storage Android allows.",
    "runningTitle": "Checking things out",
    "runningSub": "A cleaner device leads to brighter days.",
    "doneTitle": "Checkup complete",
    "doneSub": "The accessible scope for this scan has been reviewed locally.",
    "quoteIdle": "Your files. Your choice.",
    "quoteRunning": "Looking carefully. Bears don’t rush diagnostics.",
    "quoteDone": "All done. The numbers shown come from the native scan.",
    "tip": "Bearagnostic analyzes accessible files locally on this device.",
    "home": "Home",
    "nextSteps": "Cleanup plan",
    "nextLead": "Your scan is complete. Nothing changes until you choose it.",
    "reviewClean": "Review & Clean",
    "reviewCleanSub": "Low-risk cleanup candidates only",
    "noLowRisk": "No low-risk automatic cleanup was found. Review the categories below instead.",
    "duplicatesAction": "Exact duplicates",
    "largeAction": "Large files",
    "oldAction": "Older files",
    "tempAction": "Temporary files",
    "installersAction": "APK installers",
    "archivesAction": "Archives",
    "review": "Review",
    "scanAgain": "Scan again",
    "close": "Close",
    "viewResults": "View recommendations",
    "reviewTitle": "Review files",
    "selected": "selected",
    "selectAll": "Select all",
    "clearSelection": "Clear selection",
    "selectUpTo": "Select up to",
    "deleteSelected": "Delete selected",
    "deleteTitle": "Delete selected files?",
    "deleteBody": "Bearagnostic will permanently delete only the files you selected. This cannot be undone.",
    "deleteNow": "Delete files",
    "keep": "Keep",
    "lowRisk": "Low risk",
    "needsReview": "Review",
    "protectedCopy": "Keep one copy",
    "loadMore": "Load more",
    "resultsUpdated": "Cleanup finished",
    "reclaimed": "reclaimed",
    "deleted": "files deleted",
    "rescanNote": "Results are updated now. Scan again only when you want a fresh whole-device check.",
    "backResults": "Back to results",
    "resultHeroTitle": "Your storage, clarified.",
    "resultHeroLow": "Low-risk items are ready for review. Bearagnostic still asks before anything is deleted.",
    "resultHeroReview": "There is no one-tap cleanup here—and that is intentional. Review only the categories that matter to you.",
    "resultHeroClear": "Nothing in this scan currently needs cleanup review.",
    "overviewTitle": "At a glance",
    "readyNow": "Ready to clean",
    "reviewItems": "Items to review",
    "categoriesFound": "Categories",
    "items": "items",
    "sessionTitle": "This session",
    "sessionEmpty": "Nothing removed yet",
    "safetyTitle": "Protected by design",
    "safetyBody": "Large, old, APK and archive files stay review-only. Exact duplicates always keep at least one copy.",
    "zeroAction": "Zero-byte files",
    "resultKicker": "SCAN COMPLETE",
    "reviewByCategory": "Review by category",
    "scanFacts": "Scan facts",
    "filesReviewedLabel": "Files reviewed",
    "localLabel": "On device",
    "modeLabel": "Mode",
    "recommendFirst": "RECOMMENDED FIRST",
    "startHere": "Start here",
    "spaceReclaimed": "Space reclaimed",
    "reason_stale_incomplete_download": "Stale incomplete download",
    "reason_temporary_artifact": "Temporary artifact — review first",
    "reason_verified_duplicate": "Identical copy confirmed",
    "reason_large_file": "Large file — size alone is not junk",
    "reason_old_file": "Older file — age alone is not junk",
    "reason_apk_installer": "Downloaded APK installer",
    "reason_archive_file": "Archive — may be the only copy",
    "reason_zero_byte": "Zero-byte file — review context"
  },
  "th": {
    "eyebrow": "ระดับการสแกน",
    "title": "เลือกความละเอียดในการสแกน",
    "lead": "หน้าตา Bearagnostic ต้นฉบับยังคงเดิม เลือกเฉพาะระดับการวิเคราะห์จริงของตัวสแกน Android",
    "smart": "Smart Scan",
    "smartSub": "ตรวจ shared storage ที่เข้าถึงได้ อ่านตัวอย่างเนื้อหา และยืนยันไฟล์ซ้ำในจุดสำคัญ",
    "smartBadge": "แนะนำ",
    "quick": "Quick Scan",
    "quickSub": "ตรวจ shared storage ที่เข้าถึงได้ทั้งหมดด้วย metadata และกฎที่ใช้ทรัพยากรต่ำ เน้นความเร็ว",
    "deep": "Deep Scan",
    "deepSub": "ตรวจ shared storage ที่เข้าถึงได้ทั้งหมด อ่านเนื้อหาแบบ streaming จนครบ และยืนยันไฟล์ซ้ำแบบ exact",
    "custom": "Custom Scan",
    "customSub": "เลือกหมวด shared storage และกำหนดว่าจะยืนยันไฟล์ซ้ำหรือไม่",
    "cancel": "ยกเลิก",
    "customTitle": "Custom Scan",
    "downloads": "ดาวน์โหลด",
    "photos": "รูปภาพ",
    ...
    "documents": "เอกสาร",
    "music": "เพลง",
    "verify": "ยืนยันไฟล์ซ้ำแบบ exact",
    "start": "เริ่ม Custom Scan",
    "permission": "ต้องอนุญาตสิทธิ์เข้าถึงไฟล์ใน Settings ของ Android ก่อนเริ่มสแกน",
    "busy": "มีการสแกนทำงานอยู่แล้ว",
    "failed": "Bearagnostic ตรวจไม่สำเร็จ",
    "cancelled": "ยกเลิกการตรวจแล้ว",
    "ready": "พร้อม",
    "scanning": "กำลังตรวจ",
    "complete": "เสร็จแล้ว",
    "idleTitle": "พร้อมตรวจเครื่องแล้ว",
    "idleSub": "เลือกโหมดสแกน คุณหมอแบร์จะตรวจเฉพาะพื้นที่ที่ Android อนุญาต",
    "runningTitle": "กำลังตรวจอย่างละเอียด",
    "runningSub": "เครื่องที่เป็นระเบียบขึ้น ก็ทำให้ทุกอย่างลื่นขึ้น",
    "doneTitle": "ตรวจเครื่องเรียบร้อย",
    "doneSub": "ตรวจพื้นที่ที่ Android อนุญาตสำหรับรอบนี้แล้วภายในเครื่อง",
    "quoteIdle": "ไฟล์ของคุณ คุณเป็นคนเลือก",
    "quoteRunning": "กำลังดูให้ละเอียด การตรวจที่ดีไม่ต้องรีบ",
    "quoteDone": "เรียบร้อย ตัวเลขทั้งหมดมาจากการสแกนจริง",
    "tip": "Bearagnostic วิเคราะห์ไฟล์ที่เข้าถึงได้ภายในเครื่องนี้",
    "home": "หน้าหลัก",
    "nextSteps": "แผนทำความสะอาด",
    "nextLead": "ผลสแกนพร้อมแล้ว ทุกอย่างยังคงเดิมจนกว่าคุณจะเป็นคนเลือก",
    "reviewClean": "ตรวจและทำความสะอาด",
    "reviewCleanSub": "เฉพาะรายการความเสี่ยงต่ำที่ตรวจพบจริง",
    "noLowRisk": "ไม่พบรายการที่เหมาะกับการลบอัตโนมัติแบบความเสี่ยงต่ำ ให้ตรวจหมวดด้านล่างแทน",
    "duplicatesAction": "ไฟล์ซ้ำตรงกัน",
    "largeAction": "ไฟล์ขนาดใหญ่",
    "oldAction": "ไฟล์เก่า",
    "tempAction": "ไฟล์ชั่วคราว",
    "installersAction": "ไฟล์ติดตั้ง APK",
    "archivesAction": "ไฟล์บีบอัด",
    "review": "ตรวจรายการ",
    "scanAgain": "สแกนอีกครั้ง",
    "close": "ปิด",
    "viewResults": "ดูคำแนะนำ",
    "reviewTitle": "ตรวจรายการไฟล์",
    "selected": "เลือกแล้ว",
    "selectAll": "เลือกทั้งหมด",
    "clearSelection": "ล้างที่เลือก",
    "selectUpTo": "เลือกได้สูงสุด",
    "deleteSelected": "ลบที่เลือก",
    "deleteTitle": "ลบไฟล์ที่เลือก?",
    "deleteBody": "Bearagnostic จะลบถาวรเฉพาะไฟล์ที่คุณเลือก การลบนี้ย้อนกลับไม่ได้",
    "deleteNow": "ลบไฟล์",
    "keep": "เก็บไว้",
    "lowRisk": "ความเสี่ยงต่ำ",
    "needsReview": "ต้องตรวจ",
    "protectedCopy": "เก็บอย่างน้อยหนึ่งสำเนา",
    "loadMore": "โหลดเพิ่ม",
    "resultsUpdated": "ทำความสะอาดเรียบร้อย",
    "reclaimed": "คืนพื้นที่",
    "deleted": "ไฟล์ที่ลบ",
    "rescanNote": "ผลลัพธ์อัปเดตแล้ว สแกนใหม่เฉพาะเมื่ออยากตรวจทั้งเครื่องอีกครั้ง",
    "backResults": "กลับผลลัพธ์",
    "resultHeroTitle": "เห็นภาพพื้นที่ชัดขึ้นแล้ว",
    "resultHeroLow": "พบรายการความเสี่ยงต่ำที่พร้อมให้ตรวจ และ Bearagnostic จะถามยืนยันก่อนลบเสมอ",
    "resultHeroReview": "รอบนี้ไม่มีรายการที่ควรลบแบบคลิกเดียว ซึ่งเป็นสิ่งที่ตั้งใจไว้ เลือกตรวจเฉพาะหมวดที่คุณต้องการได้",
    "resultHeroClear": "ผลสแกนนี้ยังไม่มีรายการที่ต้องตรวจเพื่อทำความสะอาด",
    "overviewTitle": "ภาพรวม",
    "readyNow": "พร้อมทำความสะอาด",
    "reviewItems": "รายการให้ตรวจ",
    "categoriesFound": "หมวดที่พบ",
    "items": "รายการ",
    "sessionTitle": "รอบนี้",
    "sessionEmpty": "ยังไม่ได้ลบไฟล์",
    "safetyTitle": "ปกป้องข้อมูลเป็นหลัก",
    "safetyBody": "ไฟล์ใหญ่ ไฟล์เก่า APK และไฟล์บีบอัดจะไม่ถูกเลือกลบอัตโนมัติ ส่วนไฟล์ซ้ำจะเก็บไว้อย่างน้อยหนึ่งสำเนา",
    "zeroAction": "ไฟล์ขนาด 0 ไบต์",
    "resultKicker": "สแกนเสร็จแล้ว",
    "reviewByCategory": "ตรวจตามหมวด",
    "scanFacts": "ข้อมูลการสแกน",
    "filesReviewedLabel": "ไฟล์ที่ตรวจแล้ว",
    "localLabel": "ทำงานบนเครื่อง",
    "modeLabel": "โหมด",
    "recommendFirst": "แนะนำให้เริ่มตรงนี้",
    "startHere": "เริ่มตรวจ",
    "spaceReclaimed": "พื้นที่ที่คืนได้",
    "reason_stale_incomplete_download": "ไฟล์ดาวน์โหลดไม่สมบูรณ์ที่ค้างมานาน",
    "reason_temporary_artifact": "ไฟล์ชั่วคราว — ควรตรวจก่อน",
    "reason_verified_duplicate": "ยืนยันแล้วว่าเป็นสำเนาที่ตรงกัน",
    "reason_large_file": "ไฟล์ใหญ่ — ขนาดไม่ได้แปลว่าเป็นขยะ",
    "reason_old_file": "ไฟล์เก่า — อายุไฟล์ไม่ได้แปลว่าเป็นขยะ",
    "reason_apk_installer": "ไฟล์ติดตั้ง APK ที่ดาวน์โหลดไว้",
    "reason_archive_file": "ไฟล์บีบอัด — อาจเป็นสำเนาเดียว",
    "reason_zero_byte": "ไฟล์ขนาด 0 ไบต์ — ควรดูบริบท"
  },
  "ja": {
    "eyebrow": "スキャン深度",
    "title": "スキャンの深さを選択",
    "lead": "元の Bearagnostic 画面はそのままに、Android の実際の解析量だけを選びます。",
    "smart": "Smart Scan",
    "smartSub": "アクセス可能な共有ストレージ、内容サンプル、重要場所の重複検証。",
    "smartBadge": "おすすめ",
    "quick": "Quick Scan",
    "quickSub": "アクセス可能な共有ストレージ全体をメタデータと軽量ルールで高速確認。",
    "deep": "Deep Scan",
    "deepSub": "アクセス可能な共有ストレージ全体を最後まで読み、重複も完全一致で検証。",
    "custom": "Custom Scan",
    "customSub": "共有ストレージのカテゴリと重複検証を選択。",
    "cancel": "キャンセル",
    "customTitle": "Custom Scan",
    "downloads": "ダウンロード",
    "photos": "写真",
    ...
    "music": "音楽",
    "verify": "完全一致の重複を検証",
    "start": "Custom Scan を開始",
    "permission": "スキャンには Android のストレージアクセス許可が必要です。",
    "busy": "すでにスキャン中です。",
    "failed": "チェックを完了できませんでした。",
    "cancelled": "チェックを中止しました。",
    "ready": "準備完了",
    "scanning": "チェック中",
    "complete": "完了",
    "idleTitle": "チェックの準備ができました",
    "idleSub": "スキャン方法を選択してください。Android が許可する範囲のみ確認します。",
    "runningTitle": "丁寧に確認中",
    "runningSub": "端末をすっきり。毎日を軽やかに。",
    "doneTitle": "チェック完了",
    "doneSub": "アクセス可能な範囲を端末内で確認しました。",
    "quoteIdle": "選ぶのは、あなた。",
    "quoteRunning": "丁寧に確認中。診断は急ぎません。",
    "quoteDone": "完了しました。表示値は実際のネイティブスキャン結果です。",
    "tip": "Bearagnostic はアクセス可能なファイルを端末内で解析します。",
    "home": "ホーム",
    "nextSteps": "クリーンアッププラン",
    "nextLead": "スキャン結果を整理しました。選択するまで何も削除されません。",
    "reviewClean": "確認してクリーンアップ",
    "reviewCleanSub": "実際に見つかった低リスク候補のみ",
    "noLowRisk": "自動クリーンアップ向けの低リスク候補はありません。下のカテゴリを確認してください。",
    "duplicatesAction": "完全一致の重複",
    "largeAction": "大きいファイル",
    "oldAction": "古いファイル",
    "tempAction": "一時ファイル",
    "installersAction": "APK インストーラー",
    "archivesAction": "アーカイブ",
    "review": "確認",
    "scanAgain": "再スキャン",
    "close": "閉じる",
    "viewResults": "おすすめを見る",
    ...
    "deleteTitle": "選択したファイルを削除しますか？",
    "deleteBody": "選択したファイルだけを完全に削除します。この操作は元に戻せません。",
    "deleteNow": "削除",
    "keep": "保持",
    "lowRisk": "低リスク",
    "needsReview": "要確認",
    "protectedCopy": "1つは保持",
    "loadMore": "さらに表示",
    "resultsUpdated": "クリーンアップ完了",
    "reclaimed": "解放",
    "deleted": "削除したファイル",
    "rescanNote": "結果は更新済みです。端末全体を改めて確認したい場合のみ再スキャンしてください。",
    "backResults": "結果へ戻る",
    "resultHeroTitle": "ストレージの状況が見えました",
    "resultHeroLow": "低リスク項目を確認できます。削除前には Bearagnostic が必ず確認します。",
    "resultHeroReview": "今回はワンタップ削除に適した項目はありません。必要なカテゴリだけ確認できます。",
    "resultHeroClear": "このスキャンには現在クリーンアップ確認が必要な項目はありません。",
    "overviewTitle": "概要",
    "readyNow": "クリーンアップ候補",
    "reviewItems": "確認項目",
    "categoriesFound": "カテゴリ",
    "items": "項目",
    "sessionTitle": "今回",
    "sessionEmpty": "まだ削除していません",
    "safetyTitle": "保護を優先した設計",
    "safetyBody": "大容量・古い・APK・アーカイブは自動選択しません。重複ファイルも必ず1つ以上残します。",
    "zeroAction": "0 バイトファイル",
    "resultKicker": "スキャン完了",
    "reviewByCategory": "カテゴリ別に確認",
    "scanFacts": "スキャン情報",
    "filesReviewedLabel": "確認済みファイル",
    "localLabel": "端末内処理",
    "modeLabel": "モード",
    "recommendFirst": "最初におすすめ",
    "startHere": "ここから確認",
    "spaceReclaimed": "解放した容量",
    "reason_stale_incomplete_download": "古い未完了ダウンロード",
    "reason_temporary_artifact": "一時ファイル — 要確認",
    "reason_verified_duplicate": "同一コピーを確認済み",
    "reason_large_file": "大きいファイル — サイズだけでは不要とは限りません",
    "reason_old_file": "古いファイル — 日付だけでは不要とは限りません",
    "reason_apk_installer": "ダウンロード済み APK",
    "reason_archive_file": "アーカイブ — 唯一のコピーかもしれません",
    "reason_zero_byte": "0 バイトファイル — 状況を確認"
  },
  "es": {
    "eyebrow": "PROFUNDIDAD DEL ANÁLISIS",
    "title": "Elige la profundidad del análisis",
    "lead": "La experiencia original de Bearagnostic se mantiene sin cambios. Elige únicamente cuánto análisis nativo realizar.",
    "smart": "Smart Scan",
    "smartSub": "Todo el almacenamiento compartido accesible, muestreo de contenido y duplicados verificados de forma enfocada.",
    "smartBadge": "RECOMENDADO",
    "quick": "Quick Scan",
    "quickSub": "Todo el almacenamiento compartido accesible usando metadatos y reglas ligeras. Rápido por diseño.",
    "deep": "Deep Scan",
    "deepSub": "Todo el almacenamiento compartido accesible, lectura completa del contenido por streaming y verificación de duplicados exactos.",
    "custom": "Custom Scan",
    "customSub": "Elige categorías de almacenamiento compartido y la verificación de duplicados.",
    "cancel": "Cancelar",
    "customTitle": "Custom Scan",
    "downloads": "Descargas",
    "photos": "Fotos",
    ...
    "music": "Música",
    "verify": "Verificar duplicados exactos",
    "start": "Iniciar Custom Scan",
    "permission": "Permite el acceso al almacenamiento en los ajustes de Android para iniciar este análisis.",
    "busy": "Ya hay un análisis en curso.",
    "failed": "Bearagnostic no pudo completar esta revisión.",
    "cancelled": "Revisión cancelada.",
    "ready": "LISTO",
    "scanning": "ANALIZANDO",
    "complete": "COMPLETADO",
    "idleTitle": "Listo para una revisión",
    "idleSub": "Elige un modo de análisis. Dr. Bear revisa solo el almacenamiento que Android permite.",
    "runningTitle": "Revisando todo",
    "runningSub": "Un dispositivo más limpio ayuda a que todo fluya mejor.",
    "doneTitle": "Revisión completada",
    "doneSub": "El ámbito accesible de este análisis se revisó localmente.",
    "quoteIdle": "Tus archivos. Tu decisión.",
    "quoteRunning": "Revisando con cuidado. Los osos no apresuran un diagnóstico.",
    "quoteDone": "Todo listo. Los números mostrados provienen del análisis nativo.",
    "tip": "Bearagnostic analiza localmente los archivos accesibles en este dispositivo.",
    "home": "Inicio",
    "nextSteps": "Plan de limpieza",
    "nextLead": "El análisis ha terminado. Nada cambia hasta que tú lo decidas.",
    "reviewClean": "Revisar y limpiar",
    "reviewCleanSub": "Solo candidatos de limpieza de bajo riesgo",
    "noLowRisk": "No se encontró ninguna limpieza automática de bajo riesgo. Revisa las categorías de abajo.",
    "duplicatesAction": "Duplicados exactos",
    "largeAction": "Archivos grandes",
    "oldAction": "Archivos antiguos",
    "tempAction": "Archivos temporales",
    "installersAction": "Instaladores APK",
    "archivesAction": "Archivos comprimidos",
    "review": "Revisar",
    "scanAgain": "Analizar de nuevo",
    "close": "Cerrar",
    "viewResults": "Ver recomendaciones",
    "reviewTitle": "Revisar archivos",
    "selected": "seleccionados",
    "selectAll": "Seleccionar todo",
    "clearSelection": "Limpiar selección",
    "selectUpTo": "Seleccionar hasta",
    "deleteSelected": "Eliminar seleccionados",
    "deleteTitle": "¿Eliminar los archivos seleccionados?",
    "deleteBody": "Bearagnostic eliminará permanentemente solo los archivos que seleccionaste. Esto no se puede deshacer.",
    "deleteNow": "Eliminar archivos",
    "keep": "Conservar",
    "lowRisk": "Bajo riesgo",
    "needsReview": "Revisar",
    "protectedCopy": "Conservar una copia",
    "loadMore": "Cargar más",
    "resultsUpdated": "Limpieza terminada",
    "reclaimed": "recuperado",
    "deleted": "archivos eliminados",
    "rescanNote": "Los resultados ya están actualizados. Analiza de nuevo solo cuando quieras una revisión nueva de todo el dispositivo.",
    "backResults": "Volver a resultados",
    "resultHeroTitle": "Tu almacenamiento, más claro.",
    "resultHeroLow": "Los elementos de bajo riesgo están listos para revisar. Bearagnostic seguirá pidiendo confirmación antes de eliminar nada.",
    "resultHeroReview": "Aquí no hay limpieza con un solo toque, y es intencional. Revisa solo las categorías que te importan.",
    "resultHeroClear": "Nada de este análisis necesita revisión de limpieza en este momento.",
    "overviewTitle": "De un vistazo",
    "readyNow": "Listo para limpiar",
    "reviewItems": "Elementos para revisar",
    "categoriesFound": "Categorías",
    "items": "elementos",
    "sessionTitle": "Esta sesión",
    "sessionEmpty": "Todavía no se ha eliminado nada",
    "safetyTitle": "Protegido por diseño",
    "safetyBody": "Los archivos grandes, antiguos, APK y comprimidos permanecen solo para revisión. Los duplicados exactos siempre conservan al menos una copia.",
    "zeroAction": "Archivos de cero bytes",
    "resultKicker": "ANÁLISIS COMPLETADO",
    "reviewByCategory": "Revisar por categoría",
    "scanFacts": "Datos del análisis",
    "filesReviewedLabel": "Archivos revisados",
    "localLabel": "En el dispositivo",
    "modeLabel": "Modo",
    "recommendFirst": "RECOMENDADO PRIMERO",
    "startHere": "Empieza aquí",
    "spaceReclaimed": "Espacio recuperado",
    "reason_stale_incomplete_download": "Descarga incompleta antigua",
    "reason_temporary_artifact": "Artefacto temporal — revisar primero",
    "reason_verified_duplicate": "Copia idéntica confirmada",
    "reason_large_file": "Archivo grande — el tamaño por sí solo no es basura",
    "reason_old_file": "Archivo antiguo — la antigüedad por sí sola no es basura",
    "reason_apk_installer": "Instalador APK descargado",
    "reason_archive_file": "Archivo comprimido — puede ser la única copia",
    "reason_zero_byte": "Archivo de cero bytes — revisar contexto"
  },
  "pt-BR": {
    "eyebrow": "PROFUNDIDADE DO SCAN",
    "title": "Escolha a profundidade do scan",
    "lead": "A experiência original do Bearagnostic permanece inalterada. Escolha apenas quanto da análise nativa será executada.",
    "smart": "Smart Scan",
    "smartSub": "Todo o armazenamento compartilhado acessível, amostragem de conteúdo e duplicados verificados de forma focada.",
    "smartBadge": "RECOMENDADO",
    "quick": "Quick Scan",
    "quickSub": "Todo o armazenamento compartilhado acessível usando metadados e regras leves. Rápido por design.",
    "deep": "Deep Scan",
    "deepSub": "Todo o armazenamento compartilhado acessível, leitura completa do conteúdo por streaming e verificação de duplicados exatos.",
    "custom": "Custom Scan",
    "customSub": "Escolha categorias do armazenamento compartilhado e a verificação de duplicados.",
    "cancel": "Cancelar",
    "customTitle": "Custom Scan",
    "downloads": "Downloads",
    "photos": "Fotos",
    ...
    "documents": "Documentos",
    "music": "Música",
    "verify": "Verificar duplicados exatos",
    "start": "Iniciar Custom Scan",
    "permission": "Permita acesso ao armazenamento nas configurações do Android para iniciar este scan.",
    "busy": "Um scan já está em andamento.",
    "failed": "O Bearagnostic não conseguiu concluir esta verificação.",
    "cancelled": "Verificação cancelada.",
    "ready": "PRONTO",
    "scanning": "VERIFICANDO",
    "complete": "CONCLUÍDO",
    "idleTitle": "Pronto para uma verificação",
    "idleSub": "Escolha um modo de scan. O Dr. Bear verifica apenas o armazenamento permitido pelo Android.",
    "runningTitle": "Verificando tudo",
    "runningSub": "Um dispositivo mais limpo ajuda tudo a fluir melhor.",
    "doneTitle": "Verificação concluída",
    "doneSub": "O escopo acessível deste scan foi verificado localmente.",
    "quoteIdle": "Seus arquivos. Sua escolha.",
    "quoteRunning": "Verificando com cuidado. Ursos não apressam diagnósticos.",
    "quoteDone": "Tudo pronto. Os números exibidos vêm do scan nativo.",
    "tip": "O Bearagnostic analisa localmente os arquivos acessíveis neste dispositivo.",
    "home": "Início",
    "nextSteps": "Plano de limpeza",
    "nextLead": "Seu scan foi concluído. Nada muda até você escolher.",
    "reviewClean": "Revisar e limpar",
    "reviewCleanSub": "Somente candidatos à limpeza de baixo risco",
    "noLowRisk": "Nenhuma limpeza automática de baixo risco foi encontrada. Revise as categorias abaixo.",
    "duplicatesAction": "Duplicados exatos",
    "largeAction": "Arquivos grandes",
    "oldAction": "Arquivos antigos",
    "tempAction": "Arquivos temporários",
    "installersAction": "Instaladores APK",
    "archivesAction": "Arquivos compactados",
    "review": "Revisar",
    "scanAgain": "Verificar novamente",
    "close": "Fechar",
    "viewResults": "Ver recomendações",
    "reviewTitle": "Revisar arquivos",
    "selected": "selecionados",
    "selectAll": "Selecionar tudo",
    "clearSelection": "Limpar seleção",
    "selectUpTo": "Selecionar até",
    "deleteSelected": "Excluir selecionados",
    "deleteTitle": "Excluir os arquivos selecionados?",
    "deleteBody": "O Bearagnostic excluirá permanentemente apenas os arquivos que você selecionou. Isso não pode ser desfeito.",
    "deleteNow": "Excluir arquivos",
    "keep": "Manter",
    "lowRisk": "Baixo risco",
    "needsReview": "Revisar",
    "protectedCopy": "Manter uma cópia",
    "loadMore": "Carregar mais",
    "resultsUpdated": "Limpeza concluída",
    "reclaimed": "recuperado",
    "deleted": "arquivos excluídos",
    "rescanNote": "Os resultados já estão atualizados. Faça um novo scan apenas quando quiser uma nova verificação de todo o dispositivo.",
    "backResults": "Voltar aos resultados",
    "resultHeroTitle": "Seu armazenamento, mais claro.",
    "resultHeroLow": "Os itens de baixo risco estão prontos para revisão. O Bearagnostic ainda pede confirmação antes de excluir qualquer coisa.",
    "resultHeroReview": "Não há limpeza com um toque aqui — e isso é intencional. Revise apenas as categorias que importam para você.",
    "resultHeroClear": "Nada neste scan precisa de revisão de limpeza agora.",
    "overviewTitle": "Visão geral",
    "readyNow": "Pronto para limpar",
    "reviewItems": "Itens para revisar",
    "categoriesFound": "Categorias",
    "items": "itens",
    "sessionTitle": "Esta sessão",
    "sessionEmpty": "Nada removido ainda",
    "safetyTitle": "Protegido por design",
    "safetyBody": "Arquivos grandes, antigos, APK e compactados permanecem apenas para revisão. Duplicados exatos sempre mantêm pelo menos uma cópia.",
    "zeroAction": "Arquivos de zero bytes",
    "resultKicker": "SCAN CONCLUÍDO",
    "reviewByCategory": "Revisar por categoria",
    "scanFacts": "Dados do scan",
    "filesReviewedLabel": "Arquivos revisados",
    "localLabel": "No dispositivo",
    "modeLabel": "Modo",
    "recommendFirst": "RECOMENDADO PRIMEIRO",
    "startHere": "Comece aqui",
    "spaceReclaimed": "Espaço recuperado",
    "reason_stale_incomplete_download": "Download incompleto antigo",
    "reason_temporary_artifact": "Artefato temporário — revisar primeiro",
    "reason_verified_duplicate": "Cópia idêntica confirmada",
    "reason_large_file": "Arquivo grande — tamanho, por si só, não é lixo",
    "reason_old_file": "Arquivo antigo — idade, por si só, não é lixo",
    "reason_apk_installer": "Instalador APK baixado",
    "reason_archive_file": "Arquivo compactado — pode ser a única cópia",
    "reason_zero_byte": "Arquivo de zero bytes — revisar contexto"
  }
};
  ...
  function trustCopy() {
    ...
    if(lang==='th') return {
      ...
      share:'แชร์ผลลัพธ์', shareTitle:'ผลการทำความสะอาด Bearagnostic', shareIntro:'Bearagnostic นับเฉพาะผลลัพธ์ที่ตรวจยืนยันได้จากเครื่องนี้',
      shareUnavailable:'ยังไม่สามารถเปิดหน้าต่างแชร์ได้', proof:'นับเฉพาะไฟล์ที่ Android ยืนยันว่าลบสำเร็จแล้ว',
      supportOnline:'Ko-fi จะเปิดในเบราว์เซอร์เมื่อคุณเลือกสนับสนุนเท่านั้น การวิเคราะห์ไฟล์และผลสแกนยังคงอยู่ในเครื่อง',
      planFree:'Bearagnostic Free', planComing:'Pro จะไม่ล็อกคำแนะนำด้านความปลอดภัย คำเตือน หรือสิทธิ์ Free ที่คุณมีอยู่แล้ว'
    };
    if(lang==='ja') return {
      ...
      supportOnline:'Ko-fi は「サポート」を選んだときだけブラウザで開きます。ファイル解析とスキャン結果は端末内のままです。',
      planFree:'Bearagnostic Free', planComing:'Pro が安全ガイダンス、警告、現在の Free アクセスを有料化することはありません。'
    };
    if(lang==='es') return {
      moreTitle:'Ajustes y soporte', moreSub:'Privacidad, ayuda, soporte e información de la app',
      safe:'Eliminar con confianza', review:'Revisar antes de eliminar', protected:'Protegido',
      lowriskTitle:'Elementos de bajo riesgo', lowriskBody:'Estos elementos ya cumplen las reglas de bajo riesgo de Bearagnostic. Aun así, siempre puedes revisarlos y confirmar antes de eliminar.',
      duplicatesTitle:'Duplicados exactos', duplicatesBody:'Son copias verificadas como idénticas. Bearagnostic siempre conserva al menos una copia.',
      largeTitle:'Archivos grandes', largeBody:'Un archivo grande no es basura por sí mismo. Puede ser un vídeo, trabajo o copia de seguridad importante; revisa el contexto antes de eliminarlo.',
      oldTitle:'Archivos antiguos', oldBody:'La antigüedad por sí sola no es motivo para eliminar. Comprueba si el archivo sigue siendo útil o si es una copia que necesitas conservar.',
      temporaryTitle:'Archivos temporales', temporaryBody:'Algunos pueden ser descargas incompletas de bajo riesgo, pero no todos los archivos temporales son prescindibles. Revisa los que no estén clasificados como de bajo riesgo.',
      installersTitle:'Instaladores APK', installersBody:'Eliminar un APK no desinstala la app instalada; solo elimina el instalador del dispositivo. Consérvalo si aún lo necesitas para reinstalar.',
      archivesTitle:'Archivos comprimidos', archivesBody:'Un ZIP u otro archivo comprimido puede ser la única copia de los datos que contiene. Revisa su contenido u origen antes de eliminarlo.',
      zeroTitle:'Archivos de 0 bytes', zeroBody:'Un archivo vacío puede no contener datos, pero algunas apps lo usan como marcador o placeholder. Revisa su ubicación antes de eliminarlo.',
      reviewTitle:'Consejo de Dr. Bear', destructiveTitle:'Revisa una vez más antes de eliminar', destructiveBody:'Esta eliminación es permanente y solo afecta a los elementos seleccionados. Comprueba el nombre, la ubicación y el impacto antes de confirmar.',
      impactTitle:'Resultado de la limpieza', verifiedSpace:'Espacio realmente recuperado', freeStorage:'Espacio libre', filesRemoved:'Archivos eliminados', duplicatesResolved:'Copias duplicadas resueltas', protectedKept:'Copias protegidas', lowRiskResolved:'Elementos de bajo riesgo resueltos',
      share:'Compartir resultado', shareTitle:'Resultado de limpieza de Bearagnostic', shareIntro:'Bearagnostic contabilizó únicamente resultados que pudo verificar en este dispositivo.',
      shareUnavailable:'No se pudo abrir el panel para compartir', proof:'Solo se cuentan los archivos que Android confirmó como eliminados.',
      supportOnline:'Ko-fi se abre en tu navegador solo cuando eliges Soporte. El análisis de archivos y los resultados permanecen en el dispositivo.',
      planFree:'Bearagnostic Free', planComing:'Pro nunca bloquea las indicaciones de seguridad, las advertencias ni tu acceso Free actual.'
    };
    if(lang==='pt-BR') return {
      moreTitle:'Configurações e suporte', moreSub:'Privacidade, ajuda, suporte e informações do app',
      safe:'Excluir com confiança', review:'Revisar antes de excluir', protected:'Protegido',
      lowriskTitle:'Itens de baixo risco', lowriskBody:'Esses itens já atendem às regras de baixo risco do Bearagnostic. Mesmo assim, você sempre pode revisar e confirmar antes de excluir.',
      duplicatesTitle:'Duplicados exatos', duplicatesBody:'São cópias verificadas como idênticas. O Bearagnostic sempre mantém pelo menos uma cópia.',
      largeTitle:'Arquivos grandes', largeBody:'Um arquivo grande não é lixo só por ser grande. Pode ser um vídeo, trabalho ou backup importante; revise o contexto antes de excluir.',
      oldTitle:'Arquivos antigos', oldBody:'A idade do arquivo, sozinha, não é motivo para excluir. Verifique se ele ainda é útil ou se é uma cópia que precisa ser mantida.',
      temporaryTitle:'Arquivos temporários', temporaryBody:'Alguns podem ser downloads incompletos de baixo risco, mas nem todo arquivo temporário é descartável. Revise os que não forem classificados como baixo risco.',
      installersTitle:'Instaladores APK', installersBody:'Excluir um APK não desinstala o app instalado; apenas remove o instalador do dispositivo. Mantenha-o se ainda precisar reinstalar.',
      archivesTitle:'Arquivos compactados', archivesBody:'Um ZIP ou outro arquivo compactado pode ser a única cópia dos dados que contém. Revise o conteúdo ou a origem antes de excluir.',
      zeroTitle:'Arquivos de 0 bytes', zeroBody:'Um arquivo vazio pode não conter dados, mas alguns apps o usam como marcador ou placeholder. Revise a localização antes de excluir.',
      reviewTitle:'Conselho do Dr. Bear', destructiveTitle:'Revise mais uma vez antes de excluir', destructiveBody:'Esta exclusão é permanente e afeta somente os itens selecionados. Confira o nome, a localização e o impacto antes de confirmar.',
      impactTitle:'Resultado da limpeza', verifiedSpace:'Espaço realmente recuperado', freeStorage:'Espaço livre', filesRemoved:'Arquivos excluídos', duplicatesResolved:'Cópias duplicadas resolvidas', protectedKept:'Cópias protegidas', lowRiskResolved:'Itens de baixo risco resolvidos',
      share:'Compartilhar resultado', shareTitle:'Resultado da limpeza do Bearagnostic', shareIntro:'O Bearagnostic contabilizou apenas resultados que conseguiu verificar neste dispositivo.',
      shareUnavailable:'Não foi possível abrir a tela de compartilhamento', proof:'Somente arquivos que o Android confirmou como excluídos são contabilizados.',
      supportOnline:'O Ko-fi abre no navegador somente quando você escolhe Suporte. A análise dos arquivos e os resultados permanecem no dispositivo.',
      planFree:'Bearagnostic Free', planComing:'O Pro nunca bloqueia orientações de segurança, avisos ou seu acesso Free atual.'
    };
    return {
      ...
      supportOnline:'Ko-fi opens in your browser only when you choose Support. File analysis and scan results remain on device.',
      planFree:'Bearagnostic Free', planComing:'Pro never paywalls safety guidance, warnings or your existing Free access.'
    };
  }
  ...
  function setScanState(state) {
    ...
    if(action){ const l=currentLanguage(); action.disabled=state==='running'; action.textContent=state==='running'?(l==='th'?'กำลังตรวจไฟล์…':l==='ja'?'チェック中…':l==='es'?'Análisis en curso…':l==='pt-BR'?'Verificação em andamento…':'Scanning in progress…'):(state==='complete'?text('viewResults'):(l==='th'?'เลือกโหมดสแกน':l==='ja'?'スキャン方法を選ぶ':l==='es'?'Elegir modo de análisis':l==='pt-BR'?'Escolher modo de verificação':'Choose scan mode')); }
  ...
  function formatDate(value) {
    ...
    try{return new Intl.DateTimeFormat(currentLanguage()==='th'?'th-TH':currentLanguage()==='ja'?'ja-JP':currentLanguage()==='es'?'es-ES':currentLanguage()==='pt-BR'?'pt-BR':'en-US',{year:'numeric',month:'short',day:'numeric'}).format(new Date(n));}catch(_){return '';}
  }
  ...
  function preferenceCopy(){
    const lang=currentLanguage();
    if(lang==='th') return {
      intro:'การสแกน ความปลอดภัย ความเป็นส่วนตัว และการทำงานของแอพ', scanTitle:'การสแกนและการวิเคราะห์',scanSub:'ตั้งค่าพฤติกรรมหลักของ Bearagnostic', smart:'โหมดแนะนำ',smartValue:'Smart Scan',scope:'ขอบเขต Quick Scan',scopeValue:'พื้นที่ shared storage ที่เข้าถึงได้', safetyTitle:'ความปลอดภัยในการทำความสะอาด',safetySub:'กฎป้องกันข้อมูลสำคัญที่ปิดไม่ได้', confirm:'ยืนยันก่อนลบ',confirmValue:'เสมอ',duplicate:'การป้องกันไฟล์ซ้ำ',duplicateValue:'เก็บไว้อย่างน้อย 1 สำเนา', privacyTitle:'ความเป็นส่วนตัวและสิทธิ์',privacySub:'วิเคราะห์ไฟล์ภายในเครื่องโดยไม่อัปโหลด', local:'การวิเคราะห์ไฟล์',localValue:'บนเครื่องเท่านั้น',access:'สิทธิ์เข้าถึงไฟล์',allowed:'อนุญาตแล้ว',needs:'ต้องอนุญาต', aboutTitle:'Bearagnostic for Android',aboutSub:'Benedict Interactive',version:'เวอร์ชัน'
    };
    if(lang==='ja') return {
      intro:'スキャン、安全性、プライバシー、アプリ動作', scanTitle:'スキャンと解析',scanSub:'Bearagnostic の基本動作', smart:'推奨モード',smartValue:'Smart Scan',scope:'Quick Scan の範囲',scopeValue:'アクセス可能な共有ストレージ', safetyTitle:'クリーンアップの安全性',safetySub:'重要なデータを守る必須ルール', confirm:'削除前の確認',confirmValue:'常に確認',duplicate:'重複保護',duplicateValue:'最低1コピーを保持', privacyTitle:'プライバシーとアクセス',privacySub:'ファイルは端末内で解析し、アップロードしません', local:'ファイル解析',localValue:'端末内のみ',access:'ストレージアクセス',allowed:'許可済み',needs:'許可が必要', aboutTitle:'Bearagnostic for Android',aboutSub:'Benedict Interactive',version:'バージョン'
    };
    if(lang==='es') return {
      intro:'Análisis, seguridad, privacidad y comportamiento de la app', scanTitle:'Análisis y revisión',scanSub:'Comportamiento principal de Bearagnostic', smart:'Modo recomendado',smartValue:'Smart Scan',scope:'Alcance de Quick Scan',scopeValue:'Todo el almacenamiento compartido accesible', safetyTitle:'Seguridad de limpieza',safetySub:'Protección no negociable para tus archivos', confirm:'Confirmar antes de eliminar',confirmValue:'Siempre',duplicate:'Protección de duplicados',duplicateValue:'Conservar al menos 1 copia', privacyTitle:'Privacidad y acceso',privacySub:'Los archivos se analizan localmente y no se suben', local:'Análisis de archivos',localValue:'Solo en el dispositivo',access:'Acceso al almacenamiento',allowed:'Permitido',needs:'Permiso necesario', aboutTitle:'Bearagnostic para Android',aboutSub:'Benedict Interactive',version:'Versión'
    };
    if(lang==='pt-BR') return {
      intro:'Análise, segurança, privacidade e comportamento do app', scanTitle:'Análise e verificação',scanSub:'Comportamento principal do Bearagnostic', smart:'Modo recomendado',smartValue:'Smart Scan',scope:'Escopo do Quick Scan',scopeValue:'Todo o armazenamento compartilhado acessível', safetyTitle:'Segurança da limpeza',safetySub:'Proteção inegociável para seus arquivos', confirm:'Confirmar antes de excluir',confirmValue:'Sempre',duplicate:'Proteção de duplicados',duplicateValue:'Manter pelo menos 1 cópia', privacyTitle:'Privacidade e acesso',privacySub:'Os arquivos são analisados localmente e não são enviados', local:'Análise de arquivos',localValue:'Somente no dispositivo',access:'Acesso ao armazenamento',allowed:'Permitido',needs:'Permissão necessária', aboutTitle:'Bearagnostic para Android',aboutSub:'Benedict Interactive',version:'Versão'
    };
    return {
      intro:'Scan, safety, privacy and app behavior', scanTitle:'Scan & analysis',scanSub:'Core Bearagnostic behavior', smart:'Recommended mode',smartValue:'Smart Scan',scope:'Quick Scan scope',scopeValue:'All accessible shared storage', safetyTitle:'Cleanup safety',safetySub:'Non-negotiable protection for your files', confirm:'Confirm before delete',confirmValue:'Always',duplicate:'Duplicate protection',duplicateValue:'Keep at least 1 copy', privacyTitle:'Privacy & access',privacySub:'Files are analyzed locally and are not uploaded', local:'File analysis',localValue:'On device only',access:'Storage access',allowed:'Allowed',needs:'Permission needed', aboutTitle:'Bearagnostic for Android',aboutSub:'Benedict Interactive',version:'Version'
    };
  }
  ...
  function ensureTrustSurfaces() {
    ...
    if(modePanel){
      ...
      const l=currentLanguage(); const guideBody=l==='th'?'เลือกความลึกให้เหมาะกับเวลาที่มี และสิ่งที่ต้องการตรวจจริง':l==='ja'?'時間と目的に合う深さを選べます。':l==='es'?'Elige la profundidad que encaje con tu tiempo y con lo que realmente quieres revisar.':l==='pt-BR'?'Escolha a profundidade que combina com seu tempo e com o que você realmente quer revisar.':'Choose the depth that fits your time and what you actually want to inspect.';
  ...
  function renderCleanupImpact(count,reclaimed,result,liveReview,beforeStorage,afterStorage) {
    ...
    { const l=currentLanguage(); byId('nativeImpactResolved').textContent=resolved==null?(l==='th'?'ตรวจเอง':l==='ja'?'手動確認':l==='es'?'Revisión manual':l==='pt-BR'?'Revisão manual':'Manual review'):`${Math.round(resolved)}%`; }
  ...
  function openResults(data=lastCompleteResult) {
    ...
    { const l=currentLanguage(); byId('nativeDurationFactLabel').textContent=l==='th'?'เวลาสแกน':l==='ja'?'所要時間':l==='es'?'Duración':l==='pt-BR'?'Duração':'Duration'; }
    ...
    { const l=currentLanguage(); byId('nativeCoverageFactLabel').textContent=l==='th'?'ความครอบคลุม':l==='ja'?'カバレッジ':l==='es'?'Cobertura':l==='pt-BR'?'Cobertura':'Coverage'; }
