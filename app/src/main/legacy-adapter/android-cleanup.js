(() => {
  ...
  "en": {
    "kicker": "QUICK CLEAN",
    "title": "Clean the low-risk clutter first",
    ...
    "scanNow": "Run Smart Checkup",
    "permissionTitle": "Storage access is needed",
    ...
    "scanningTitle": "Checking for safe cleanup candidates",
    ...
    "liveSource": "SOURCE",
    "liveSourceSmart": "Live Smart Checkup",
    "liveSourceActive": "Active checkup",
    "snapshotSource": "RESULT SOURCE",
    "scopeLabel": "SCOPE",
    "scopeAccessible": "Accessible shared storage",
    "scopeCustom": "Selected Custom Scan scope",
    "safetyLabel": "SAFETY",
    "lowRiskOnly": "Low-risk only",
    "phasePreparing": "Discovering storage",
    "phaseDetails": "Reviewing file details",
    "phaseSizes": "Measuring file sizes",
    "phaseDuplicates": "Verifying duplicates",
    "phaseDates": "Checking modified dates",
    "phaseFinalizing": "Building safe results",
    "filesReviewedLive": "Files reviewed",
    "foldersVisited": "Folders visited",
    "dataSeen": "Data seen",
    "contentSampled": "Content sampled",
    "storageMeasured": "Storage measured",
    "verificationRead": "Verification read",
    "localLive": "LOCAL · LIVE",
    "nowChecking": "Now checking",
    "waitingItem": "Preparing the next item…",
    "realWorkNote": "This view follows the scan’s real work. It finishes when that work finishes — no padded waiting.",
    "emptyKicker": "QUICK CLEAN RESULT",
    "lowRiskResult": "Low-risk result",
    "checkedAt": "Checked",
    "zeroItems": "0 items",
    "reviewFirstTitle": "Review-first opportunities",
    "reviewFirstBody": "These stay separate because they need your judgement before anything is removed.",
    "duplicatesNext": "Duplicates",
    "largeNext": "Large files",
    "olderNext": "Older files",
    "reviewCount": "{count} to review",
    "noneReviewFirst": "No duplicate, large-file or older-file review items were surfaced in this snapshot.",
    "openReview": "Review",
    "checkAgain": "Check again",
    "safeItems": "Safe candidates",
    "reclaimable": "Selected size",
    "fromCheckup": "Review snapshot",
    "current": "Current",
    ...
    "selected": "selected",
    "of": "of",
    "safeBadge": "SAFE TO CLEAN",
    "staleReason": "Stale incomplete download",
    "genericReason": "Low-risk cleanup candidate",
    ...
    "confirmTitle": "Delete the selected files?",
    ...
    "doneKicker": "VERIFIED CLEANUP",
    "doneTitle": "Cleanup complete",
    "reclaimed": "reclaimed",
    "removed": "files removed",
    "verifiedBody": "Only successfully verified deletions are included in the result.",
    "failedTitle": "Some files were not removed",
    "failedBody": "{count} item(s) could not be deleted and were not counted as reclaimed space.",
    "protectedTitle": "Safety protection applied",
    "protectedBody": "{count} item(s) were retained by native safeguards.",
    "reviewRemaining": "Review remaining",
    "done": "Done",
    "errorTitle": "Quick Clean could not continue",
    "retry": "Try again",
    "noAccess": "Storage access is still unavailable.",
    "scanFailed": "Smart Checkup could not start.",
    "scanModeSmart": "Smart Checkup",
    "scanModeQuick": "Quick Scan",
    "scanModeDeep": "Deep Scan",
    "scanModeCustom": "Custom Scan",
    "homeReady": "{count} safe candidates ready",
    "homeClear": "No low-risk cleanup waiting",
    "homeReadyShort": "{count} safe · review",
    "homeClearShort": "No safe clutter",
    "itemAge": "{age}",
    "unknownLocation": "Shared storage",
    "selectedSummary": "{count} selected · {bytes}",
    "pageLimit": "Up to 500 files can be deleted in one reviewed batch."
  },
  "th": {
    "kicker": "ทำความสะอาดด่วน",
    "title": "เริ่มจากไฟล์ที่เสี่ยงต่ำก่อน",
    ...
    "scanNow": "เริ่ม Smart Checkup",
    "permissionTitle": "ต้องอนุญาตการเข้าถึงพื้นที่จัดเก็บ",
    ...
    "scanningTitle": "กำลังหารายการที่เหมาะกับ Quick Clean",
    ...
    "liveSource": "แหล่งข้อมูล",
    "liveSourceSmart": "Smart Checkup ที่กำลังทำงาน",
    "liveSourceActive": "การตรวจที่กำลังทำงาน",
    "snapshotSource": "แหล่งผลลัพธ์",
    "scopeLabel": "ขอบเขต",
    "scopeAccessible": "shared storage ที่เข้าถึงได้",
    "scopeCustom": "ขอบเขต Custom Scan ที่เลือก",
    "safetyLabel": "ความปลอดภัย",
    "lowRiskOnly": "เฉพาะความเสี่ยงต่ำ",
    "phasePreparing": "กำลังค้นหาพื้นที่จัดเก็บ",
    "phaseDetails": "กำลังตรวจรายละเอียดไฟล์",
    "phaseSizes": "กำลังวัดขนาดไฟล์",
    "phaseDuplicates": "กำลังยืนยันไฟล์ซ้ำ",
    "phaseDates": "กำลังตรวจวันที่แก้ไข",
    "phaseFinalizing": "กำลังสร้างผลลัพธ์ที่ปลอดภัย",
    "filesReviewedLive": "ไฟล์ที่ตรวจแล้ว",
    "foldersVisited": "โฟลเดอร์ที่ตรวจ",
    "dataSeen": "ข้อมูลที่พบ",
    "contentSampled": "เนื้อหาที่อ่านตัวอย่าง",
    "storageMeasured": "พื้นที่ที่วัดแล้ว",
    "verificationRead": "ข้อมูลที่อ่านเพื่อยืนยัน",
    "localLive": "บนเครื่อง · เรียลไทม์",
    "nowChecking": "กำลังตรวจ",
    "waitingItem": "กำลังเตรียมรายการถัดไป…",
    "realWorkNote": "หน้านี้แสดงงานจากการสแกนจริง และจะจบเมื่องานจริงเสร็จ ไม่มีการหน่วงเวลาเพื่อให้ดูนาน",
    "emptyKicker": "ผล QUICK CLEAN",
    "lowRiskResult": "ผลความเสี่ยงต่ำ",
    "checkedAt": "ตรวจเมื่อ",
    "zeroItems": "0 รายการ",
    "reviewFirstTitle": "รายการที่ควรตรวจต่อ",
    "reviewFirstBody": "รายการเหล่านี้ถูกแยกไว้ เพราะต้องให้คุณพิจารณาก่อนมีการลบ",
    "duplicatesNext": "ไฟล์ซ้ำ",
    "largeNext": "ไฟล์ขนาดใหญ่",
    "olderNext": "ไฟล์เก่า",
    "reviewCount": "{count} รายการให้ตรวจ",
    "noneReviewFirst": "ไม่พบไฟล์ซ้ำ ไฟล์ขนาดใหญ่ หรือไฟล์เก่าที่ต้องตรวจต่อใน snapshot นี้",
    "openReview": "ตรวจรายการ",
    "checkAgain": "ตรวจอีกครั้ง",
    "safeItems": "รายการเสี่ยงต่ำ",
    "reclaimable": "ขนาดที่เลือก",
    "fromCheckup": "ข้อมูลจากการตรวจ",
    "current": "ล่าสุด",
    "refreshRecommended": "แนะนำให้ตรวจใหม่",
    ...
    "selected": "เลือกแล้ว",
    "of": "จาก",
    "safeBadge": "ปลอดภัยระดับต่ำ",
    "staleReason": "ไฟล์ดาวน์โหลดไม่สมบูรณ์ที่ค้างไว้นาน",
    "genericReason": "รายการทำความสะอาดความเสี่ยงต่ำ",
    ...
    "refresh": "ตรวจ Smart Checkup ใหม่",
    "close": "ปิด",
    ...
    "doneKicker": "ผลการลบที่ยืนยันแล้ว",
    "doneTitle": "ทำความสะอาดเรียบร้อย",
    "reclaimed": "พื้นที่ที่คืนได้",
    "removed": "ไฟล์ที่ลบแล้ว",
    "verifiedBody": "ผลลัพธ์นับเฉพาะไฟล์ที่ลบสำเร็จและตรวจยืนยันแล้วเท่านั้น",
    "failedTitle": "มีบางไฟล์ที่ลบไม่สำเร็จ",
    "failedBody": "ลบไม่สำเร็จ {count} รายการ และจะไม่นับพื้นที่ของรายการเหล่านี้เป็นพื้นที่ที่คืนได้",
    "protectedTitle": "ระบบความปลอดภัยทำงาน",
    "protectedBody": "มี {count} รายการที่ระบบ Native เก็บไว้ตามกฎป้องกันการลบ",
    "reviewRemaining": "ดูรายการที่เหลือ",
    "done": "เสร็จสิ้น",
    "errorTitle": "Quick Clean ทำงานต่อไม่ได้",
    "retry": "ลองอีกครั้ง",
    "noAccess": "ยังไม่มีสิทธิ์เข้าถึงพื้นที่จัดเก็บ",
    "scanFailed": "ไม่สามารถเริ่ม Smart Checkup ได้",
    "scanModeSmart": "Smart Checkup",
    "scanModeQuick": "Quick Scan",
    "scanModeDeep": "Deep Scan",
    "scanModeCustom": "Custom Scan",
    "homeReady": "มี {count} รายการเสี่ยงต่ำพร้อมตรวจ",
    "homeClear": "ไม่มีรายการความเสี่ยงต่ำค้างอยู่",
    "homeReadyShort": "{count} รายการ · ตรวจ",
    "homeClearShort": "ไม่มีไฟล์เสี่ยงต่ำ",
    "itemAge": "{age}",
    "unknownLocation": "พื้นที่จัดเก็บร่วม",
    "selectedSummary": "เลือก {count} รายการ · {bytes}",
  ...
  "ja": {
    ...
    "liveSource": "ソース",
    "liveSourceSmart": "実行中の Smart Checkup",
    "liveSourceActive": "実行中のチェック",
    "snapshotSource": "結果ソース",
    "scopeLabel": "範囲",
    "scopeAccessible": "アクセス可能な共有ストレージ",
    "scopeCustom": "選択した Custom Scan 範囲",
    "safetyLabel": "安全性",
    "lowRiskOnly": "低リスクのみ",
    "phasePreparing": "ストレージを探索中",
    "phaseDetails": "ファイル情報を確認中",
    "phaseSizes": "ファイルサイズを確認中",
    "phaseDuplicates": "重複を検証中",
    "phaseDates": "更新日を確認中",
    "phaseFinalizing": "安全な結果を作成中",
    "filesReviewedLive": "確認済みファイル",
    "foldersVisited": "確認フォルダ",
    "dataSeen": "確認データ",
    "contentSampled": "サンプル読取量",
    "storageMeasured": "計測済み容量",
    "verificationRead": "検証読取量",
    "localLive": "端末内 · リアルタイム",
    "nowChecking": "確認中",
    "waitingItem": "次の項目を準備中…",
    "realWorkNote": "この画面は実際のスキャン処理に連動します。見せかけの待ち時間は追加しません。",
    "emptyKicker": "QUICK CLEAN 結果",
    "lowRiskResult": "低リスク結果",
    "checkedAt": "確認時刻",
    "zeroItems": "0 件",
    "reviewFirstTitle": "確認が必要な候補",
    "reviewFirstBody": "削除前に判断が必要なため、Quick Clean とは分けて表示します。",
    "duplicatesNext": "重複ファイル",
    "largeNext": "大きいファイル",
    "olderNext": "古いファイル",
    "reviewCount": "{count} 件を確認",
    "noneReviewFirst": "このスナップショットでは重複・大容量・古いファイルの確認候補もありません。",
    "openReview": "確認",
    "checkAgain": "再チェック",
    "safeItems": "低リスク候補",
    "reclaimable": "選択サイズ",
    "fromCheckup": "レビュースナップショット",
    "current": "最新",
    "refreshRecommended": "再チェック推奨",
    "minutesAgo": "分前",
    "justNow": "たった今",
    "safeTitle": "安全境界",
    ...
    "of": "/",
    "safeBadge": "低リスク",
    "staleReason": "古い未完了ダウンロード",
    "genericReason": "低リスク cleanup 候補",
    ...
    "confirmKicker": "最終確認",
    "confirmTitle": "選択したファイルを削除しますか？",
    "confirmBody": "現在のレビュースナップショットから選択した低リスクファイルだけを Android に送り、完全に削除します。元に戻せません。",
    "proof": "Android が実際に削除を確認したファイルだけ、空き容量として計上します。",
    "cancel": "キャンセル",
    "deleteVerify": "削除して検証",
    "deleting": "削除して確認中…",
    "doneKicker": "検証済みクリーンアップ",
    "doneTitle": "クリーンアップ完了",
    "reclaimed": "解放",
    "removed": "削除済みファイル",
    "verifiedBody": "削除成功を確認できたファイルだけを結果に含めています。",
    "failedTitle": "削除できなかったファイルがあります",
    "failedBody": "{count} 件は削除できず、解放容量にも含めていません。",
    "protectedTitle": "安全保護が適用されました",
    "protectedBody": "{count} 件は Native の安全ルールにより保持されました。",
    "reviewRemaining": "残りを確認",
    "done": "完了",
    "errorTitle": "Quick Clean を続行できません",
    "retry": "もう一度試す",
    "noAccess": "ストレージへのアクセスがまだありません。",
    "scanFailed": "Smart Checkup を開始できませんでした。",
    "scanModeSmart": "Smart Checkup",
    "scanModeQuick": "Quick Scan",
    "scanModeDeep": "Deep Scan",
    "scanModeCustom": "Custom Scan",
    "homeReady": "{count} 件の低リスク候補",
    "homeClear": "低リスク候補はありません",
    "homeReadyShort": "{count}件 · 確認",
    "homeClearShort": "低リスクなし",
    "itemAge": "{age}",
    "unknownLocation": "共有ストレージ",
    "selectedSummary": "{count} 件選択 · {bytes}",
    "pageLimit": "確認済みの1バッチで削除できるのは最大500ファイルです。"
  },
  "es": {
    "kicker": "LIMPIEZA RÁPIDA",
    "title": "Limpia primero el desorden de bajo riesgo",
    "lead": "Bearagnostic muestra solo candidatos de limpieza que ya cumplen sus reglas de bajo riesgo. Tú mantienes el control antes de eliminar nada.",
    "noSnapshotTitle": "Ejecuta primero un Smart Checkup",
    "noSnapshotBody": "Quick Clean usa la instantánea real de revisión más reciente. Un Smart Checkup crea esa instantánea localmente sin eliminar nada.",
    "scanNow": "Ejecutar Smart Checkup",
    "permissionTitle": "Se necesita acceso al almacenamiento",
    "permissionBody": "Android controla el acceso al almacenamiento compartido. Bearagnostic no puede revisar candidatos de limpieza hasta que ese permiso esté disponible.",
    "openSettings": "Abrir ajustes de Android",
    "scanningTitle": "Buscando candidatos seguros de limpieza",
    "scanningBody": "Smart Checkup se está ejecutando en este dispositivo. No se añade espera artificial; termina cuando finaliza el trabajo real del análisis.",
    "scanElsewhere": "Ya hay una revisión en curso. Quick Clean usará su instantánea de revisión verificada cuando termine.",
    "liveSource": "FUENTE",
    "liveSourceSmart": "Smart Checkup en vivo",
    "liveSourceActive": "Revisión activa",
    "snapshotSource": "FUENTE DEL RESULTADO",
    "scopeLabel": "ÁMBITO",
    "scopeAccessible": "Almacenamiento compartido accesible",
    "scopeCustom": "Ámbito seleccionado de Custom Scan",
    "safetyLabel": "SEGURIDAD",
    "lowRiskOnly": "Solo bajo riesgo",
    "phasePreparing": "Descubriendo almacenamiento",
    "phaseDetails": "Revisando detalles de archivos",
    "phaseSizes": "Midiendo tamaños de archivo",
    "phaseDuplicates": "Verificando duplicados",
    "phaseDates": "Revisando fechas de modificación",
    "phaseFinalizing": "Preparando resultados seguros",
    "filesReviewedLive": "Archivos revisados",
    "foldersVisited": "Carpetas visitadas",
    "dataSeen": "Datos revisados",
    "contentSampled": "Contenido muestreado",
    "storageMeasured": "Almacenamiento medido",
    "verificationRead": "Datos de verificación leídos",
    "localLive": "LOCAL · EN VIVO",
    "nowChecking": "Revisando ahora",
    "waitingItem": "Preparando el siguiente elemento…",
    "realWorkNote": "Esta vista sigue el trabajo real del análisis. Termina cuando ese trabajo termina, sin esperas artificiales.",
    "emptyKicker": "RESULTADO DE LIMPIEZA RÁPIDA",
    "lowRiskResult": "Resultado de bajo riesgo",
    "checkedAt": "Comprobado",
    "zeroItems": "0 elementos",
    "reviewFirstTitle": "Elementos para revisar primero",
    "reviewFirstBody": "Se mantienen separados porque requieren tu criterio antes de eliminar nada.",
    "duplicatesNext": "Duplicados",
    "largeNext": "Archivos grandes",
    "olderNext": "Archivos antiguos",
    "reviewCount": "{count} por revisar",
    "noneReviewFirst": "En esta instantánea no aparecieron duplicados, archivos grandes ni archivos antiguos para revisar.",
    "openReview": "Revisar",
    "checkAgain": "Revisar de nuevo",
    "safeItems": "Candidatos seguros",
    "reclaimable": "Tamaño seleccionado",
    "fromCheckup": "Instantánea de revisión",
    "current": "Actual",
    "refreshRecommended": "Se recomienda actualizar",
    "minutesAgo": "min atrás",
    "justNow": "ahora mismo",
    "safeTitle": "Límite de seguridad",
    "safeBody": "Quick Clean incluye solo candidatos de bajo riesgo. Los archivos grandes, antiguos, APK, comprimidos y duplicados exactos quedan fuera de esta lista de limpieza de un toque.",
    "selectAll": "Seleccionar todos los mostrados",
    "clear": "Limpiar",
    "selected": "seleccionados",
    "of": "de",
    "safeBadge": "SEGURO PARA LIMPIAR",
    "staleReason": "Descarga incompleta antigua",
    "genericReason": "Candidato de limpieza de bajo riesgo",
    "partialList": "Mostrando los primeros {shown} de {total} candidatos seguros. Limpia este lote y continúa con los elementos restantes.",
    "truncated": "El escáner alcanzó el límite seguro de detalle de revisión. Solo se muestran los candidatos presentes en esta instantánea verificada.",
    "noCandidatesTitle": "No hay nada de bajo riesgo que necesite limpieza",
    "noCandidatesBody": "Bearagnostic no encontró elementos que cumplan las reglas de seguridad de Quick Clean. Las categorías que requieren revisión permanecen separadas para que no se elimine nada ambiguo.",
    "refresh": "Actualizar Smart Checkup",
    "close": "Cerrar",
    "reviewSelected": "Revisar seleccionados",
    "staleBlockTitle": "Actualiza antes de eliminar",
    "staleBlockBody": "Esta instantánea de revisión tiene más de 15 minutos. Ejecuta un Smart Checkup nuevo antes de eliminar para basar la decisión en los archivos actuales.",
    "confirmKicker": "REVISIÓN FINAL",
    "confirmTitle": "¿Eliminar los archivos seleccionados?",
    "confirmBody": "Solo los archivos de bajo riesgo seleccionados en la instantánea actual se enviarán a Android para su eliminación permanente. Esto no se puede deshacer.",
    "proof": "El espacio solo se contabiliza después de que Android confirma que cada archivo realmente se eliminó.",
    "cancel": "Cancelar",
    "deleteVerify": "Eliminar y verificar",
    "deleting": "Eliminando y verificando…",
    "doneKicker": "LIMPIEZA VERIFICADA",
    "doneTitle": "Limpieza completada",
    "reclaimed": "recuperado",
    "removed": "archivos eliminados",
    "verifiedBody": "El resultado incluye solo eliminaciones verificadas correctamente.",
    "failedTitle": "Algunos archivos no se eliminaron",
    "failedBody": "No se pudieron eliminar {count} elemento(s) y no se contabilizaron como espacio recuperado.",
    "protectedTitle": "Protección de seguridad aplicada",
    "protectedBody": "Las protecciones nativas conservaron {count} elemento(s).",
    "reviewRemaining": "Revisar restantes",
    "done": "Listo",
    "errorTitle": "Quick Clean no pudo continuar",
    "retry": "Intentar de nuevo",
    "noAccess": "El acceso al almacenamiento sigue sin estar disponible.",
    "scanFailed": "No se pudo iniciar Smart Checkup.",
    "scanModeSmart": "Smart Checkup",
    "scanModeQuick": "Quick Scan",
    "scanModeDeep": "Deep Scan",
    "scanModeCustom": "Custom Scan",
    "homeReady": "{count} candidatos seguros listos",
    "homeClear": "No hay limpieza de bajo riesgo pendiente",
    "homeReadyShort": "{count} seguros · revisar",
    "homeClearShort": "Sin desorden seguro",
    "itemAge": "{age}",
    "unknownLocation": "Almacenamiento compartido",
    "selectedSummary": "{count} seleccionados · {bytes}",
    "pageLimit": "Se pueden eliminar hasta 500 archivos en un lote revisado."
  },
  "pt-BR": {
    "kicker": "LIMPEZA RÁPIDA",
    "title": "Limpe primeiro a bagunça de baixo risco",
    "lead": "O Bearagnostic mostra apenas candidatos à limpeza que já atendem às regras de baixo risco. Você mantém o controle antes de qualquer remoção.",
    "noSnapshotTitle": "Execute um Smart Checkup primeiro",
    "noSnapshotBody": "O Quick Clean usa o snapshot real de revisão mais recente. Um Smart Checkup cria esse snapshot localmente sem excluir nada.",
    "scanNow": "Executar Smart Checkup",
    "permissionTitle": "É necessário acesso ao armazenamento",
    "permissionBody": "O Android controla o acesso ao armazenamento compartilhado. O Bearagnostic não pode revisar candidatos à limpeza até que essa permissão esteja disponível.",
    "openSettings": "Abrir configurações do Android",
    "scanningTitle": "Procurando candidatos seguros para limpeza",
    "scanningBody": "O Smart Checkup está sendo executado neste dispositivo. Nenhuma espera artificial é adicionada; ele termina quando o trabalho real do scan termina.",
    "scanElsewhere": "Uma verificação já está em andamento. O Quick Clean usará o snapshot de revisão verificado quando ela terminar.",
    "liveSource": "FONTE",
    "liveSourceSmart": "Smart Checkup ao vivo",
    "liveSourceActive": "Verificação ativa",
    "snapshotSource": "FONTE DO RESULTADO",
    "scopeLabel": "ESCOPO",
    "scopeAccessible": "Armazenamento compartilhado acessível",
    "scopeCustom": "Escopo selecionado do Custom Scan",
    "safetyLabel": "SEGURANÇA",
    "lowRiskOnly": "Somente baixo risco",
    "phasePreparing": "Descobrindo armazenamento",
    ...
    "phaseFinalizing": "Preparando resultados seguros",
    "filesReviewedLive": "Arquivos revisados",
    "foldersVisited": "Pastas visitadas",
    "dataSeen": "Dados revisados",
    "contentSampled": "Conteúdo amostrado",
    "storageMeasured": "Armazenamento medido",
    "verificationRead": "Dados de verificação lidos",
    "localLive": "LOCAL · AO VIVO",
    "nowChecking": "Verificando agora",
    "waitingItem": "Preparando o próximo item…",
    "realWorkNote": "Esta tela acompanha o trabalho real do scan. Ela termina quando esse trabalho termina, sem espera artificial.",
    "emptyKicker": "RESULTADO DA LIMPEZA RÁPIDA",
    "lowRiskResult": "Resultado de baixo risco",
    "checkedAt": "Verificado",
    "zeroItems": "0 itens",
    "reviewFirstTitle": "Itens para revisar primeiro",
    "reviewFirstBody": "Eles ficam separados porque precisam do seu julgamento antes de qualquer remoção.",
    "duplicatesNext": "Duplicados",
    "largeNext": "Arquivos grandes",
    "olderNext": "Arquivos antigos",
    "reviewCount": "{count} para revisar",
    "noneReviewFirst": "Neste snapshot não apareceram duplicados, arquivos grandes nem arquivos antigos para revisão.",
    "openReview": "Revisar",
    "checkAgain": "Verificar novamente",
    "safeItems": "Candidatos seguros",
    "reclaimable": "Tamanho selecionado",
    "fromCheckup": "Snapshot de revisão",
    "current": "Atual",
    "refreshRecommended": "Atualização recomendada",
    "minutesAgo": "min atrás",
    "justNow": "agora mesmo",
    "safeTitle": "Limite de segurança",
    "safeBody": "O Quick Clean inclui somente candidatos de baixo risco. Arquivos grandes, antigos, APKs, compactados e duplicados exatos ficam fora desta lista de limpeza com um toque.",
    "selectAll": "Selecionar todos os exibidos",
    "clear": "Limpar",
    "selected": "selecionados",
    "of": "de",
    "safeBadge": "SEGURO PARA LIMPAR",
    "staleReason": "Download incompleto antigo",
    "genericReason": "Candidato à limpeza de baixo risco",
    "partialList": "Mostrando os primeiros {shown} de {total} candidatos seguros. Limpe este lote e depois continue com os itens restantes.",
    "truncated": "O scanner atingiu o limite seguro de detalhes da revisão. Apenas os candidatos presentes neste snapshot verificado são mostrados.",
    "noCandidatesTitle": "Nada de baixo risco precisa de limpeza",
    "noCandidatesBody": "O Bearagnostic não encontrou itens que atendam às regras de segurança do Quick Clean. As categorias que exigem revisão permanecem separadas para que nada ambíguo seja excluído.",
    "refresh": "Atualizar Smart Checkup",
    "close": "Fechar",
    "reviewSelected": "Revisar selecionados",
    "staleBlockTitle": "Atualize antes de excluir",
    "staleBlockBody": "Este snapshot de revisão tem mais de 15 minutos. Execute um Smart Checkup novo antes de excluir para que a decisão use os arquivos atuais.",
    "confirmKicker": "REVISÃO FINAL",
    "confirmTitle": "Excluir os arquivos selecionados?",
    "confirmBody": "Somente os arquivos de baixo risco selecionados no snapshot atual serão enviados ao Android para exclusão permanente. Isso não pode ser desfeito.",
    "proof": "O espaço só é contabilizado depois que o Android confirma que cada arquivo realmente foi removido.",
    "cancel": "Cancelar",
    "deleteVerify": "Excluir e verificar",
    "deleting": "Excluindo e verificando…",
    "doneKicker": "LIMPEZA VERIFICADA",
    "doneTitle": "Limpeza concluída",
    "reclaimed": "recuperado",
    "removed": "arquivos removidos",
    "verifiedBody": "O resultado inclui apenas exclusões verificadas com sucesso.",
    "failedTitle": "Alguns arquivos não foram removidos",
    "failedBody": "Não foi possível excluir {count} item(ns) e eles não foram contabilizados como espaço recuperado.",
    "protectedTitle": "Proteção de segurança aplicada",
    "protectedBody": "As proteções nativas mantiveram {count} item(ns).",
    "reviewRemaining": "Revisar restantes",
    "done": "Concluído",
    "errorTitle": "O Quick Clean não pôde continuar",
    "retry": "Tentar novamente",
    "noAccess": "O acesso ao armazenamento ainda não está disponível.",
    "scanFailed": "Não foi possível iniciar o Smart Checkup.",
    "scanModeSmart": "Smart Checkup",
    "scanModeQuick": "Quick Scan",
    "scanModeDeep": "Deep Scan",
    "scanModeCustom": "Custom Scan",
    "homeReady": "{count} candidatos seguros prontos",
    "homeClear": "Nenhuma limpeza de baixo risco pendente",
    "homeReadyShort": "{count} seguros · revisar",
    "homeClearShort": "Sem bagunça segura",
    "itemAge": "{age}",
    "unknownLocation": "Armazenamento compartilhado",
    "selectedSummary": "{count} selecionados · {bytes}",
    "pageLimit": "Até 500 arquivos podem ser excluídos em um lote revisado."
  }
};
  ...
  function formatAge(ms) {
    ...
    if (hours < 24) return lang() === 'th' ? `${hours} ชม.ที่แล้ว` : lang() === 'ja' ? `${hours}時間前` : lang() === 'es' ? `hace ${hours} h` : lang() === 'pt-BR' ? `há ${hours} h` : `${hours}h ago`;
    const days = Math.floor(hours / 24);
    return lang() === 'th' ? `${days} วันที่แล้ว` : lang() === 'ja' ? `${days}日前` : lang() === 'es' ? `hace ${days} días` : lang() === 'pt-BR' ? `há ${days} dias` : `${days}d ago`;
  }
  ...
  function formatCount(value) {
    ...
    try {
      const locale = lang() === 'th' ? 'th-TH' : lang() === 'ja' ? 'ja-JP' : lang() === 'es' ? 'es-ES' : lang() === 'pt-BR' ? 'pt-BR' : 'en-US';
    ...
    surface.innerHTML = `
      <div class="ba-qc-panel">
        <header class="ba-qc-head">
          ...
          <button class="ba-qc-close" id="baQcClose" type="button" aria-label="${esc(window.BearagnosticLaunchLocales?.a11y?.('close') || t('close'))}">×</button>
        </header>
  ...
  function restoreHomeCardIfNoSnapshot() {
    ...
    document.querySelectorAll('[data-tool="cleanup"] small[data-quick-clean-status="1"]').forEach((node) => {
      ...
      const language = lang();
      node.textContent = language === 'th' ? 'ตรวจรายการก่อนลบ' : language === 'ja' ? '候補を確認' : language === 'es' ? 'Revisar candidatos' : language === 'pt-BR' ? 'Revisar candidatos' : 'Review candidates';
    });
  }
