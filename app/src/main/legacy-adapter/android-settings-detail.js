(() => {
  ...
  "en": {
    "back": "Back",
    "supportFallbackKicker": "INDEPENDENT",
    "supportFallbackTitle": "Support Bearagnostic",
    "supportIntro": "Keep Bearagnostic moving forward.",
    "helpFallbackKicker": "SUPPORT",
    "helpFallbackTitle": "Help & Feedback",
    "helpIntro": "How can Dr. Bear help?",
    "proFallbackKicker": "PLAN",
    "proFallbackTitle": "Bearagnostic Pro",
    "proIntro": "Go deeper. See more. Stay in control.",
    "legalFallbackKicker": "INFORMATION",
    "legalFallbackTitle": "Legal & Licenses",
    "legalIntro": "Clear ownership. Clear terms.",
    "aboutFallbackKicker": "APP",
    "aboutFallbackTitle": "About Bearagnostic",
    "supportAction": "Support on Ko-fi",
    "supportActionSub": "Ko-fi · Benedict Interactive",
    "helpReport": "Report a Problem",
    "helpReportSub": "Tell us what happened inside Bearagnostic.",
    "helpFeedback": "Send Feedback",
    "helpFeedbackSub": "Share an idea or tell us what could be better.",
    "helpDiagnostics": "Copy Diagnostic Info",
    "helpDiagnosticsSub": "Copy non-sensitive app and device details.",
    "diagnosticsCopied": "Diagnostic info copied.",
    "copyFailed": "Could not copy automatically.",
    "proAvailable": "Available in the current app",
    "proSafety": "Safety & ownership",
    "aboutPrivacy": "Selected files are analyzed locally by Bearagnostic and are not uploaded by the app in the current version."
  },
  "th": {
    "back": "ย้อนกลับ",
    "supportFallbackKicker": "การพัฒนาอิสระ",
    "supportFallbackTitle": "สนับสนุน Bearagnostic",
    "supportIntro": "ช่วยให้ Bearagnostic เดินหน้าต่อไป",
    "helpFallbackKicker": "ช่วยเหลือ",
    "helpFallbackTitle": "ช่วยเหลือและข้อเสนอแนะ",
    "helpIntro": "ให้ Dr. Bear ช่วยอะไรดี?",
    "proFallbackKicker": "แผน",
    "proFallbackTitle": "Bearagnostic Pro",
    "proIntro": "ตรวจได้ลึกขึ้น เห็นมากขึ้น และยังควบคุมทุกอย่างเอง",
    "legalFallbackKicker": "ข้อมูล",
    "legalFallbackTitle": "กฎหมายและสิทธิ์การใช้งาน",
    "legalIntro": "สิทธิ์ชัดเจน เงื่อนไขชัดเจน",
    "aboutFallbackKicker": "แอป",
    "aboutFallbackTitle": "เกี่ยวกับ Bearagnostic",
    "supportAction": "สนับสนุนผ่าน Ko-fi",
    "supportActionSub": "Ko-fi · Benedict Interactive",
    "helpReport": "แจ้งปัญหา",
    "helpReportSub": "บอกเราว่าเกิดอะไรขึ้นภายใน Bearagnostic",
    "helpFeedback": "ส่งข้อเสนอแนะ",
    "helpFeedbackSub": "แบ่งปันไอเดียหรือสิ่งที่อยากให้เราปรับปรุง",
    "helpDiagnostics": "คัดลอกข้อมูลวินิจฉัย",
    "helpDiagnosticsSub": "คัดลอกข้อมูลแอปและอุปกรณ์ที่ไม่ละเอียดอ่อน",
    "diagnosticsCopied": "คัดลอกข้อมูลทางเทคนิคแล้ว",
    "copyFailed": "ไม่สามารถคัดลอกให้อัตโนมัติได้",
    "proAvailable": "ความสามารถที่มีอยู่ในแอปตอนนี้",
    "proSafety": "ความปลอดภัยและสิทธิ์การใช้งาน",
    "aboutPrivacy": "ไฟล์ที่เลือกจะถูกวิเคราะห์บนอุปกรณ์โดย Bearagnostic และแอปเวอร์ชันปัจจุบันจะไม่อัปโหลดเนื้อหาไฟล์เหล่านั้น"
  },
  "ja": {
    "back": "戻る",
    "supportFallbackKicker": "独立開発",
    "supportFallbackTitle": "Bearagnostic を支援",
    "supportIntro": "Bearagnostic の次の一歩を支える",
    "helpFallbackKicker": "サポート",
    "helpFallbackTitle": "ヘルプ・フィードバック",
    "helpIntro": "Dr. Bear にご相談ください",
    "proFallbackKicker": "プラン",
    "proFallbackTitle": "Bearagnostic Pro",
    "proIntro": "より深く確認し、もっと把握し、操作は自分の手に。",
    "legalFallbackKicker": "情報",
    "legalFallbackTitle": "法的情報とライセンス",
    "legalIntro": "権利と条件を、分かりやすく。",
    "aboutFallbackKicker": "アプリ",
    "aboutFallbackTitle": "Bearagnostic について",
    "supportAction": "Ko-fi で支援",
    "supportActionSub": "Ko-fi · Benedict Interactive",
    "helpReport": "問題を報告",
    "helpReportSub": "Bearagnostic で起きたことをお知らせください。",
    "helpFeedback": "フィードバックを送る",
    "helpFeedbackSub": "アイデアや改善してほしい点を共有してください。",
    "helpDiagnostics": "診断情報をコピー",
    "helpDiagnosticsSub": "機密性のないアプリと端末の情報をコピーします。",
    "diagnosticsCopied": "診断情報をコピーしました。",
    "copyFailed": "自動でコピーできませんでした。",
    "proAvailable": "現在のアプリで利用できる機能",
    "proSafety": "安全性と所有モデル",
    "aboutPrivacy": "選択したファイルは Bearagnostic が端末内で解析し、現在のバージョンではその内容をアップロードしません。"
  },
  "es": {
    "back": "Atrás",
    "supportFallbackKicker": "INDEPENDIENTE",
    "supportFallbackTitle": "Apoyar Bearagnostic",
    "supportIntro": "Ayuda a que Bearagnostic siga avanzando.",
    "helpFallbackKicker": "AYUDA",
    "helpFallbackTitle": "Ayuda y comentarios",
    "helpIntro": "¿Cómo puede ayudarte Dr. Bear?",
    "proFallbackKicker": "PLAN",
    "proFallbackTitle": "Bearagnostic Pro",
    "proIntro": "Ve más a fondo. Descubre más. Mantén el control.",
    "legalFallbackKicker": "INFORMACIÓN",
    "legalFallbackTitle": "Avisos legales y licencias",
    "legalIntro": "Propiedad clara. Condiciones claras.",
    "aboutFallbackKicker": "APP",
    "aboutFallbackTitle": "Acerca de Bearagnostic",
    "supportAction": "Apoyar en Ko-fi",
    "supportActionSub": "Ko-fi · Benedict Interactive",
    "helpReport": "Informar de un problema",
    "helpReportSub": "Cuéntanos qué ocurrió dentro de Bearagnostic.",
    "helpFeedback": "Enviar comentarios",
    "helpFeedbackSub": "Comparte una idea o cuéntanos qué podríamos mejorar.",
    "helpDiagnostics": "Copiar información de diagnóstico",
    "helpDiagnosticsSub": "Copia detalles no sensibles de la app y el dispositivo.",
    "diagnosticsCopied": "Información de diagnóstico copiada.",
    "copyFailed": "No se pudo copiar automáticamente.",
    "proAvailable": "Disponible en la app actual",
    "proSafety": "Seguridad y propiedad",
    "aboutPrivacy": "Los archivos seleccionados se analizan localmente con Bearagnostic y la app no los sube en la versión actual."
  },
  "pt-BR": {
    "back": "Voltar",
    "supportFallbackKicker": "INDEPENDENTE",
    "supportFallbackTitle": "Apoiar o Bearagnostic",
    "supportIntro": "Ajude o Bearagnostic a continuar evoluindo.",
    "helpFallbackKicker": "SUPORTE",
    "helpFallbackTitle": "Ajuda e feedback",
    "helpIntro": "Como o Dr. Bear pode ajudar?",
    "proFallbackKicker": "PLANO",
    "proFallbackTitle": "Bearagnostic Pro",
    "proIntro": "Vá mais fundo. Veja mais. Mantenha o controle.",
    "legalFallbackKicker": "INFORMAÇÕES",
    "legalFallbackTitle": "Informações legais e licenças",
    "legalIntro": "Propriedade clara. Termos claros.",
    "aboutFallbackKicker": "APP",
    "aboutFallbackTitle": "Sobre o Bearagnostic",
    "supportAction": "Apoiar no Ko-fi",
    "supportActionSub": "Ko-fi · Benedict Interactive",
    "helpReport": "Relatar um problema",
    "helpReportSub": "Conte o que aconteceu dentro do Bearagnostic.",
    "helpFeedback": "Enviar feedback",
    "helpFeedbackSub": "Compartilhe uma ideia ou diga o que podemos melhorar.",
    "helpDiagnostics": "Copiar informações de diagnóstico",
    "helpDiagnosticsSub": "Copie detalhes não sensíveis do app e do dispositivo.",
    "diagnosticsCopied": "Informações de diagnóstico copiadas.",
    "copyFailed": "Não foi possível copiar automaticamente.",
    "proAvailable": "Disponível no app atual",
    "proSafety": "Segurança e propriedade",
    "aboutPrivacy": "Os arquivos selecionados são analisados localmente pelo Bearagnostic e não são enviados pelo app na versão atual."
  }
});
