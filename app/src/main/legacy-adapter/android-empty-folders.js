(() => {
  ...
  "en": {
    "title": "Empty Folders",
    "sub": "Review unused empty folders",
    "kicker": "EMPTY FOLDERS",
    ...
    "source": "SOURCE",
    "sourceValue": "Live folder check",
    "coverage": "COVERAGE",
    "coverageValue": "Accessible storage",
    "safety": "SAFETY",
    "safetyValue": "Review first",
    "accessTitle": "Storage access is needed",
    "accessBody": "Android must allow shared-storage access before Bearagnostic can review empty folders.",
    "permission": "Open Android settings",
    "startTitle": "Check empty folders",
    "startBody": "This performs a dedicated local folder check. It does not delete anything.",
    "start": "Scan empty folders",
    "runningTitle": "Checking empty folders",
    "runningBody": "Bearagnostic is walking accessible folders locally. No fake delay or cosmetic progress is added.",
    "checkedFolders": "folders checked",
    "emptyTitle": "No removable empty folders surfaced",
    "emptyBody": "Protected, hidden, top-level, Android system, and non-empty folders are not offered for deletion.",
    "refresh": "Check again",
    ...
    "justNow": "just now",
    "minAgo": "min ago",
    "cautionTitle": "Empty does not mean disposable",
    "cautionBody": "Apps may recreate or expect placeholder folders. Nothing is selected automatically, and protected/system locations stay out of this list.",
    "verifyTitle": "Rechecked at deletion time",
    "verifyBody": "Every selected folder must still be empty immediately before deletion. If a file appears, Bearagnostic refuses to remove that folder.",
    "partialTitle": "Review list is partial",
    "partialBody": "The dedicated folder snapshot reached its detail limit. Only folders represented here can be selected.",
    "sortName": "Name A–Z",
    "sortNewest": "Newest first",
    "sortOldest": "Oldest first",
    "sortLocation": "Location A–Z",
    "choose": "Choose only folders you recognize and no longer need",
    "showing": "Showing {shown} of {total}",
    "dateUnknown": "Date unavailable",
    "selected": "{count} selected",
    "clear": "Clear",
    "review": "Review selected",
    "limit": "Up to 100 folders can be removed in one verified batch.",
    "limitReached": "The 100-folder safety limit has been reached.",
    "staleTitle": "Check again before deleting",
    "staleBody": "This folder snapshot is more than 15 minutes old.",
    "finalKicker": "FINAL REVIEW",
    "finalTitle": "Remove the selected empty folders?",
    ...
    "deleting": "Rechecking and deleting…",
    "resultKicker": "VERIFIED CLEANUP",
    "resultTitle": "Empty-folder review complete",
    "removed": "folders removed",
    "changed": "became non-empty",
    "notRemoved": "not removed",
    "resultBody": "Only folders Android confirmed as gone are counted as removed. No storage-savings claim is added.",
    "remaining": "Review remaining",
    "done": "Done",
    "errorTitle": "Empty-folder review could not continue",
    "retry": "Try again",
    "busy": "Another storage check is running. Finish it before scanning empty folders.",
    "noFilter": "No folders to show."
  },
  "th": {
    "title": "โฟลเดอร์ว่าง",
    "sub": "ตรวจโฟลเดอร์ว่างก่อนลบ",
    "kicker": "โฟลเดอร์ว่าง",
    ...
    "source": "แหล่งข้อมูล",
    "sourceValue": "ตรวจโฟลเดอร์สด",
    "coverage": "ขอบเขต",
    "coverageValue": "พื้นที่ที่เข้าถึงได้",
    "safety": "ความปลอดภัย",
    "safetyValue": "ตรวจดูก่อน",
    "accessTitle": "ต้องอนุญาตการเข้าถึงพื้นที่จัดเก็บ",
    "accessBody": "Android ต้องอนุญาต shared storage ก่อนที่ Bearagnostic จะตรวจโฟลเดอร์ว่างได้",
    "permission": "เปิดการตั้งค่า Android",
    "startTitle": "ตรวจหาโฟลเดอร์ว่าง",
    "startBody": "เป็นการตรวจโฟลเดอร์ภายในเครื่องโดยเฉพาะ และจะไม่ลบอะไร",
    "start": "ตรวจโฟลเดอร์ว่าง",
    "runningTitle": "กำลังตรวจโฟลเดอร์ว่าง",
    "runningBody": "Bearagnostic กำลังเดินตรวจโฟลเดอร์ที่เข้าถึงได้จริง ไม่มีการหน่วงเวลาหรือสร้าง progress ปลอม",
    "checkedFolders": "โฟลเดอร์ที่ตรวจแล้ว",
    "emptyTitle": "ไม่พบโฟลเดอร์ว่างที่เหมาะให้ตรวจลบ",
    "emptyBody": "โฟลเดอร์ระบบ โฟลเดอร์ซ่อน โฟลเดอร์ระดับบน และโฟลเดอร์ที่ไม่ว่างจะไม่ถูกเสนอให้ลบ",
    "refresh": "ตรวจอีกครั้ง",
    "folders": "โฟลเดอร์ว่าง",
    "protected": "โฟลเดอร์ว่างที่ป้องกัน",
    "checked": "ตรวจเมื่อ",
    "justNow": "เมื่อสักครู่",
    "minAgo": "นาทีที่แล้ว",
    "cautionTitle": "ว่างไม่ได้แปลว่าควรลบ",
    "cautionBody": "บางแอปอาจสร้างหรือคาดหวัง placeholder folder ไว้ ระบบจะไม่เลือกให้อัตโนมัติ และจะไม่แสดงตำแหน่งระบบ/ที่ป้องกันไว้",
    "verifyTitle": "ตรวจซ้ำตอนลบจริง",
    "verifyBody": "ทุกโฟลเดอร์ต้องยังว่างอยู่ทันทีตอนลบ ถ้ามีไฟล์เกิดขึ้นภายหลัง Bearagnostic จะปฏิเสธการลบโฟลเดอร์นั้น",
    "partialTitle": "รายการตรวจแสดงได้ไม่ครบทั้งหมด",
    "partialBody": "snapshot การตรวจโฟลเดอร์ถึงขีดจำกัดรายละเอียด เลือกได้เฉพาะโฟลเดอร์ที่อยู่ในรายการนี้",
    "sortName": "ชื่อ A–Z",
    "sortNewest": "ใหม่สุดก่อน",
    "sortOldest": "เก่าสุดก่อน",
    "sortLocation": "ตำแหน่ง A–Z",
    "choose": "เลือกเฉพาะโฟลเดอร์ที่รู้จักและไม่ต้องการแล้ว",
    "showing": "แสดง {shown} จาก {total}",
    "dateUnknown": "ไม่มีข้อมูลวันที่",
    "selected": "เลือก {count} โฟลเดอร์",
    "clear": "ล้างที่เลือก",
    "review": "ตรวจรายการที่เลือก",
    "limit": "ลบได้สูงสุด 100 โฟลเดอร์ต่อหนึ่ง batch ที่มีการตรวจยืนยัน",
    "limitReached": "เลือกครบขีดจำกัดความปลอดภัย 100 โฟลเดอร์แล้ว",
    "staleTitle": "ตรวจใหม่ก่อนลบ",
    "staleBody": "snapshot โฟลเดอร์นี้เก่ากว่า 15 นาทีแล้ว",
    "finalKicker": "ตรวจครั้งสุดท้าย",
    "finalTitle": "ลบโฟลเดอร์ว่างที่เลือกหรือไม่",
    ...
    "deleting": "กำลังตรวจซ้ำและลบ…",
    "resultKicker": "ยืนยันผลแล้ว",
    "resultTitle": "ตรวจโฟลเดอร์ว่างเรียบร้อย",
    "removed": "โฟลเดอร์ที่ลบแล้ว",
    "changed": "มีข้อมูลเพิ่มภายหลัง",
    "notRemoved": "ไม่ได้ลบ",
    "resultBody": "นับเฉพาะโฟลเดอร์ที่ Android ยืนยันว่าหายไปแล้วเท่านั้น และไม่มีการอ้างพื้นที่คืนเกินจริง",
    "remaining": "ตรวจรายการที่เหลือ",
    "done": "เสร็จสิ้น",
    "errorTitle": "ไม่สามารถดำเนินการตรวจโฟลเดอร์ว่างต่อได้",
    "retry": "ลองอีกครั้ง",
    "busy": "มีการตรวจพื้นที่อื่นกำลังทำงานอยู่ กรุณารอให้เสร็จก่อน",
  ...
  "ja": {
    ...
    "source": "ソース",
    "sourceValue": "ライブフォルダーチェック",
    "coverage": "範囲",
    "coverageValue": "アクセス可能な領域",
    "safety": "安全性",
    "safetyValue": "要確認",
    "accessTitle": "ストレージへのアクセスが必要です",
    "accessBody": "空フォルダーを確認するには Android の共有ストレージアクセスが必要です。",
    "permission": "Android 設定を開く",
    "startTitle": "空フォルダーを確認",
    "startBody": "端末内でフォルダーだけを確認します。削除は行いません。",
    "start": "空フォルダーをスキャン",
    "runningTitle": "空フォルダーを確認中",
    "runningBody": "アクセス可能なフォルダーを実際に確認しています。偽の待ち時間や進捗は追加しません。",
    "checkedFolders": "確認済みフォルダー",
    "emptyTitle": "削除候補の空フォルダーはありません",
    "emptyBody": "保護・非表示・最上位・Android システム・空でないフォルダーは削除候補にしません。",
    "refresh": "もう一度確認",
    "folders": "空フォルダー",
    "protected": "保護された空フォルダー",
    "checked": "確認",
    "justNow": "たった今",
    "minAgo": "分前",
    "cautionTitle": "空でも不要とは限りません",
    "cautionBody": "アプリがプレースホルダーとして必要とする場合があります。自動選択せず、保護領域は一覧に出しません。",
    "verifyTitle": "削除直前に再確認",
    "verifyBody": "削除直前にも空であることを確認します。ファイルが追加されていれば削除を拒否します。",
    "partialTitle": "一覧は一部のみです",
    "partialBody": "フォルダー snapshot の詳細上限に達しました。この一覧にあるものだけ選択できます。",
    "sortName": "名前 A–Z",
    "sortNewest": "新しい順",
    "sortOldest": "古い順",
    "sortLocation": "場所 A–Z",
    "choose": "内容を把握し、不要だと判断したフォルダーだけを選択してください",
    "showing": "{total} 件中 {shown} 件",
    "dateUnknown": "日付情報なし",
    "selected": "{count} 件選択",
    "clear": "選択解除",
    "review": "選択内容を確認",
    "limit": "1 回の検証済みバッチで最大 100 フォルダーです。",
    "limitReached": "100 フォルダーの安全上限に達しました。",
    "staleTitle": "削除前に再確認",
    "staleBody": "このフォルダー snapshot は 15 分以上前のものです。",
    "finalKicker": "最終確認",
    "finalTitle": "選択した空フォルダーを削除しますか？",
    ...
    "deleting": "再確認して削除中…",
    "resultKicker": "検証済み",
    "resultTitle": "空フォルダーの確認が完了しました",
    "removed": "削除済み",
    "changed": "空でなくなった",
    "notRemoved": "未削除",
    "resultBody": "Android が消えたと確認したフォルダーだけを削除件数に数え、容量節約の誇張はしません。",
    "remaining": "残りを確認",
    "done": "完了",
    "errorTitle": "空フォルダーの確認を続行できません",
    "retry": "再試行",
    "busy": "別のストレージチェックが実行中です。完了してから再試行してください。",
    "noFilter": "表示するフォルダーはありません"
  },
  "es": {
    "title": "Carpetas vacías",
    "sub": "Revisar carpetas vacías sin uso",
    "kicker": "CARPETAS VACÍAS",
    "hero": "Revisa carpetas vacías sin hacer suposiciones.",
    "lead": "Una carpeta vacía ocupa un espacio prácticamente insignificante y algunas apps crean carpetas vacías intencionalmente. Bearagnostic nunca considera que una carpeta vacía sea basura por sí sola.",
    "source": "FUENTE",
    "sourceValue": "Comprobación de carpetas en vivo",
    "coverage": "COBERTURA",
    "coverageValue": "Almacenamiento accesible",
    "safety": "SEGURIDAD",
    "safetyValue": "Revisar primero",
    "accessTitle": "Se necesita acceso al almacenamiento",
    "accessBody": "Android debe permitir el acceso al almacenamiento compartido antes de que Bearagnostic pueda revisar carpetas vacías.",
    "permission": "Abrir ajustes de Android",
    "startTitle": "Revisar carpetas vacías",
    "startBody": "Esto realiza una comprobación local específica de carpetas. No elimina nada.",
    "start": "Analizar carpetas vacías",
    "runningTitle": "Revisando carpetas vacías",
    "runningBody": "Bearagnostic recorre localmente las carpetas accesibles. No añade retrasos falsos ni progreso cosmético.",
    "checkedFolders": "carpetas revisadas",
    "emptyTitle": "No se detectaron carpetas vacías eliminables",
    "emptyBody": "Las carpetas protegidas, ocultas, de nivel superior, del sistema Android y no vacías no se ofrecen para eliminar.",
    "refresh": "Revisar de nuevo",
    "folders": "Carpetas vacías",
    "protected": "Vacías protegidas",
    "checked": "Comprobado",
    "justNow": "ahora mismo",
    "minAgo": "min atrás",
    "cautionTitle": "Vacío no significa desechable",
    "cautionBody": "Las apps pueden volver a crear o esperar carpetas marcadoras. Nada se selecciona automáticamente y las ubicaciones protegidas o del sistema quedan fuera de esta lista.",
    "verifyTitle": "Revisado de nuevo al eliminar",
    "verifyBody": "Cada carpeta seleccionada debe seguir vacía justo antes de eliminarla. Si aparece un archivo, Bearagnostic se niega a eliminar esa carpeta.",
    "partialTitle": "La lista de revisión es parcial",
    "partialBody": "La instantánea específica de carpetas alcanzó su límite de detalle. Solo se pueden seleccionar las carpetas representadas aquí.",
    "sortName": "Nombre A–Z",
    "sortNewest": "Más recientes primero",
    "sortOldest": "Más antiguos primero",
    "sortLocation": "Ubicación A–Z",
    "choose": "Elige solo carpetas que reconozcas y ya no necesites",
    "showing": "Mostrando {shown} de {total}",
    "dateUnknown": "Fecha no disponible",
    "selected": "{count} seleccionadas",
    "clear": "Limpiar",
    "review": "Revisar seleccionados",
    "limit": "Se pueden eliminar hasta 100 carpetas en un lote verificado.",
    "limitReached": "Se alcanzó el límite de seguridad de 100 carpetas.",
    "staleTitle": "Revisa de nuevo antes de eliminar",
    "staleBody": "Esta instantánea de carpetas tiene más de 15 minutos.",
    "finalKicker": "REVISIÓN FINAL",
    "finalTitle": "¿Eliminar las carpetas vacías seleccionadas?",
    "finalBody": "Bearagnostic eliminará permanentemente solo las carpetas seleccionadas que sigan vacías y superen las comprobaciones nativas de seguridad.",
    "noSpace": "No se muestra una estimación de espacio recuperado porque las carpetas vacías normalmente usan un espacio insignificante.",
    "back": "Atrás",
    "deleteVerify": "Eliminar y verificar",
    "deleting": "Revisando de nuevo y eliminando…",
    "resultKicker": "LIMPIEZA VERIFICADA",
    "resultTitle": "Revisión de carpetas vacías completada",
    "removed": "carpetas eliminadas",
    "changed": "dejaron de estar vacías",
    "notRemoved": "no eliminados",
    "resultBody": "Solo se cuentan como eliminadas las carpetas que Android confirmó que ya no existen. No se añade ninguna afirmación sobre ahorro de espacio.",
    "remaining": "Revisar restantes",
    "done": "Listo",
    "errorTitle": "La revisión de carpetas vacías no pudo continuar",
    "retry": "Intentar de nuevo",
    "busy": "Hay otra comprobación de almacenamiento en curso. Termínala antes de analizar carpetas vacías.",
    "noFilter": "No hay carpetas que mostrar."
  },
  "pt-BR": {
    "title": "Pastas vazias",
    "sub": "Revisar pastas vazias sem uso",
    "kicker": "PASTAS VAZIAS",
    "hero": "Revise pastas vazias sem suposições.",
    "lead": "Uma pasta vazia usa um espaço praticamente irrelevante, e alguns apps criam pastas vazias de propósito. O Bearagnostic nunca trata uma pasta vazia como lixo só por estar vazia.",
    "source": "FONTE",
    "sourceValue": "Verificação de pastas ao vivo",
    "coverage": "COBERTURA",
    "coverageValue": "Armazenamento acessível",
    "safety": "SEGURANÇA",
    "safetyValue": "Revisar primeiro",
    "accessTitle": "É necessário acesso ao armazenamento",
    "accessBody": "O Android precisa permitir acesso ao armazenamento compartilhado antes que o Bearagnostic possa revisar pastas vazias.",
    "permission": "Abrir configurações do Android",
    "startTitle": "Verificar pastas vazias",
    "startBody": "Isto faz uma verificação local dedicada das pastas. Não exclui nada.",
    "start": "Verificar pastas vazias",
    "runningTitle": "Verificando pastas vazias",
    "runningBody": "O Bearagnostic percorre localmente as pastas acessíveis. Nenhum atraso falso ou progresso cosmético é adicionado.",
    "checkedFolders": "pastas verificadas",
    "emptyTitle": "Nenhuma pasta vazia removível foi encontrada",
    "emptyBody": "Pastas protegidas, ocultas, de nível superior, do sistema Android e não vazias não são oferecidas para exclusão.",
    "refresh": "Verificar novamente",
    "folders": "Pastas vazias",
    "protected": "Vazias protegidas",
    "checked": "Verificado",
    "justNow": "agora mesmo",
    "minAgo": "min atrás",
    "cautionTitle": "Vazio não significa descartável",
    "cautionBody": "Apps podem recriar ou esperar pastas marcadoras. Nada é selecionado automaticamente, e locais protegidos ou do sistema ficam fora desta lista.",
    "verifyTitle": "Verificado novamente na hora da exclusão",
    "verifyBody": "Cada pasta selecionada precisa continuar vazia imediatamente antes da exclusão. Se um arquivo aparecer, o Bearagnostic se recusa a remover essa pasta.",
    "partialTitle": "A lista de revisão é parcial",
    "partialBody": "O snapshot dedicado de pastas atingiu o limite de detalhes. Apenas as pastas representadas aqui podem ser selecionadas.",
    "sortName": "Nome A–Z",
    "sortNewest": "Mais recentes primeiro",
    "sortOldest": "Mais antigos primeiro",
    "sortLocation": "Local A–Z",
    "choose": "Escolha apenas pastas que você reconhece e não precisa mais",
    "showing": "Mostrando {shown} de {total}",
    "dateUnknown": "Data indisponível",
    "selected": "{count} selecionadas",
    "clear": "Limpar",
    "review": "Revisar selecionados",
    "limit": "Até 100 pastas podem ser removidas em um lote verificado.",
    "limitReached": "O limite de segurança de 100 pastas foi atingido.",
    "staleTitle": "Verifique novamente antes de excluir",
    "staleBody": "Este snapshot de pastas tem mais de 15 minutos.",
    "finalKicker": "REVISÃO FINAL",
    "finalTitle": "Remover as pastas vazias selecionadas?",
    "finalBody": "O Bearagnostic removerá permanentemente apenas as pastas selecionadas que ainda estejam vazias e passem pelas verificações nativas de segurança.",
    "noSpace": "Nenhuma estimativa de espaço recuperado é mostrada porque pastas vazias normalmente usam espaço insignificante.",
    "back": "Voltar",
    "deleteVerify": "Excluir e verificar",
    "deleting": "Verificando novamente e excluindo…",
    "resultKicker": "LIMPEZA VERIFICADA",
    "resultTitle": "Revisão de pastas vazias concluída",
    "removed": "pastas removidas",
    "changed": "deixaram de estar vazias",
    "notRemoved": "não removidos",
    "resultBody": "Somente pastas que o Android confirmou como removidas contam como excluídas. Nenhuma alegação de economia de espaço é adicionada.",
    "remaining": "Revisar restantes",
    "done": "Concluído",
    "errorTitle": "A revisão de pastas vazias não pôde continuar",
    "retry": "Tentar novamente",
    "busy": "Outra verificação de armazenamento está em andamento. Termine-a antes de verificar pastas vazias.",
    "noFilter": "Nenhuma pasta para mostrar."
  }
};
  ...
  function ageLabel(ms) {
    ...
    try {
      const locale = language()==='th'?'th-TH':language()==='ja'?'ja-JP':language()==='es'?'es-ES':language()==='pt-BR'?'pt-BR':'en-US';
  ...
  function ensureSurface() {
    ...
    surface.innerHTML = `<header class="ba-empty-head"><span class="ba-empty-head__icon">${badge(true)}</span><div class="ba-empty-head__copy"><strong id="baEmptySurfaceTitle"></strong><small>BEARAGNOSTIC · LOCAL REVIEW</small></div><button class="ba-empty-close" type="button" data-empty-action="close" aria-label="${esc(window.BearagnosticLaunchLocales?.a11y?.('close') || c().back)}">×</button></header><div class="ba-empty-scroll"><div class="ba-empty-wrap" id="baEmptyContent"></div></div><div id="baEmptySelection"></div>`;
