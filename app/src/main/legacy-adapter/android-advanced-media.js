(() => {
  ...
  const language = () => {
    ...
    return lang.startsWith('th') ? 'th' : lang.startsWith('ja') ? 'ja' : lang.startsWith('es') ? 'es' : (lang === 'pt-br' || lang.startsWith('pt-br') || lang.startsWith('pt_')) ? 'pt-BR' : 'en';
  };

  const COPY = {
  "en": {
    "title": "Media Review",
    "subFree": "PRO · Advanced review filters",
    "subPro": "Advanced review filters · Pro active",
    "kicker": "ADVANCED MEDIA REVIEW",
    ...
    "local": "LOCAL ONLY",
    "source": "SOURCE",
    "sourceValue": "Current review snapshot",
    "coverage": "COVERAGE",
    "coverageValue": "Surfaced media only",
    "safety": "SAFETY",
    "safetyValue": "Review first",
    "noSnapshotTitle": "Run a checkup first",
    "noSnapshotBody": "A Quick Scan can create a fresh review snapshot. It reads filesystem metadata only and does not delete anything.",
    "quick": "Run Quick Scan",
    "scanningTitle": "Checking for review-worthy media",
    "scanningBody": "Bearagnostic is using real filesystem work. No fake delay or cosmetic progress is added.",
    "emptyTitle": "No media surfaced for review",
    "emptyBody": "The current review snapshot contains no photo, video, or audio candidates. This does not mean the device has no media.",
    "refresh": "Refresh snapshot",
    "scopeTitle": "Review-set scope",
    "scopeBody": "Only media already surfaced by the current checkup appears here. Bearagnostic does not claim this is your complete photo, video, or music library.",
    "autoTitle": "Nothing is selected automatically",
    "autoBody": "Media is personal. Size, age, or file type never becomes a junk verdict on its own.",
    "partialTitle": "Review details are partial",
    "partialBody": "The current safety snapshot reached its detail limit. Filters apply only to media represented in this snapshot.",
    "staleTitle": "Check again before deleting",
    "staleBody": "This review snapshot is more than 15 minutes old. Run a fresh checkup before removal.",
    "media": "Media surfaced",
    "photos": "Photos",
    "videos": "Videos",
    "audio": "Audio",
    "size": "Total size",
    ...
    "choose": "Choose only media you recognize and no longer need",
    "more": "Show more",
    "noMatch": "No surfaced media matches these filters.",
    ...
    "finalTitle": "Remove the selected media files?",
    "finalBody": "Only the files you selected will be permanently removed. Bearagnostic verifies deletion and counts reclaimed bytes only after Android confirms the files are gone.",
    "back": "Back",
    "deleteVerify": "Delete & verify",
    "deleting": "Deleting and verifying…",
    "resultKicker": "VERIFIED CLEANUP",
    "resultTitle": "Media review complete",
    "reclaimed": "Reclaimed",
    "removed": "Removed",
    "protected": "Protected",
    "failed": "Failed",
    ...
    "locationUnknown": "Shared storage",
    "metadata": "Local preview",
    "errorTitle": "Media Review could not continue",
    "retry": "Try again",
    "scanBusy": "Another checkup is already running. Media Review will refresh when it finishes.",
    "available": "Available in the current app",
    "featureTitle": "Advanced Media Review",
    "featureBody": "Review surfaced photos, videos, and audio with local previews, type/size/age filters, and verified deletion."
  },
  "th": {
    "title": "Media Review",
    "subFree": "PRO · ตัวกรองสื่อขั้นสูง",
    "subPro": "ตัวกรองสื่อขั้นสูง · Pro เปิดใช้งาน",
    "kicker": "MEDIA REVIEW ขั้นสูง",
    ...
    "pro": "PRO",
    "local": "เฉพาะในเครื่อง",
    "source": "แหล่งข้อมูล",
    "sourceValue": "Review snapshot ปัจจุบัน",
    "coverage": "ขอบเขต",
    "coverageValue": "เฉพาะสื่อที่ถูกเสนอให้ตรวจ",
    "safety": "ความปลอดภัย",
    "safetyValue": "ตรวจดูก่อน",
    "noSnapshotTitle": "ตรวจเครื่องก่อน",
    "noSnapshotBody": "Quick Scan สามารถสร้าง review snapshot ใหม่ได้ โดยอ่านเฉพาะ metadata ของระบบไฟล์และไม่ลบอะไร",
    "quick": "เริ่ม Quick Scan",
    "scanningTitle": "กำลังตรวจหาไฟล์สื่อที่ควร Review",
    "scanningBody": "Bearagnostic กำลังทำงานกับระบบไฟล์จริง ไม่มีการหน่วงเวลาหรือสร้าง progress ปลอม",
    "emptyTitle": "ไม่พบไฟล์สื่อที่ถูกเสนอให้ Review",
    "emptyBody": "review snapshot ปัจจุบันไม่มี candidate ประเภทรูป วิดีโอ หรือเสียง ซึ่งไม่ได้หมายความว่าเครื่องไม่มีไฟล์สื่อ",
    "refresh": "อัปเดต snapshot",
    "scopeTitle": "ขอบเขตของ Review set",
    "scopeBody": "แสดงเฉพาะสื่อที่ checkup ปัจจุบันเสนอให้ Review อยู่แล้ว Bearagnostic จะไม่อ้างว่านี่คือคลังรูป วิดีโอ หรือเพลงทั้งหมดในเครื่อง",
    "autoTitle": "ไม่มีการเลือกให้อัตโนมัติ",
    "autoBody": "ไฟล์สื่อเป็นข้อมูลส่วนบุคคล ขนาด อายุ หรือชนิดไฟล์เพียงอย่างเดียวไม่ถูกตีความว่าเป็นขยะ",
    "partialTitle": "รายละเอียด Review แสดงได้ไม่ครบทั้งหมด",
    "partialBody": "safety snapshot ปัจจุบันถึงขีดจำกัดรายละเอียด ตัวกรองจึงใช้กับสื่อที่มีตัวตนอยู่ใน snapshot นี้เท่านั้น",
    "staleTitle": "ตรวจใหม่ก่อนลบ",
    "staleBody": "review snapshot นี้เก่ากว่า 15 นาทีแล้ว กรุณาตรวจใหม่ก่อนลบไฟล์",
    "media": "สื่อที่พบ",
    "photos": "รูปภาพ",
    "videos": "วิดีโอ",
    "audio": "เสียง",
    ...
    "over10": "10 MB+",
    "over100": "100 MB+",
    "recent30": "30 วันล่าสุด",
    "olderYear": "1 ปีขึ้นไป",
    "largest": "ใหญ่สุดก่อน",
    "newest": "ใหม่สุดก่อน",
    "oldest": "เก่าสุดก่อน",
    "name": "ชื่อ A–Z",
    "showing": "แสดง {shown} จาก {total}",
    "choose": "เลือกเฉพาะไฟล์สื่อที่รู้จักและไม่ต้องการแล้ว",
    "more": "แสดงเพิ่ม",
    "noMatch": "ไม่มีไฟล์สื่อที่ตรงกับตัวกรองนี้",
    "selected": "เลือก {count} ไฟล์ · {size}",
    "clear": "ล้างที่เลือก",
    "review": "ตรวจรายการที่เลือก",
    ...
    "finalTitle": "ลบไฟล์สื่อที่เลือกหรือไม่",
    "finalBody": "ระบบจะลบถาวรเฉพาะไฟล์ที่เลือกไว้ และนับพื้นที่คืนได้ก็ต่อเมื่อ Android ยืนยันว่าไฟล์หายไปจริงแล้วเท่านั้น",
    "back": "ย้อนกลับ",
    "deleteVerify": "ลบและตรวจยืนยัน",
    "deleting": "กำลังลบและตรวจยืนยัน…",
    "resultKicker": "ยืนยันผลแล้ว",
    "resultTitle": "Media Review เรียบร้อย",
    "reclaimed": "พื้นที่คืนได้",
    "removed": "ลบแล้ว",
    "protected": "ป้องกันไว้",
    "failed": "ไม่สำเร็จ",
    "resultBody": "นับเฉพาะไฟล์ที่ Android ยืนยันว่าหายไปแล้วเป็นจำนวนที่ลบและพื้นที่คืนได้",
    "remaining": "ตรวจรายการที่เหลือ",
    "done": "เสร็จสิ้น",
    "checked": "ตรวจเมื่อ",
    ...
    "locationUnknown": "Shared storage",
    "metadata": "ตัวอย่างภายในเครื่อง",
    "errorTitle": "ไม่สามารถดำเนิน Media Review ต่อได้",
    "retry": "ลองอีกครั้ง",
    "scanBusy": "มี checkup อื่นกำลังทำงานอยู่ Media Review จะอัปเดตเมื่อการตรวจนั้นเสร็จ",
    "available": "ความสามารถที่มีอยู่ในแอปตอนนี้",
    "featureTitle": "Media Review ขั้นสูง",
    "featureBody": "ตรวจรูป วิดีโอ และเสียงที่ถูกเสนอให้ Review ด้วยตัวอย่างภายในเครื่อง ตัวกรองชนิด/ขนาด/อายุ และการลบที่ตรวจยืนยันจริง"
  },
  "ja": {
    "title": "Media Review",
    "subFree": "PRO · 高度なメディアフィルター",
    "subPro": "高度なメディアフィルター · Pro 有効",
    "kicker": "高度な MEDIA REVIEW",
    "hero": "確認すべきメディアを、より詳しい情報と一緒に。",
    "lead": "これは端末全体のギャラリーではありません。最新のチェックで確認対象として表示された写真・動画・音声に、ローカルプレビューと高度なフィルターを追加します。",
    "pro": "PRO",
    "local": "端末内のみ",
    "source": "ソース",
    "sourceValue": "現在の review snapshot",
    "coverage": "範囲",
    "coverageValue": "表示済みメディアのみ",
    "safety": "安全性",
    "safetyValue": "要確認",
    "noSnapshotTitle": "まずチェックを実行",
    "noSnapshotBody": "Quick Scan で新しい review snapshot を作成できます。ファイルシステムのメタデータのみを読み取り、削除は行いません。",
    "quick": "Quick Scan を実行",
    "scanningTitle": "確認対象のメディアをチェック中",
    "scanningBody": "実際のファイルシステム処理を行っています。偽の待ち時間や進捗は追加しません。",
    "emptyTitle": "確認対象のメディアはありません",
    "emptyBody": "現在の review snapshot に写真・動画・音声の候補はありません。端末にメディアがないという意味ではありません。",
    "refresh": "snapshot を更新",
    "scopeTitle": "Review set の範囲",
    "scopeBody": "現在の checkup ですでに確認対象になったメディアだけを表示します。端末全体の写真・動画・音楽ライブラリだとは表示しません。",
    "autoTitle": "自動選択は行いません",
    "autoBody": "メディアは個人的なデータです。サイズ・経過日数・種類だけで不要とは判断しません。",
    "partialTitle": "Review 詳細は一部のみです",
    "partialBody": "現在の safety snapshot は詳細上限に達しています。フィルターは snapshot に含まれるメディアだけに適用されます。",
    "staleTitle": "削除前に再チェック",
    "staleBody": "この review snapshot は 15 分以上前のものです。削除前に新しいチェックを実行してください。",
    "media": "表示メディア",
    "photos": "写真",
    "videos": "動画",
    "audio": "音声",
    ...
    "choose": "内容を把握し、不要だと判断したメディアだけを選択してください",
    "more": "さらに表示",
    "noMatch": "このフィルターに一致するメディアはありません。",
    "selected": "{count} 件選択 · {size}",
    "clear": "選択解除",
    "review": "選択内容を確認",
    "limit": "1 回の検証済みバッチで最大 500 ファイルです。",
    "limitReached": "500 ファイルの安全上限に達しました。",
    "finalKicker": "最終確認",
    "finalTitle": "選択したメディアを削除しますか？",
    "finalBody": "選択したファイルだけを完全に削除します。回収容量は Android がファイルの消失を確認した後だけ計上します。",
    "back": "戻る",
    "deleteVerify": "削除して確認",
    "deleting": "削除して確認中…",
    "resultKicker": "検証済み",
    "resultTitle": "Media Review が完了しました",
    "reclaimed": "回収容量",
    "removed": "削除済み",
    "protected": "保護",
    "failed": "失敗",
    "resultBody": "Android が消えたと確認したファイルだけを削除件数と回収容量に数えます。",
    "remaining": "残りを確認",
    "done": "完了",
    "checked": "確認",
    "justNow": "たった今",
    "minAgo": "分前",
    "dateUnknown": "日付情報なし",
    "locationUnknown": "共有ストレージ",
    "metadata": "端末内プレビュー",
    "errorTitle": "Media Review を続行できません",
    "retry": "再試行",
    "scanBusy": "別の checkup が実行中です。完了後に Media Review を更新します。",
    "available": "現在のアプリで利用できる機能",
    "featureTitle": "高度な Media Review",
    "featureBody": "表示された写真・動画・音声を、ローカルプレビュー、種類・サイズ・期間フィルター、検証済み削除で確認できます。"
  },
  "es": {
    "title": "Revisión de contenido multimedia",
    "subFree": "PRO · Filtros avanzados de revisión",
    "subPro": "Filtros avanzados de revisión · Pro activo",
    "kicker": "REVISIÓN AVANZADA DE CONTENIDO MULTIMEDIA",
    "hero": "Revisa contenido multimedia con más contexto.",
    "lead": "No es una galería completa. Muestra fotos, vídeos y audio detectados por tu última revisión y añade vistas previas locales y filtros más completos.",
    "pro": "PRO",
    "local": "SOLO LOCAL",
    "source": "FUENTE",
    "sourceValue": "Instantánea de revisión actual",
    "coverage": "COBERTURA",
    "coverageValue": "Solo contenido multimedia detectado",
    "safety": "SEGURIDAD",
    "safetyValue": "Revisar primero",
    "noSnapshotTitle": "Ejecuta primero una revisión",
    "noSnapshotBody": "Un Quick Scan puede crear una instantánea de revisión nueva. Solo lee metadatos del sistema de archivos y no elimina nada.",
    "quick": "Ejecutar Quick Scan",
    "scanningTitle": "Buscando contenido multimedia para revisar",
    ...
    "emptyTitle": "No se detectó contenido multimedia para revisar",
    "emptyBody": "La instantánea de revisión actual no contiene candidatos de foto, vídeo ni audio. Esto no significa que el dispositivo no tenga contenido multimedia.",
    "refresh": "Actualizar instantánea",
    "scopeTitle": "Ámbito del conjunto de revisión",
    "scopeBody": "Aquí solo aparece el contenido multimedia ya detectado por la revisión actual. Bearagnostic no afirma que sea toda tu biblioteca de fotos, vídeos o música.",
    "autoTitle": "Nada se selecciona automáticamente",
    "autoBody": "El contenido multimedia es personal. El tamaño, la antigüedad o el tipo de archivo nunca determinan por sí solos que algo sea basura.",
    "partialTitle": "Los detalles de revisión son parciales",
    "partialBody": "La instantánea de seguridad actual alcanzó su límite de detalle. Los filtros se aplican solo al contenido representado en esta instantánea.",
    "staleTitle": "Revisa de nuevo antes de eliminar",
    "staleBody": "Esta instantánea de revisión tiene más de 15 minutos. Ejecuta una revisión nueva antes de eliminar archivos.",
    "media": "Contenido detectado",
    "photos": "Fotos",
    "videos": "Vídeos",
    "audio": "Audio",
    "size": "Tamaño total",
    ...
    "olderYear": "1 año+",
    "largest": "Más grandes primero",
    "newest": "Más recientes primero",
    "oldest": "Más antiguos primero",
    "name": "Nombre A–Z",
    "showing": "Mostrando {shown} de {total}",
    "choose": "Elige solo contenido que reconozcas y ya no necesites",
    "more": "Mostrar más",
    "noMatch": "Ningún contenido detectado coincide con estos filtros.",
    ...
    "finalTitle": "¿Eliminar los archivos multimedia seleccionados?",
    "finalBody": "Solo se eliminarán permanentemente los archivos que seleccionaste. Bearagnostic verifica la eliminación y cuenta los bytes recuperados solo después de que Android confirme que los archivos ya no existen.",
    "back": "Atrás",
    "deleteVerify": "Eliminar y verificar",
    "deleting": "Eliminando y verificando…",
    "resultKicker": "LIMPIEZA VERIFICADA",
    "resultTitle": "Revisión de contenido multimedia completada",
    ...
    "remaining": "Revisar restantes",
    "done": "Listo",
    "checked": "Comprobado",
    "justNow": "ahora mismo",
    "minAgo": "min atrás",
    "dateUnknown": "Fecha no disponible",
    "locationUnknown": "Almacenamiento compartido",
    "metadata": "Vista previa local",
    "errorTitle": "La revisión de contenido multimedia no pudo continuar",
    "retry": "Intentar de nuevo",
    "scanBusy": "Ya hay otra revisión en curso. Media Review se actualizará cuando termine.",
    "available": "Disponible en la app actual",
    "featureTitle": "Revisión avanzada de contenido multimedia",
    "featureBody": "Revisa fotos, vídeos y audio detectados con vistas previas locales, filtros por tipo, tamaño y antigüedad, y eliminación verificada."
  },
  "pt-BR": {
    "title": "Revisão de mídia",
    "subFree": "PRO · Filtros avançados de revisão",
    "subPro": "Filtros avançados de revisão · Pro ativo",
    "kicker": "REVISÃO AVANÇADA DE MÍDIA",
    "hero": "Veja mídias que merecem revisão com mais contexto.",
    "lead": "Isto não é uma galeria completa. Mostra fotos, vídeos e áudios encontrados na sua última verificação e adiciona prévias locais e filtros mais completos.",
    "pro": "PRO",
    "local": "SOMENTE LOCAL",
    "source": "FONTE",
    "sourceValue": "Snapshot de revisão atual",
    "coverage": "COBERTURA",
    "coverageValue": "Somente mídias encontradas",
    "safety": "SEGURANÇA",
    "safetyValue": "Revisar primeiro",
    "noSnapshotTitle": "Execute uma verificação primeiro",
    "noSnapshotBody": "Um Quick Scan pode criar um novo snapshot de revisão. Ele lê apenas metadados do sistema de arquivos e não exclui nada.",
    "quick": "Executar Quick Scan",
    "scanningTitle": "Procurando mídias para revisar",
    ...
    "emptyTitle": "Nenhuma mídia foi encontrada para revisão",
    "emptyBody": "O snapshot de revisão atual não contém candidatos de foto, vídeo ou áudio. Isso não significa que o dispositivo não tenha mídia.",
    "refresh": "Atualizar snapshot",
    "scopeTitle": "Escopo do conjunto de revisão",
    "scopeBody": "Aqui aparece somente a mídia já encontrada pela verificação atual. O Bearagnostic não afirma que esta seja toda a sua biblioteca de fotos, vídeos ou músicas.",
    "autoTitle": "Nada é selecionado automaticamente",
    "autoBody": "Mídia é algo pessoal. Tamanho, idade ou tipo de arquivo nunca determinam, sozinhos, que algo seja lixo.",
    "partialTitle": "Os detalhes da revisão são parciais",
    "partialBody": "O snapshot de segurança atual atingiu o limite de detalhes. Os filtros se aplicam somente às mídias representadas neste snapshot.",
    "staleTitle": "Verifique novamente antes de excluir",
    "staleBody": "Este snapshot de revisão tem mais de 15 minutos. Execute uma nova verificação antes de remover arquivos.",
    "media": "Mídias encontradas",
    "photos": "Fotos",
    "videos": "Vídeos",
    "audio": "Áudio",
    "size": "Tamanho total",
    ...
    "name": "Nome A–Z",
    "showing": "Mostrando {shown} de {total}",
    "choose": "Escolha apenas mídias que você reconhece e não precisa mais",
    "more": "Mostrar mais",
    "noMatch": "Nenhuma mídia encontrada corresponde a estes filtros.",
    "selected": "{count} selecionados · {size}",
    "clear": "Limpar",
    "review": "Revisar selecionados",
    ...
    "finalTitle": "Remover os arquivos de mídia selecionados?",
    "finalBody": "Somente os arquivos que você selecionou serão removidos permanentemente. O Bearagnostic verifica a exclusão e só conta os bytes recuperados depois que o Android confirma que os arquivos foram removidos.",
    "back": "Voltar",
    "deleteVerify": "Excluir e verificar",
    "deleting": "Excluindo e verificando…",
    "resultKicker": "LIMPEZA VERIFICADA",
    "resultTitle": "Revisão de mídia concluída",
    "reclaimed": "Recuperado",
    "removed": "Removidos",
    "protected": "Protegidos",
    "failed": "Falharam",
    ...
    "locationUnknown": "Armazenamento compartilhado",
    "metadata": "Prévia local",
    "errorTitle": "A revisão de mídia não pôde continuar",
    "retry": "Tentar novamente",
    "scanBusy": "Outra verificação já está em andamento. A revisão de mídia será atualizada quando ela terminar.",
    "available": "Disponível no app atual",
    "featureTitle": "Revisão avançada de mídia",
    "featureBody": "Revise fotos, vídeos e áudios encontrados com prévias locais, filtros por tipo, tamanho e idade e exclusão verificada."
  }
};
  ...
  function ageText(ms) {
    ...
    try { return new Intl.DateTimeFormat(language()==='th'?'th-TH':language()==='ja'?'ja-JP':language()==='es'?'es-ES':language()==='pt-BR'?'pt-BR':'en-US',{year:'numeric',month:'short',day:'numeric'}).format(new Date(value)); }
  ...
  function ensureSurface() {
    ...
    surface.innerHTML = `<header class="ba-media-head"><span>${badge(true)}</span><div class="ba-media-head__copy"><strong id="baMediaSurfaceTitle"></strong><small>BEARAGNOSTIC · LOCAL REVIEW · PRO</small></div><button class="ba-media-close" type="button" data-media-action="close" aria-label="${esc(window.BearagnosticLaunchLocales?.a11y?.('close') || c().back)}">×</button></header><div class="ba-media-scroll"><div class="ba-media-wrap" id="baMediaContent"></div></div><div id="baMediaSelection"></div>`;
