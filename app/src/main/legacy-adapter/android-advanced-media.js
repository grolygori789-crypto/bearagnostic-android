(() => {
  ...
  function bulkCandidates(){return filteredItems();}
  ...
  function finishBulkSelection(){state.message='';syncBulkSelectionDom();renderSelection();window.BearagnosticFinalPolish?.syncBulkControls?.();return bulkStatus();}
