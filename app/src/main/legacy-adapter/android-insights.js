(() => {
  ...
  "en": {
    "kicker": "INSIGHTS",
    "title": "Your storage, explained over time.",
    ...
    "goCheckup": "Go to Checkup",
    "privacyLine": "No account · No cloud · No file names or paths stored",
    "latest": "LATEST CHECKUP",
    "latestTitle": "What Bearagnostic saw",
    "files": "Files",
    "scannedData": "Accessible data",
    ...
    "deviceTitle": "Space on this device",
    "used": "Used",
    "free": "Free",
    "storageUnavailable": "Device storage snapshot unavailable",
    "changed": "WHAT CHANGED",
    "changedTitle": "Since the previous comparable checkup",
    ...
    "accessibleData": "Accessible data",
    ...
    "since": "since",
    "trend": "STORAGE TREND",
    "trendTitle": "Comparable checkups",
    "trendBody": "Accessible-file totals from complete full-scope checkups only.",
    "history": "CHECKUP HISTORY",
    "historyTitle": "Recent completed checkups",
    "complete": "Complete",
    "partial": "Partial",
    "cleanup": "VERIFIED CLEANUP",
    "cleanupTitle": "What Bearagnostic actually removed",
    "cleanups": "Cleanup events",
    "removed": "Items removed",
    "reclaimed": "Verified space",
    "noCleanups": "No verified cleanup has been recorded yet.",
    "fileCleanup": "Files cleaned",
    "folderCleanup": "Empty folders removed",
    "verified": "Verified",
    "pattern": "PATTERN",
    "patternTitle": "A useful signal, only when the data supports it",
    ...
    "privacy": "PRIVACY",
    "privacyTitle": "History stays under your control",
    ...
    "clearAsk": "Clear all local Insights history?",
    "clearBody": "This removes saved checkup and cleanup aggregates from Bearagnostic. It does not delete any of your files.",
    "cancel": "Cancel",
    "clearNow": "Clear history",
    "proFeatureTitle": "Insights & Local History",
    "proFeatureBody": "Historical checkups, What Changed, real storage trends, patterns, and verified cleanup history — all kept on this device.",
    "plannedInsights": "Historical Insights & What Changed",
    "plannedCleanup": "Full cleanup history",
    "justNow": "just now",
  ...
  "th": {
    ...
    "goCheckup": "ไปที่ Checkup",
    "privacyLine": "ไม่ต้องมีบัญชี · ไม่ขึ้นคลาวด์ · ไม่เก็บชื่อไฟล์หรือพาธ",
    "latest": "การตรวจล่าสุด",
    "latestTitle": "สิ่งที่ Bearagnostic พบ",
    "files": "ไฟล์",
    "scannedData": "ข้อมูลที่เข้าถึงได้",
    ...
    "modeCustom": "Custom",
    "modeUnknown": "Checkup",
    "deviceStorage": "พื้นที่เครื่อง",
    "deviceTitle": "พื้นที่จัดเก็บบนอุปกรณ์นี้",
    "used": "ใช้แล้ว",
    "free": "ว่าง",
    "storageUnavailable": "ไม่มี snapshot พื้นที่เครื่องสำหรับรอบนี้",
    "changed": "มีอะไรเปลี่ยนไป",
    "changedTitle": "เทียบกับการตรวจครั้งก่อนที่ขอบเขตเทียบกันได้",
    ...
    "accessibleData": "ข้อมูลที่เข้าถึงได้",
    "fileCount": "จำนวนไฟล์",
    "downloads": "Downloads",
    "noChange": "แทบไม่เปลี่ยน",
    "more": "มากขึ้น",
    "less": "น้อยลง",
    "since": "จาก",
    "trend": "แนวโน้มพื้นที่",
    "trendTitle": "การตรวจที่เทียบกันได้",
    "trendBody": "ใช้ยอดข้อมูลจากการตรวจเต็มขอบเขตที่ครอบคลุมสมบูรณ์เท่านั้น",
    "history": "ประวัติการตรวจ",
    "historyTitle": "การตรวจที่เสร็จล่าสุด",
    "complete": "สมบูรณ์",
    "partial": "บางส่วน",
    "cleanup": "การลบที่ยืนยันแล้ว",
    "cleanupTitle": "สิ่งที่ Bearagnostic ลบออกจริง",
    "cleanups": "ครั้งที่ลบ",
    "removed": "รายการที่ลบ",
    "reclaimed": "พื้นที่ที่ยืนยัน",
    "noCleanups": "ยังไม่มีประวัติการลบที่ยืนยันแล้ว",
    "fileCleanup": "ลบไฟล์",
    "folderCleanup": "ลบโฟลเดอร์ว่าง",
    "verified": "ยืนยันแล้ว",
    "pattern": "รูปแบบ",
    "patternTitle": "แสดงเฉพาะสัญญาณที่ข้อมูลรองรับจริง",
    ...
    "privacyTitle": "ประวัติอยู่ภายใต้การควบคุมของคุณ",
    ...
    "clear": "ล้างประวัติในเครื่อง",
    "clearAsk": "ล้างประวัติ Insights ทั้งหมดหรือไม่",
    "clearBody": "ระบบจะลบเฉพาะข้อมูลสรุปการตรวจและการลบที่ Bearagnostic บันทึกไว้ ไม่ได้ลบไฟล์ของคุณ",
    "cancel": "ยกเลิก",
    "clearNow": "ล้างประวัติ",
    "proFeatureTitle": "Insights และประวัติในเครื่อง",
    "proFeatureBody": "ดูประวัติการตรวจ What Changed แนวโน้มพื้นที่ รูปแบบ และประวัติการลบที่ยืนยันแล้ว โดยเก็บไว้บนเครื่องนี้เท่านั้น",
    "plannedInsights": "Insights ย้อนหลังและ What Changed",
    "plannedCleanup": "ประวัติการทำความสะอาดแบบเต็ม",
  ...
  "ja": {
    ...
    "goCheckup": "Checkup へ",
    "privacyLine": "アカウント不要 · クラウドなし · ファイル名やパスは保存しません",
    "latest": "最新のチェック",
    "latestTitle": "Bearagnostic が確認した内容",
    "files": "ファイル",
    "scannedData": "アクセス可能データ",
    "reviewItems": "確認項目",
    "checked": "確認時刻",
    "modeQuick": "Quick",
    "modeSmart": "Smart",
    ...
    "modeCustom": "Custom",
    "modeUnknown": "Checkup",
    "deviceStorage": "端末ストレージ",
    "deviceTitle": "この端末の空き容量",
    "used": "使用済み",
    "free": "空き",
    "storageUnavailable": "このチェックには端末ストレージ snapshot がありません",
    "changed": "変化",
    "changedTitle": "比較可能な前回チェックとの差",
    ...
    "since": "前回比",
    "trend": "ストレージ推移",
    "trendTitle": "比較可能なチェック",
    "trendBody": "完全なフルスコープチェックのアクセス可能データだけを表示します。",
    "history": "チェック履歴",
    "historyTitle": "最近完了したチェック",
    "complete": "完全",
    "partial": "部分",
    "cleanup": "検証済みクリーンアップ",
    "cleanupTitle": "実際に削除されたもの",
    "cleanups": "削除イベント",
    "removed": "削除項目",
    "reclaimed": "確認済み容量",
    "noCleanups": "検証済みクリーンアップ履歴はまだありません。",
    "fileCleanup": "ファイルを削除",
    "folderCleanup": "空フォルダを削除",
    "verified": "検証済み",
    "pattern": "パターン",
    "patternTitle": "データが裏付ける場合だけ表示",
    "patternNeed": "パターンと呼ぶには、比較可能なフルスコープチェックが少なくとも 3 回必要です。",
    "steady": "直近 3 回の比較可能なチェックでは、アクセス可能データはほぼ安定しています。",
    "downloadsGrow": "直近 3 回で Downloads が {value} 増えました。",
    "downloadsShrink": "直近 3 回で Downloads が {value} 減りました。",
    "largeGrow": "直近 3 回で大容量ファイルが {value} 増えました。",
    "largeShrink": "直近 3 回で大容量ファイルが {value} 減りました。",
    "storageGrow": "直近 3 回でアクセス可能データが {value} 増えました。",
    "storageShrink": "直近 3 回でアクセス可能データが {value} 減りました。",
    "proTitle": "履歴インサイトは Pro 機能です",
    "proBody": "最新チェックの事実は全ユーザーに表示されます。Pro では端末内履歴、What Changed、パターン、完全な検証済み削除履歴を利用できます。",
    "privacy": "プライバシー",
    "privacyTitle": "履歴はあなたの管理下にあります",
    "privacyBody": "この端末に集計値だけを保存します。ファイル名、パス、ハッシュ、内容は保存しません。最大 30 回のチェックと 50 件の削除イベントに制限されます。",
    "clear": "端末内履歴を消去",
    "clearAsk": "Insights のローカル履歴をすべて消去しますか？",
    "clearBody": "Bearagnostic が保存したチェックと削除の集計だけを消去します。ファイルは削除しません。",
    "cancel": "キャンセル",
    "clearNow": "履歴を消去",
    "proFeatureTitle": "Insights とローカル履歴",
    "proFeatureBody": "チェック履歴、What Changed、実データの推移、パターン、検証済み削除履歴をすべて端末内で利用できます。",
    "plannedInsights": "履歴 Insights と What Changed",
    "plannedCleanup": "完全なクリーンアップ履歴",
    "justNow": "たった今",
    "minutesAgo": "{n}分前",
    "hoursAgo": "{n}時間前",
    "daysAgo": "{n}日前"
  ...
  "es": {
    "kicker": "INSIGHTS",
    "title": "Tu almacenamiento, explicado a lo largo del tiempo.",
    "lead": "Creado solo a partir de revisiones completadas y limpiezas verificadas en este dispositivo. Sin puntuaciones inventadas.",
    "local": "SOLO LOCAL",
    "aggregate": "Historial agregado",
    "noHistoryTitle": "El historial empieza con tu próxima revisión",
    "noHistoryBody": "Ejecuta una revisión real y Bearagnostic empezará una cronología privada y agregada únicamente en este dispositivo.",
    "goCheckup": "Ir a Revisión",
    "privacyLine": "Sin cuenta · Sin nube · No se guardan nombres ni rutas de archivos",
    "latest": "ÚLTIMA REVISIÓN",
    "latestTitle": "Lo que vio Bearagnostic",
    "files": "Archivos",
    "scannedData": "Datos accesibles",
    ...
    "modeDeep": "Deep",
    "modeCustom": "Custom",
    "modeUnknown": "Revisión",
    "deviceStorage": "ALMACENAMIENTO DEL DISPOSITIVO",
    "deviceTitle": "Espacio en este dispositivo",
    "used": "Usado",
    "free": "Gratis",
    "storageUnavailable": "Instantánea del almacenamiento no disponible",
    "changed": "QUÉ CAMBIÓ",
    "changedTitle": "Desde la revisión comparable anterior",
    "needAnother": "Se necesita una revisión más de ámbito completo antes de que Bearagnostic pueda comparar cambios.",
    "selectedScope": "La última revisión usó un ámbito seleccionado. Ejecuta Quick, Smart o Deep para obtener una comparación de cambios de ámbito completo.",
    "partialScope": "La última revisión de ámbito completo fue parcial. Bearagnostic no la comparará como si la cobertura fuera completa.",
    "accessibleData": "Datos accesibles",
    "fileCount": "Cantidad de archivos",
    "downloads": "Descargas",
    "noChange": "Sin cambios medibles",
    "more": "más",
    "less": "menos",
    "since": "desde",
    "trend": "TENDENCIA DE ALMACENAMIENTO",
    "trendTitle": "Revisiones comparables",
    "trendBody": "Totales de archivos accesibles solo de revisiones completas de ámbito completo.",
    "history": "HISTORIAL DE REVISIONES",
    "historyTitle": "Revisiones completadas recientes",
    "complete": "Completa",
    "partial": "Parcial",
    "cleanup": "LIMPIEZA VERIFICADA",
    "cleanupTitle": "Lo que Bearagnostic eliminó realmente",
    "cleanups": "Eventos de limpieza",
    "removed": "Elementos eliminados",
    "reclaimed": "Espacio verificado",
    "noCleanups": "Todavía no se ha registrado ninguna limpieza verificada.",
    "fileCleanup": "Archivos limpiados",
    "folderCleanup": "Carpetas vacías eliminadas",
    "verified": "Verificado",
    "pattern": "PATRÓN",
    "patternTitle": "Una señal útil, solo cuando los datos la respaldan",
    "patternNeed": "Bearagnostic necesita al menos tres revisiones comparables de ámbito completo antes de considerar algo un patrón.",
    "steady": "El almacenamiento accesible se ha mantenido bastante estable en tus últimas tres revisiones comparables.",
    "downloadsGrow": "Descargas aumentó {value} en tus últimas tres revisiones comparables.",
    "downloadsShrink": "Descargas disminuyó {value} en tus últimas tres revisiones comparables.",
    "largeGrow": "La huella de archivos grandes aumentó {value} en tus últimas tres revisiones comparables.",
    "largeShrink": "La huella de archivos grandes disminuyó {value} en tus últimas tres revisiones comparables.",
    "storageGrow": "Los datos accesibles aumentaron {value} en tus últimas tres revisiones comparables.",
    "storageShrink": "Los datos accesibles disminuyeron {value} en tus últimas tres revisiones comparables.",
    "proTitle": "Los Insights históricos son una función Pro",
    "proBody": "Los datos de la última revisión siguen visibles para todos. Pro añade historial en el dispositivo, What Changed, patrones e historial completo de limpiezas verificadas.",
    "privacy": "PRIVACIDAD",
    "privacyTitle": "El historial permanece bajo tu control",
    "privacyBody": "Bearagnostic guarda solo totales agregados en este dispositivo, nunca nombres, rutas, hashes ni contenido de archivos. El historial se limita a 30 revisiones y 50 eventos de limpieza.",
    "clear": "Borrar historial local",
    "clearAsk": "¿Borrar todo el historial local de Insights?",
    "clearBody": "Esto elimina de Bearagnostic los agregados guardados de revisiones y limpiezas. No elimina ninguno de tus archivos.",
    "cancel": "Cancelar",
    "clearNow": "Borrar historial",
    "proFeatureTitle": "Insights e historial local",
    "proFeatureBody": "Revisiones históricas, What Changed, tendencias reales de almacenamiento, patrones e historial de limpiezas verificadas, todo guardado en este dispositivo.",
    "plannedInsights": "Insights históricos y What Changed",
    "plannedCleanup": "Historial completo de limpiezas",
    "justNow": "ahora mismo",
  ...
  "pt-BR": {
    "kicker": "INSIGHTS",
    "title": "Seu armazenamento, explicado ao longo do tempo.",
    "lead": "Criado apenas a partir de verificações concluídas e limpezas verificadas neste dispositivo. Sem pontuação inventada.",
    "local": "SOMENTE LOCAL",
    "aggregate": "Histórico agregado",
    "noHistoryTitle": "O histórico começa com a sua próxima verificação",
    "noHistoryBody": "Execute uma verificação real e o Bearagnostic iniciará uma linha do tempo privada e somente agregada neste dispositivo.",
    "goCheckup": "Ir para Verificação",
    "privacyLine": "Sem conta · Sem nuvem · Nenhum nome ou caminho de arquivo armazenado",
    "latest": "ÚLTIMA VERIFICAÇÃO",
    "latestTitle": "O que o Bearagnostic viu",
    "files": "Arquivos",
    "scannedData": "Dados acessíveis",
    ...
    "modeDeep": "Deep",
    "modeCustom": "Custom",
    "modeUnknown": "Verificação",
    "deviceStorage": "ARMAZENAMENTO DO DISPOSITIVO",
    "deviceTitle": "Espaço neste dispositivo",
    "used": "Usado",
    "free": "Grátis",
    "storageUnavailable": "Snapshot do armazenamento indisponível",
    "changed": "O QUE MUDOU",
    "changedTitle": "Desde a verificação comparável anterior",
    "needAnother": "É necessária mais uma verificação de escopo completo antes que o Bearagnostic possa comparar mudanças.",
    "selectedScope": "A última verificação usou um escopo selecionado. Execute Quick, Smart ou Deep para obter uma comparação de mudanças de escopo completo.",
    "partialScope": "A última verificação de escopo completo foi parcial. O Bearagnostic não a comparará como se a cobertura fosse completa.",
    "accessibleData": "Dados acessíveis",
    "fileCount": "Quantidade de arquivos",
    "downloads": "Downloads",
    "noChange": "Sem mudança mensurável",
    "more": "mais",
    "less": "menos",
    "since": "desde",
    "trend": "TENDÊNCIA DE ARMAZENAMENTO",
    "trendTitle": "Verificações comparáveis",
    "trendBody": "Totais de arquivos acessíveis apenas de verificações completas de escopo total.",
    "history": "HISTÓRICO DE VERIFICAÇÕES",
    "historyTitle": "Verificações concluídas recentemente",
    "complete": "Completa",
    "partial": "Parcial",
    "cleanup": "LIMPEZA VERIFICADA",
    "cleanupTitle": "O que o Bearagnostic realmente removeu",
    "cleanups": "Eventos de limpeza",
    "removed": "Itens removidos",
    "reclaimed": "Espaço verificado",
    "noCleanups": "Ainda não foi registrada nenhuma limpeza verificada.",
    "fileCleanup": "Arquivos limpos",
    "folderCleanup": "Pastas vazias removidas",
    "verified": "Verificado",
    "pattern": "PADRÃO",
    "patternTitle": "Um sinal útil, somente quando os dados o sustentam",
    "patternNeed": "O Bearagnostic precisa de pelo menos três verificações comparáveis de escopo completo antes de chamar algo de padrão.",
    "steady": "O armazenamento acessível permaneceu relativamente estável nas suas últimas três verificações comparáveis.",
    "downloadsGrow": "Downloads cresceu {value} nas suas últimas três verificações comparáveis.",
    "downloadsShrink": "Downloads diminuiu {value} nas suas últimas três verificações comparáveis.",
    "largeGrow": "O volume de arquivos grandes cresceu {value} nas suas últimas três verificações comparáveis.",
    "largeShrink": "O volume de arquivos grandes diminuiu {value} nas suas últimas três verificações comparáveis.",
    "storageGrow": "Os dados acessíveis cresceram {value} nas suas últimas três verificações comparáveis.",
    "storageShrink": "Os dados acessíveis diminuíram {value} nas suas últimas três verificações comparáveis.",
    "proTitle": "Insights históricos são um recurso Pro",
    "proBody": "Os dados da última verificação continuam visíveis para todos. O Pro adiciona histórico no dispositivo, What Changed, padrões e histórico completo de limpezas verificadas.",
    "privacy": "PRIVACIDADE",
    "privacyTitle": "O histórico permanece sob seu controle",
    "privacyBody": "O Bearagnostic armazena apenas totais agregados neste dispositivo — nunca nomes, caminhos, hashes ou conteúdo dos arquivos. O histórico é limitado a 30 verificações e 50 eventos de limpeza.",
    "clear": "Limpar histórico local",
    "clearAsk": "Limpar todo o histórico local de Insights?",
    "clearBody": "Isso remove do Bearagnostic os agregados salvos de verificações e limpezas. Não exclui nenhum dos seus arquivos.",
    "cancel": "Cancelar",
    "clearNow": "Limpar histórico",
    "proFeatureTitle": "Insights e histórico local",
    "proFeatureBody": "Verificações históricas, What Changed, tendências reais de armazenamento, padrões e histórico de limpezas verificadas — tudo mantido neste dispositivo.",
    "plannedInsights": "Insights históricos e What Changed",
    "plannedCleanup": "Histórico completo de limpezas",
    "justNow": "agora mesmo",
    "minutesAgo": "há {n} min",
    "hoursAgo": "há {n} h",
    "daysAgo": "há {n} d"
  ...
  function formatCount(value) {
    try { return new Intl.NumberFormat(language() === 'th' ? 'th-TH' : language() === 'ja' ? 'ja-JP' : language() === 'es' ? 'es-ES' : language() === 'pt-BR' ? 'pt-BR' : 'en-US').format(n(value)); }
