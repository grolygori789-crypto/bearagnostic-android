(() => {
  ...
  const COPY = {
  "en": {
    "kicker": "EXACT DUPLICATES",
    "title": "Keep one. Remove the extras.",
    ...
    "noAccessBody": "Android must allow shared-storage access before Bearagnostic can verify duplicate files.",
    "openSettings": "Open Android settings",
    "noSnapshotTitle": "Verify duplicates with Smart Checkup",
    "noSnapshotBody": "There is no current duplicate-verification snapshot yet. Smart Checkup verifies exact matches in priority shared folders without deleting anything.",
    "runSmart": "Run Smart Checkup",
    "quickTitle": "This Quick Scan did not verify duplicates",
    "quickBody": "Quick Scan intentionally avoids duplicate hashing. Run Smart Checkup for exact duplicate verification.",
    "customTitle": "Refresh duplicate verification",
    "customBody": "This Custom Scan did not surface a verified duplicate group. Run Smart Checkup to verify exact matches in the recommended shared folders.",
    "scanningTitle": "Verifying exact duplicate evidence",
    "scanningBody": "This follows the scanner’s real work. No waiting time is added for appearance.",
    "source": "SOURCE",
    "scope": "COVERAGE",
    "evidence": "EVIDENCE",
    "sourceLive": "Live checkup",
    "focused": "Priority shared folders",
    "full": "All accessible shared storage",
    "selectedScope": "Selected Custom Scan locations",
    "exact": "Exact match verification",
    "phasePreparing": "Discovering files",
    "phaseDetails": "Reading file details",
    "phaseSizes": "Matching file sizes",
    "phaseDuplicates": "Verifying identical content",
    "phaseDates": "Checking modified dates",
    "phaseFinalizing": "Building verified groups",
    "filesReviewed": "Files reviewed",
    "hashedFiles": "Files verified",
    "hashedBytes": "Verification data read",
    "waiting": "Preparing the next item…",
    "localLive": "LOCAL · LIVE",
    "groups": "Duplicate groups",
    "extras": "Removable copies",
    "reclaimable": "Reclaimable",
    "checked": "Checked",
    "current": "just now",
    "minAgo": "min ago",
    "trustTitle": "Why these are duplicates",
    "trustBody": "Bearagnostic first matches exact file size, then verifies the file content byte-for-byte on this device. Similar-looking files are not enough.",
    "focusedTitle": "Focused duplicate coverage",
    "focusedBody": "Smart Checkup checks priority shared folders for exact duplicates. Pro can run Deep Scan to check across all accessible shared storage.",
    "fullTitle": "Full duplicate coverage",
    "fullBody": "This result came from Deep Scan, which checks for exact duplicates across the accessible shared-storage scope.",
    "customCoverageTitle": "Custom duplicate coverage",
    "customCoverageBody": "This result contains verified duplicates from the selected Custom Scan locations.",
    "verifyAll": "Verify all accessible storage",
    "pro": "PRO",
    "noDupTitle": "No exact duplicate groups verified",
    "noDupBody": "No byte-for-byte duplicate group was verified in this scan’s duplicate coverage. Similar files are intentionally not treated as duplicates.",
    "checkAgain": "Check again",
    "done": "Done",
    "close": "Close",
    "selectionPrompt": "Choose extra copies to remove",
    "selectionPicked": "{count} copies selected",
    "loadingGroups": "Preparing duplicate groups",
    "loadingBody": "Grouping verified copies from the current review snapshot.",
    "loaded": "loaded",
    "group": "Group",
    "copies": "identical copies",
    "canReclaim": "can be reclaimed",
    "exactBadge": "EXACT MATCH",
    "keep": "KEEP",
    "keepThis": "Keep this",
    "remove": "Remove",
    "removeExtras": "Select extras",
    "clearGroup": "Clear group",
    "selected": "selected",
    "clearAll": "Clear",
    "bulkSelect": "Select recommended",
    "bulkPro": "Select recommended · PRO",
    ...
    "staleBody": "This review snapshot is more than 15 minutes old. Re-verify duplicates before permanent deletion.",
    "reviewSelected": "Review selected",
    "selectedSummary": "{count} copies · {bytes}",
    "limit": "Up to 500 selected files can be deleted in one verified batch.",
    "confirmKicker": "FINAL REVIEW",
    "confirmTitle": "Remove the selected duplicate copies?",
    "confirmBody": "Only the selected copies will be permanently deleted. The copy marked Keep in every group remains unselected.",
    "groupsAffected": "groups affected",
    "protection": "Keep-one-copy protection remains active in the native deletion layer too.",
    "cancel": "Cancel",
    "deleteVerify": "Delete & verify",
    "deleting": "Deleting and verifying…",
    "resultKicker": "VERIFIED DUPLICATE CLEANUP",
    "resultTitle": "Duplicate cleanup complete",
    "reclaimedLabel": "verified space reclaimed",
    "removedLabel": "copies removed",
    "resolvedLabel": "groups resolved",
    "nativeProtected": "native protections",
    "failed": "not removed",
    "resultBody": "Only files Android confirmed as gone are counted as removed or reclaimed.",
    "reviewRemaining": "Review remaining",
    "errorTitle": "Duplicates could not continue",
    "retry": "Try again",
    "scanFailed": "The duplicate check could not start.",
    "scanRunning": "Another checkup is already running. Bearagnostic will use its review snapshot when it finishes.",
    "homeFound": "{groups} groups · {extras} extras",
    "toolsFound": "{groups} verified groups · {extras} removable copies",
    "homeClear": "No exact repeats",
    "toolsClear": "No exact duplicate groups",
    "homeNeeds": "Run Smart check",
    "toolsNeeds": "Run Smart Checkup to verify duplicates",
    "kindImage": "Photo",
    "kindVideo": "Video",
    "kindAudio": "Audio",
    ...
    "moreGroups": "More verified groups are available below.",
    "partial": "Review details reached the safety display limit. Only groups present in this current verified snapshot are shown."
  },
  "th": {
    "kicker": "ไฟล์ซ้ำแบบ EXACT",
    "title": "เก็บหนึ่งสำเนา ลบเฉพาะส่วนเกิน",
    ...
    "noAccessBody": "Android ต้องอนุญาต shared storage ก่อนที่ Bearagnostic จะตรวจยืนยันไฟล์ซ้ำได้",
    "openSettings": "เปิดการตั้งค่า Android",
    "noSnapshotTitle": "ตรวจไฟล์ซ้ำด้วย Smart Checkup",
    "noSnapshotBody": "ยังไม่มี snapshot ปัจจุบันที่ผ่านการยืนยันไฟล์ซ้ำ Smart Checkup จะตรวจ exact match ในโฟลเดอร์ shared ที่สำคัญโดยยังไม่ลบอะไร",
    "runSmart": "เริ่ม Smart Checkup",
    "quickTitle": "Quick Scan รอบนี้ไม่ได้ตรวจยืนยันไฟล์ซ้ำ",
    "quickBody": "Quick Scan ตั้งใจไม่ทำ duplicate hashing เพื่อเน้นความเร็ว ให้ใช้ Smart Checkup เพื่อยืนยันไฟล์ซ้ำแบบ exact",
    "customTitle": "ตรวจไฟล์ซ้ำใหม่",
    "customBody": "Custom Scan รอบนี้ยังไม่แสดงกลุ่มไฟล์ซ้ำที่ยืนยันแล้ว ให้ใช้ Smart Checkup เพื่อตรวจ exact match ในตำแหน่ง shared ที่แนะนำ",
    "scanningTitle": "กำลังยืนยันหลักฐานไฟล์ซ้ำ",
    "scanningBody": "หน้านี้เดินตามงานจริงของตัวสแกน ไม่มีการหน่วงเวลาเพื่อให้ดูนาน",
    "source": "แหล่งข้อมูล",
    "scope": "ขอบเขต",
    "evidence": "หลักฐาน",
    "sourceLive": "การตรวจที่กำลังทำงาน",
    "focused": "โฟลเดอร์ shared สำคัญ",
    "full": "shared storage ที่เข้าถึงได้ทั้งหมด",
    "selectedScope": "ตำแหน่ง Custom Scan ที่เลือก",
    "exact": "ยืนยันว่าเหมือนกันจริง",
    "phasePreparing": "กำลังค้นหาไฟล์",
    "phaseDetails": "กำลังอ่านรายละเอียดไฟล์",
    "phaseSizes": "กำลังจับคู่ขนาดไฟล์",
    "phaseDuplicates": "กำลังยืนยันเนื้อหาที่ตรงกัน",
    "phaseDates": "กำลังตรวจวันที่แก้ไข",
    "phaseFinalizing": "กำลังสร้างกลุ่มที่ยืนยันแล้ว",
    "filesReviewed": "ไฟล์ที่ตรวจแล้ว",
    "hashedFiles": "ไฟล์ที่ยืนยันแล้ว",
    "hashedBytes": "ข้อมูลที่อ่านเพื่อยืนยัน",
    "waiting": "กำลังเตรียมรายการถัดไป…",
    "localLive": "บนเครื่อง · เรียลไทม์",
    "groups": "กลุ่มไฟล์ซ้ำ",
    "extras": "สำเนาที่ลบได้",
    "reclaimable": "พื้นที่ที่คืนได้",
    "checked": "ตรวจเมื่อ",
    "current": "เมื่อสักครู่",
    "minAgo": "นาทีที่แล้ว",
    "trustTitle": "ทำไมจึงถือว่าเป็นไฟล์ซ้ำ",
    "trustBody": "Bearagnostic จับคู่ขนาดไฟล์ที่ตรงกันก่อน แล้วตรวจเนื้อหาแบบ byte-for-byte ภายในเครื่อง ไฟล์ที่เพียงดูคล้ายกันจะไม่ถูกนับเป็นไฟล์ซ้ำ",
    "focusedTitle": "ขอบเขตไฟล์ซ้ำแบบ Focused",
    "focusedBody": "Smart Checkup ตรวจหาไฟล์ซ้ำแบบ exact ในโฟลเดอร์ shared สำคัญ ส่วน Pro สามารถใช้ Deep Scan เพื่อตรวจทั่ว shared storage ที่เข้าถึงได้",
    "fullTitle": "ขอบเขตไฟล์ซ้ำเต็มพื้นที่",
    "fullBody": "ผลนี้มาจาก Deep Scan ซึ่งตรวจหาไฟล์ซ้ำแบบ exact ทั่วขอบเขต shared storage ที่เข้าถึงได้",
    "customCoverageTitle": "ขอบเขตไฟล์ซ้ำแบบ Custom",
    "customCoverageBody": "ผลนี้เป็นไฟล์ซ้ำที่ยืนยันแล้วจากตำแหน่ง Custom Scan ที่เลือก",
    "verifyAll": "ตรวจทั่วพื้นที่ที่เข้าถึงได้",
    "pro": "PRO",
    "noDupTitle": "ไม่มีกลุ่มไฟล์ซ้ำแบบ exact ที่ยืนยันได้",
    "noDupBody": "ไม่พบกลุ่มไฟล์ที่ยืนยันว่าเหมือนกันทุกไบต์ภายในขอบเขตการตรวจรอบนี้ ไฟล์ที่แค่ดูคล้ายกันจะไม่ถูกเหมารวมเป็นไฟล์ซ้ำ",
    "checkAgain": "ตรวจอีกครั้ง",
    "done": "เสร็จสิ้น",
    "close": "ปิด",
    "selectionPrompt": "เลือกเฉพาะสำเนาส่วนเกินที่ต้องการลบ",
    "selectionPicked": "เลือกแล้ว {count} สำเนา",
    "loadingGroups": "กำลังเตรียมกลุ่มไฟล์ซ้ำ",
    "loadingBody": "กำลังจัดกลุ่มสำเนาที่ผ่านการยืนยันจาก review snapshot ปัจจุบัน",
    "loaded": "โหลดแล้ว",
    "group": "กลุ่ม",
    "copies": "สำเนาที่เหมือนกัน",
    "canReclaim": "คืนพื้นที่ได้",
    "exactBadge": "ตรงกันจริง",
    "keep": "เก็บไว้",
    "keepThis": "เก็บไฟล์นี้",
    "remove": "ลบ",
    "removeExtras": "เลือกสำเนาส่วนเกิน",
    "clearGroup": "ล้างกลุ่ม",
    "selected": "เลือกแล้ว",
    "clearAll": "ล้างทั้งหมด",
    "bulkSelect": "เลือกตามคำแนะนำ",
    "bulkPro": "เลือกตามคำแนะนำ · PRO",
    "bulkFreeHint": "Pro เลือกสำเนาส่วนเกินตามคำแนะนำให้ทุกกลุ่มได้ในครั้งเดียว ส่วน Free ยังตรวจและเลือกแต่ละกลุ่มเองได้ครบ",
    "loadMore": "แสดงกลุ่มเพิ่ม",
    "showing": "กำลังแสดง {shown} จาก {total} กลุ่ม",
    "staleTitle": "ตรวจใหม่ก่อนลบ",
    "staleBody": "review snapshot นี้เกิน 15 นาทีแล้ว ให้ตรวจยืนยันไฟล์ซ้ำใหม่ก่อนลบแบบถาวร",
    "reviewSelected": "ตรวจรายการที่เลือก",
    "selectedSummary": "{count} สำเนา · {bytes}",
    "limit": "หนึ่งรอบที่ยืนยันแล้วสามารถลบได้สูงสุด 500 ไฟล์",
    "confirmKicker": "ตรวจครั้งสุดท้าย",
    "confirmTitle": "ลบสำเนาไฟล์ซ้ำที่เลือก?",
    "confirmBody": "จะลบถาวรเฉพาะสำเนาที่เลือก และไฟล์ที่ทำเครื่องหมายว่า “เก็บไว้” ในแต่ละกลุ่มจะไม่ถูกเลือก",
    "groupsAffected": "กลุ่มที่ได้รับผล",
    "protection": "Native deletion layer ยังมีกฎป้องกันการลบสำเนาสุดท้ายอีกชั้นหนึ่ง",
    "cancel": "ยกเลิก",
    "deleteVerify": "ลบและตรวจยืนยัน",
    "deleting": "กำลังลบและตรวจยืนยัน…",
    "resultKicker": "ผลการจัดการไฟล์ซ้ำที่ยืนยันแล้ว",
    "resultTitle": "จัดการไฟล์ซ้ำเรียบร้อย",
    "reclaimedLabel": "พื้นที่ที่คืนได้จริง",
    "removedLabel": "สำเนาที่ลบแล้ว",
    "resolvedLabel": "กลุ่มที่จัดการจบ",
    "nativeProtected": "รายการที่ระบบปกป้อง",
    "failed": "รายการที่ลบไม่สำเร็จ",
    "resultBody": "นับเป็นไฟล์ที่ลบและพื้นที่ที่คืนได้เฉพาะรายการที่ Android ยืนยันแล้วว่าหายจริง",
    "reviewRemaining": "ดูรายการที่เหลือ",
    "errorTitle": "ระบบไฟล์ซ้ำทำงานต่อไม่ได้",
    "retry": "ลองอีกครั้ง",
    "scanFailed": "ไม่สามารถเริ่มการตรวจไฟล์ซ้ำได้",
    "scanRunning": "มีการตรวจเครื่องทำงานอยู่แล้ว Bearagnostic จะใช้ review snapshot เมื่อการตรวจนั้นเสร็จ",
    "homeFound": "{groups} กลุ่ม · {extras} ซ้ำ",
    "toolsFound": "{groups} กลุ่มที่ยืนยันแล้ว · ลบได้ {extras} สำเนา",
    "homeClear": "ไม่มีไฟล์ซ้ำแบบ exact",
    "toolsClear": "ไม่มีกลุ่มไฟล์ซ้ำแบบ exact",
    "homeNeeds": "ใช้ Smart Scan",
    "toolsNeeds": "ใช้ Smart Checkup เพื่อตรวจไฟล์ซ้ำ",
    "kindImage": "รูปภาพ",
    "kindVideo": "วิดีโอ",
    "kindAudio": "เสียง",
    "kindDocument": "เอกสาร",
    ...
    "moreGroups": "ยังมีกลุ่มที่ยืนยันแล้วให้ดูต่อด้านล่าง",
    "partial": "รายละเอียด review แตะขีดจำกัดเพื่อความปลอดภัย จะแสดงเฉพาะกลุ่มที่อยู่ใน snapshot ที่ยืนยันแล้วนี้"
  },
  "ja": {
    "kicker": "完全一致の重複",
    "title": "1つ残して、余分なコピーだけ整理",
    "lead": "Bearagnostic が同一と検証したコピーだけをグループ化します。削除前に残すファイルを自分で選べます。",
    "noAccessTitle": "ストレージへのアクセスが必要です",
    "noAccessBody": "重複を検証するには Android の共有ストレージアクセスが必要です。",
    "openSettings": "Android 設定を開く",
    "noSnapshotTitle": "Smart Checkup で重複を検証",
    "noSnapshotBody": "現在の重複検証スナップショットがありません。Smart Checkup は重要な共有フォルダで完全一致を確認し、この時点では削除しません。",
    "runSmart": "Smart Checkup を実行",
    "quickTitle": "この Quick Scan は重複を検証していません",
    "quickBody": "Quick Scan は速度を優先して重複ハッシュを行いません。完全一致の確認には Smart Checkup を使ってください。",
    "customTitle": "重複検証を更新",
    "customBody": "この Custom Scan では検証済み重複グループが確認できません。Smart Checkup で推奨共有フォルダを検証してください。",
    "scanningTitle": "完全一致の証拠を検証中",
    "scanningBody": "実際のスキャン処理に連動します。見せかけの待ち時間は追加しません。",
    "source": "ソース",
    "scope": "範囲",
    "evidence": "証拠",
    "sourceLive": "実行中のチェック",
    "focused": "重要な共有フォルダ",
    "full": "アクセス可能な共有ストレージ全体",
    "selectedScope": "選択した Custom Scan 場所",
    "exact": "完全一致を検証",
    "phasePreparing": "ファイルを探索中",
    "phaseDetails": "ファイル情報を確認中",
    "phaseSizes": "同サイズを照合中",
    "phaseDuplicates": "同一内容を検証中",
    "phaseDates": "更新日を確認中",
    "phaseFinalizing": "検証済みグループを作成中",
    "filesReviewed": "確認済みファイル",
    "hashedFiles": "検証済みファイル",
    "hashedBytes": "検証で読み取った量",
    "waiting": "次の項目を準備中…",
    ...
    "current": "たった今",
    "minAgo": "分前",
    "trustTitle": "なぜ重複と判断できるのか",
    "trustBody": "まずファイルサイズを一致させ、その後端末内で内容をバイト単位で照合します。見た目が似ているだけでは重複扱いしません。",
    "focusedTitle": "重点範囲の重複検証",
    "focusedBody": "Smart Checkup は重要な共有フォルダで完全一致の重複を確認します。Pro の Deep Scan ではアクセス可能な共有ストレージ全体を確認できます。",
    "fullTitle": "全範囲の重複検証",
    "fullBody": "Deep Scan の結果で、アクセス可能な共有ストレージ全体から完全一致の重複を確認しています。",
    "customCoverageTitle": "Custom の重複検証",
    "customCoverageBody": "選択した Custom Scan 場所で検証された重複です。",
    "verifyAll": "アクセス可能範囲をすべて検証",
    "pro": "PRO",
    "noDupTitle": "検証できた完全一致の重複グループはありません",
    "noDupBody": "この検証範囲ではバイト単位で同一の重複グループは確認されませんでした。似ているだけのファイルは重複扱いしません。",
    "checkAgain": "再チェック",
    "done": "完了",
    "close": "閉じる",
    "selectionPrompt": "削除する余分なコピーを選択",
    "selectionPicked": "{count} 件選択",
    "loadingGroups": "重複グループを準備中",
    "loadingBody": "現在のレビュースナップショットから検証済みコピーをまとめています。",
    "loaded": "読込済み",
    "group": "グループ",
    "copies": "同一コピー",
    "canReclaim": "解放可能",
    ...
    "loadMore": "さらにグループを表示",
    "showing": "{total} 組中 {shown} 組を表示",
    "staleTitle": "削除前に再検証",
    "staleBody": "このレビュースナップショットは15分以上前です。完全削除の前に重複を再検証してください。",
    "reviewSelected": "選択内容を確認",
    "selectedSummary": "{count} コピー · {bytes}",
    "limit": "検証済み1バッチで削除できるのは最大500ファイルです。",
    "confirmKicker": "最終確認",
    "confirmTitle": "選択した重複コピーを削除しますか？",
    "confirmBody": "選択したコピーだけを完全に削除します。各グループで「残す」と表示されたコピーは選択されません。",
    "groupsAffected": "対象グループ",
    "protection": "Native 削除層でも最低1コピーを残す保護が有効です。",
    "cancel": "キャンセル",
    "deleteVerify": "削除して検証",
    "deleting": "削除して確認中…",
    "resultKicker": "検証済み重複整理",
    "resultTitle": "重複整理が完了しました",
    "reclaimedLabel": "実際に解放した容量",
    "removedLabel": "削除したコピー",
    "resolvedLabel": "解決したグループ",
    "nativeProtected": "Native 保護",
    "failed": "削除できず",
    "resultBody": "Android が実際に削除を確認したファイルだけを削除数と解放容量に含めます。",
    "reviewRemaining": "残りを確認",
    "errorTitle": "重複整理を続行できません",
    "retry": "もう一度試す",
    "scanFailed": "重複チェックを開始できませんでした。",
    "scanRunning": "別のチェックが実行中です。完了後のレビュースナップショットを使用します。",
    "homeFound": "{groups}組 · 余分{extras}",
    "toolsFound": "検証済み{groups}組 · 削除可能{extras}",
    "homeClear": "完全一致なし",
    "toolsClear": "完全一致の重複なし",
    "homeNeeds": "Smart で確認",
    "toolsNeeds": "Smart Checkup で重複を検証",
    "kindImage": "写真",
    "kindVideo": "動画",
    "kindAudio": "音声",
    "kindDocument": "書類",
    ...
    "kindOther": "ファイル",
    "dateUnknown": "日付情報なし",
    "moreGroups": "下に追加の検証済みグループがあります。",
    "partial": "安全上のレビュー詳細上限に達しました。この検証済みスナップショット内のグループだけを表示します。"
  },
  "es": {
    "kicker": "DUPLICADOS EXACTOS",
    "title": "Conserva una copia. Elimina las extras.",
    "lead": "Bearagnostic agrupa solo copias verificadas como idénticas. Tú eliges qué se conserva antes de eliminar nada.",
    "noAccessTitle": "Se necesita acceso al almacenamiento",
    "noAccessBody": "Android debe permitir el acceso al almacenamiento compartido antes de que Bearagnostic pueda verificar archivos duplicados.",
    "openSettings": "Abrir ajustes de Android",
    "noSnapshotTitle": "Verificar duplicados con Smart Checkup",
    "noSnapshotBody": "Todavía no hay una instantánea actual de verificación de duplicados. Smart Checkup verifica coincidencias exactas en carpetas compartidas prioritarias sin eliminar nada.",
    "runSmart": "Ejecutar Smart Checkup",
    "quickTitle": "Este Quick Scan no verificó duplicados",
    "quickBody": "Quick Scan evita intencionalmente calcular hashes de duplicados. Ejecuta Smart Checkup para verificar duplicados exactos.",
    "customTitle": "Actualizar verificación de duplicados",
    "customBody": "Este Custom Scan no detectó ningún grupo de duplicados verificado. Ejecuta Smart Checkup para verificar coincidencias exactas en las carpetas compartidas recomendadas.",
    "scanningTitle": "Verificando evidencia de duplicados exactos",
    "scanningBody": "Esto sigue el trabajo real del escáner. No se añade tiempo de espera solo por apariencia.",
    "source": "FUENTE",
    "scope": "COBERTURA",
    "evidence": "EVIDENCIA",
    "sourceLive": "Revisión en vivo",
    "focused": "Carpetas compartidas prioritarias",
    "full": "Todo el almacenamiento compartido accesible",
    "selectedScope": "Ubicaciones seleccionadas de Custom Scan",
    "exact": "Verificación de coincidencia exacta",
    "phasePreparing": "Descubriendo archivos",
    "phaseDetails": "Leyendo detalles de archivos",
    "phaseSizes": "Comparando tamaños de archivo",
    "phaseDuplicates": "Verificando contenido idéntico",
    "phaseDates": "Revisando fechas de modificación",
    "phaseFinalizing": "Preparando grupos verificados",
    "filesReviewed": "Archivos revisados",
    "hashedFiles": "Archivos verificados",
    "hashedBytes": "Datos de verificación leídos",
    "waiting": "Preparando el siguiente elemento…",
    "localLive": "LOCAL · EN VIVO",
    "groups": "Grupos de duplicados",
    "extras": "Copias eliminables",
    "reclaimable": "Recuperable",
    "checked": "Comprobado",
    "current": "ahora mismo",
    "minAgo": "min atrás",
    "trustTitle": "Por qué son duplicados",
    "trustBody": "Bearagnostic primero compara el tamaño exacto y luego verifica el contenido byte por byte en este dispositivo. Que los archivos se parezcan no es suficiente.",
    "focusedTitle": "Cobertura enfocada de duplicados",
    "focusedBody": "Smart Checkup busca duplicados exactos en carpetas compartidas prioritarias. Pro puede ejecutar Deep Scan en todo el almacenamiento compartido accesible.",
    "fullTitle": "Cobertura completa de duplicados",
    "fullBody": "Este resultado proviene de Deep Scan, que busca duplicados exactos en todo el ámbito de almacenamiento compartido accesible.",
    "customCoverageTitle": "Cobertura personalizada de duplicados",
    "customCoverageBody": "Este resultado contiene duplicados verificados de las ubicaciones seleccionadas en Custom Scan.",
    "verifyAll": "Verificar todo el almacenamiento accesible",
    "pro": "PRO",
    "noDupTitle": "No se verificó ningún grupo de duplicados exactos",
    "noDupBody": "No se verificó ningún grupo duplicado byte por byte dentro de la cobertura de este análisis. Los archivos similares no se tratan como duplicados intencionalmente.",
    "checkAgain": "Revisar de nuevo",
    "done": "Listo",
    "close": "Cerrar",
    "selectionPrompt": "Elige las copias extra que quieras eliminar",
    "selectionPicked": "{count} copias seleccionadas",
    "loadingGroups": "Preparando grupos de duplicados",
    "loadingBody": "Agrupando copias verificadas de la instantánea de revisión actual.",
    "loaded": "cargados",
    "group": "Grupo",
    "copies": "copias idénticas",
    "canReclaim": "se pueden recuperar",
    "exactBadge": "COINCIDENCIA EXACTA",
    "keep": "CONSERVAR",
    "keepThis": "Conservar esta",
    "remove": "Eliminar",
    "removeExtras": "Seleccionar extras",
    "clearGroup": "Limpiar grupo",
    "selected": "seleccionados",
    "clearAll": "Limpiar",
    "bulkSelect": "Seleccionar recomendados",
    "bulkPro": "Seleccionar recomendados · PRO",
    "bulkFreeHint": "Pro puede seleccionar de una vez las copias extra recomendadas de todos los grupos. Los usuarios Free aún pueden revisar y seleccionar cada grupo manualmente.",
    "loadMore": "Cargar más grupos",
    "showing": "Mostrando {shown} de {total} grupos",
    "staleTitle": "Actualiza antes de eliminar",
    "staleBody": "Esta instantánea de revisión tiene más de 15 minutos. Vuelve a verificar los duplicados antes de eliminar permanentemente.",
    "reviewSelected": "Revisar seleccionados",
    "selectedSummary": "{count} copias · {bytes}",
    "limit": "Se pueden eliminar hasta 500 archivos seleccionados en un lote verificado.",
    "confirmKicker": "REVISIÓN FINAL",
    "confirmTitle": "¿Eliminar las copias duplicadas seleccionadas?",
    "confirmBody": "Solo se eliminarán permanentemente las copias seleccionadas. La copia marcada como Conservar en cada grupo permanece sin seleccionar.",
    "groupsAffected": "grupos afectados",
    "protection": "La protección de conservar una copia también permanece activa en la capa nativa de eliminación.",
    "cancel": "Cancelar",
    "deleteVerify": "Eliminar y verificar",
    "deleting": "Eliminando y verificando…",
    "resultKicker": "LIMPIEZA DE DUPLICADOS VERIFICADA",
    "resultTitle": "Limpieza de duplicados completada",
    "reclaimedLabel": "espacio recuperado verificado",
    "removedLabel": "copias eliminadas",
    "resolvedLabel": "grupos resueltos",
    "nativeProtected": "protecciones nativas",
    ...
    "errorTitle": "La revisión de duplicados no pudo continuar",
    "retry": "Intentar de nuevo",
    "scanFailed": "No se pudo iniciar la comprobación de duplicados.",
    "scanRunning": "Ya hay otra revisión en curso. Bearagnostic usará su instantánea de revisión cuando termine.",
    "homeFound": "{groups} grupos · {extras} extras",
    "toolsFound": "{groups} grupos verificados · {extras} copias eliminables",
    "homeClear": "Sin repeticiones exactas",
    "toolsClear": "Sin grupos de duplicados exactos",
    "homeNeeds": "Ejecutar Smart Check",
    "toolsNeeds": "Ejecuta Smart Checkup para verificar duplicados",
    "kindImage": "Foto",
    "kindVideo": "Vídeo",
    "kindAudio": "Audio",
    ...
    "moreGroups": "Hay más grupos verificados disponibles abajo.",
    "partial": "Los detalles de revisión alcanzaron el límite seguro de visualización. Solo se muestran los grupos presentes en esta instantánea verificada."
  },
  "pt-BR": {
    "kicker": "DUPLICADOS EXATOS",
    "title": "Mantenha uma cópia. Remova as extras.",
    "lead": "O Bearagnostic agrupa apenas cópias verificadas como idênticas. Você escolhe o que fica antes de qualquer remoção.",
    "noAccessTitle": "É necessário acesso ao armazenamento",
    "noAccessBody": "O Android precisa permitir acesso ao armazenamento compartilhado antes que o Bearagnostic possa verificar arquivos duplicados.",
    "openSettings": "Abrir configurações do Android",
    "noSnapshotTitle": "Verificar duplicados com Smart Checkup",
    "noSnapshotBody": "Ainda não há um snapshot atual de verificação de duplicados. O Smart Checkup verifica correspondências exatas em pastas compartilhadas prioritárias sem excluir nada.",
    "runSmart": "Executar Smart Checkup",
    "quickTitle": "Este Quick Scan não verificou duplicados",
    "quickBody": "O Quick Scan evita intencionalmente calcular hashes de duplicados. Execute o Smart Checkup para verificar duplicados exatos.",
    "customTitle": "Atualizar verificação de duplicados",
    "customBody": "Este Custom Scan não encontrou nenhum grupo de duplicados verificado. Execute o Smart Checkup para verificar correspondências exatas nas pastas compartilhadas recomendadas.",
    "scanningTitle": "Verificando evidências de duplicados exatos",
    "scanningBody": "Isto acompanha o trabalho real do scanner. Nenhum tempo de espera é adicionado apenas por aparência.",
    "source": "FONTE",
    "scope": "COBERTURA",
    "evidence": "EVIDÊNCIA",
    "sourceLive": "Verificação ao vivo",
    "focused": "Pastas compartilhadas prioritárias",
    "full": "Todo o armazenamento compartilhado acessível",
    "selectedScope": "Locais selecionados do Custom Scan",
    "exact": "Verificação de correspondência exata",
    "phasePreparing": "Descobrindo arquivos",
    "phaseDetails": "Lendo detalhes dos arquivos",
    "phaseSizes": "Comparando tamanhos dos arquivos",
    "phaseDuplicates": "Verificando conteúdo idêntico",
    "phaseDates": "Verificando datas de modificação",
    "phaseFinalizing": "Preparando grupos verificados",
    "filesReviewed": "Arquivos revisados",
    "hashedFiles": "Arquivos verificados",
    "hashedBytes": "Dados de verificação lidos",
    "waiting": "Preparando o próximo item…",
    "localLive": "LOCAL · AO VIVO",
    "groups": "Grupos de duplicados",
    "extras": "Cópias removíveis",
    "reclaimable": "Recuperável",
    "checked": "Verificado",
    "current": "agora mesmo",
    "minAgo": "min atrás",
    "trustTitle": "Por que estes são duplicados",
    "trustBody": "O Bearagnostic primeiro compara o tamanho exato e depois verifica o conteúdo byte a byte neste dispositivo. Arquivos apenas parecidos não são suficientes.",
    "focusedTitle": "Cobertura focada de duplicados",
    "focusedBody": "O Smart Checkup procura duplicados exatos em pastas compartilhadas prioritárias. O Pro pode executar Deep Scan em todo o armazenamento compartilhado acessível.",
    "fullTitle": "Cobertura completa de duplicados",
    "fullBody": "Este resultado veio do Deep Scan, que procura duplicados exatos em todo o escopo de armazenamento compartilhado acessível.",
    "customCoverageTitle": "Cobertura personalizada de duplicados",
    "customCoverageBody": "Este resultado contém duplicados verificados dos locais selecionados no Custom Scan.",
    "verifyAll": "Verificar todo o armazenamento acessível",
    "pro": "PRO",
    "noDupTitle": "Nenhum grupo de duplicados exatos foi verificado",
    "noDupBody": "Nenhum grupo duplicado byte a byte foi verificado na cobertura deste scan. Arquivos semelhantes não são tratados como duplicados de propósito.",
    "checkAgain": "Verificar novamente",
    "done": "Concluído",
    "close": "Fechar",
    "selectionPrompt": "Escolha as cópias extras que deseja remover",
    "selectionPicked": "{count} cópias selecionadas",
    "loadingGroups": "Preparando grupos de duplicados",
    "loadingBody": "Agrupando cópias verificadas do snapshot de revisão atual.",
    "loaded": "carregados",
    "group": "Grupo",
    "copies": "cópias idênticas",
    "canReclaim": "podem ser recuperados",
    "exactBadge": "CORRESPONDÊNCIA EXATA",
    "keep": "MANTER",
    "keepThis": "Manter esta",
    "remove": "Remover",
    "removeExtras": "Selecionar extras",
    "clearGroup": "Limpar grupo",
    "selected": "selecionados",
    "clearAll": "Limpar",
    "bulkSelect": "Selecionar recomendados",
    "bulkPro": "Selecionar recomendados · PRO",
    "bulkFreeHint": "O Pro pode selecionar de uma vez as cópias extras recomendadas de todos os grupos. Usuários Free ainda podem revisar e selecionar cada grupo manualmente.",
    "loadMore": "Carregar mais grupos",
    "showing": "Mostrando {shown} de {total} grupos",
    "staleTitle": "Atualize antes de excluir",
    "staleBody": "Este snapshot de revisão tem mais de 15 minutos. Verifique novamente os duplicados antes da exclusão permanente.",
    "reviewSelected": "Revisar selecionados",
    "selectedSummary": "{count} cópias · {bytes}",
    "limit": "Até 500 arquivos selecionados podem ser excluídos em um lote verificado.",
    "confirmKicker": "REVISÃO FINAL",
    "confirmTitle": "Remover as cópias duplicadas selecionadas?",
    "confirmBody": "Somente as cópias selecionadas serão excluídas permanentemente. A cópia marcada como Manter em cada grupo permanece desmarcada.",
    "groupsAffected": "grupos afetados",
    "protection": "A proteção de manter uma cópia também permanece ativa na camada nativa de exclusão.",
    "cancel": "Cancelar",
    "deleteVerify": "Excluir e verificar",
    "deleting": "Excluindo e verificando…",
    "resultKicker": "LIMPEZA DE DUPLICADOS VERIFICADA",
    "resultTitle": "Limpeza de duplicados concluída",
    "reclaimedLabel": "espaço recuperado verificado",
    "removedLabel": "cópias removidas",
    "resolvedLabel": "grupos resolvidos",
    "nativeProtected": "proteções nativas",
    ...
    "reviewRemaining": "Revisar restantes",
    "errorTitle": "A revisão de duplicados não pôde continuar",
    "retry": "Tentar novamente",
    "scanFailed": "Não foi possível iniciar a verificação de duplicados.",
    "scanRunning": "Outra verificação já está em andamento. O Bearagnostic usará o snapshot de revisão quando ela terminar.",
    "homeFound": "{groups} grupos · {extras} extras",
    "toolsFound": "{groups} grupos verificados · {extras} cópias removíveis",
    "homeClear": "Sem repetições exatas",
    "toolsClear": "Sem grupos de duplicados exatos",
    "homeNeeds": "Executar Smart Check",
    "toolsNeeds": "Execute o Smart Checkup para verificar duplicados",
    "kindImage": "Foto",
    "kindVideo": "Vídeo",
    "kindAudio": "Áudio",
    "kindDocument": "Documento",
    ...
    "moreGroups": "Há mais grupos verificados disponíveis abaixo.",
    "partial": "Os detalhes da revisão atingiram o limite seguro de exibição. Apenas os grupos presentes neste snapshot verificado são mostrados."
  }
};
  ...
  function formatCount(value) {
    try { return new Intl.NumberFormat(lang()==='th'?'th-TH':lang()==='ja'?'ja-JP':lang()==='es'?'es-ES':lang()==='pt-BR'?'pt-BR':'en-US').format(Math.round(n(value))); }
  ...
  function formatDate(ms) {
    ...
    try { return new Intl.DateTimeFormat(lang()==='th'?'th-TH':lang()==='ja'?'ja-JP':lang()==='es'?'es-ES':lang()==='pt-BR'?'pt-BR':'en-US',{year:'numeric',month:'short',day:'numeric'}).format(new Date(value)); }
  ...
  function ageText(ms) {
    ...
    const hours=Math.floor(minutes/60); if(hours<24) return lang()==='th'?`${hours} ชม.ที่แล้ว`:lang()==='ja'?`${hours}時間前`:lang()==='es'?`hace ${hours} h`:lang()==='pt-BR'?`há ${hours} h`:`${hours}h ago`;
    const days=Math.floor(hours/24); return lang()==='th'?`${days} วันที่แล้ว`:lang()==='ja'?`${days}日前`:lang()==='es'?`hace ${days} días`:lang()==='pt-BR'?`há ${days} dias`:`${days}d ago`;
  }
  ...
  function visibleDuplicateItems(items=state.rawItems){ return HIDDEN?.filter?.(items) || items; }
  function duplicateHiddenStats(){ return HIDDEN?.hiddenStats?.(state.rawItems) || {count:0,bytes:0}; }
  ...
  function hiddenControlHtml(){const stats=duplicateHiddenStats();if(!stats.count)return '';const labels=hiddenLabels();const on=Boolean(HIDDEN?.isEnabled?.());return `<section class="ba-dup-hidden"><div><strong>${esc(labels.title)}</strong><small>${esc(formatCount(stats.count))} · ${esc(formatBytes(stats.bytes))} · ${esc(labels.body)}</small></div><button class="ba-dup-hidden-toggle" id="baDupHiddenToggle" type="button" aria-pressed="${on?'true':'false'}">${esc(on?labels.on:labels.off)}</button></section>`;}
  ...
  function ensureStyle(){
    ...
    style.textContent=`
      ...
      .ba-dup-trust{display:grid;grid-template-columns:38px minmax(0,1fr) auto;gap:10px;align-items:center;margin-top:10px;padding:12px 13px;border-radius:20px;background:linear-gradient(135deg,#f3efff,#f4faff);border:1px solid rgba(103,91,190,.08)}.ba-dup-trust.has-action{grid-template-columns:38px minmax(0,1fr);align-items:start}.ba-dup-trust.has-action .ba-dup-pro-scan{grid-column:2;justify-self:start;margin-top:3px;white-space:normal;text-align:left;line-height:1.28;padding:8px 11px}.ba-dup-trust i{width:38px;height:38px;border-radius:13px;display:grid;place-items:center;background:#e9e5fb;color:#6a60c8}.ba-dup-trust i svg{width:20px;height:20px;fill:none;stroke:currentColor;stroke-width:1.7}.ba-dup-trust strong{display:block;font-size:12.5px;line-height:1.3;color:#30395e}.ba-dup-trust small{display:block;margin-top:4px;font-size:11px;line-height:1.45;color:#66738e}.ba-dup-pro-scan{min-height:36px;padding:0 10px;border-radius:12px;background:linear-gradient(145deg,#ede9ff,#edf6ff);border:1px solid rgba(101,91,190,.09);color:#6159ad;font-size:10px;font-weight:790;white-space:nowrap}.ba-dup-pro-scan b{font-size:9.5px;margin-left:3px;color:#8b6bc0}
      .ba-dup-hidden{display:grid;grid-template-columns:minmax(0,1fr) auto;gap:10px;align-items:center;margin-top:10px;padding:11px 12px;border-radius:18px;background:linear-gradient(135deg,#f7f5ff,#f5fbff);border:1px solid rgba(113,90,202,.10)}.ba-dup-hidden strong{display:block;font-size:12px;line-height:1.3;color:#3f3e60}.ba-dup-hidden small{display:block;margin-top:3px;font-size:10px;line-height:1.42;color:#7b7f98}.ba-dup-hidden-toggle{min-width:54px;height:34px;padding:0 11px;border-radius:999px;background:#eef0f6;color:#6d7189;border:1px solid rgba(102,96,151,.09);font-size:10px;font-weight:820}.ba-dup-hidden-toggle[aria-pressed="true"]{background:linear-gradient(135deg,#ddd7ff,#dff2ff);color:#654fb8;border-color:rgba(105,85,201,.15)}.ba-dup-hidden-badge{display:inline-flex;margin-left:5px;padding:2px 5px;border-radius:999px;background:#eeeafd;color:#725db9;font-size:8px;font-weight:840;letter-spacing:.04em;vertical-align:1px}
  ...
  function updateLive(){
    ...
    byId('baDupLiveReviewed').textContent=formatCount(p.reviewedFiles); const verificationStarted=['duplicates','modified_dates','finalizing'].includes(String(p.phase||'')); byId('baDupLiveHashed').textContent=verificationStarted?formatCount(p.hashedFiles):'—'; byId('baDupLiveHashBytes').textContent=verificationStarted?formatBytes(p.hashedBytes):'—'; if(byId('baDupLiveScope')) byId('baDupLiveScope').textContent=mode==='deep'?t('full'):mode==='custom'?t('selectedScope'):t('focused');
  }
  ...
  function buildGroups(items){
    const map=new Map();
    visibleDuplicateItems(items).forEach((item)=>{ const gid=String(item?.duplicateGroupId||'').trim(); if(!gid) return; if(!map.has(gid)) map.set(gid,[]); map.get(gid).push(item); });
    const groups=[];
  ...
  function renderEmpty(){
    ...
    byId('baDupBody').innerHTML=`<section class="ba-dup-state"><div class="ba-dup-state-icon">${svg('check')}</div><h3>${esc(t('noDupTitle'))}</h3><p>${esc(t('noDupBody'))}</p><div class="ba-dup-evidence"><div><span>${esc(t('groups'))}</span><strong>0</strong></div><div><span>${esc(t('checked'))}</span><strong>${esc(ageText(state.summary?.generatedAtMs))}</strong></div><div><span>${esc(t('scope'))}</span><strong>${esc(coverageLabel())}</strong></div></div><section class="ba-dup-trust${trust.button?' has-action':''}"><i>${svg('shield')}</i><div><strong>${esc(trust.title)}</strong><small>${esc(trust.body)}</small></div>${trust.button?`<button class="ba-dup-pro-scan" id="baDupVerifyAll" type="button">${esc(t('verifyAll'))}${ENT?.isPro?.()?'':` <b>${esc(t('pro'))}</b>`}</button>`:''}</section>${hiddenControlHtml()}<div class="ba-dup-state-actions"><button class="ba-dup-secondary" id="baDupEmptyAgain" type="button">${esc(t('checkAgain'))}</button><button class="ba-dup-primary" id="baDupEmptyDone" type="button">${esc(t('done'))}</button></div></section>`;
    byId('baDupEmptyAgain').addEventListener('click',()=>startScan(scanMode()==='deep'&&ENT?.can?.('deep_scan')?'deep':'smart')); byId('baDupEmptyDone').addEventListener('click',closeSurface); byId('baDupVerifyAll')?.addEventListener('click',verifyAllAccessible); byId('baDupHiddenToggle')?.addEventListener('click',()=>HIDDEN?.toggle?.());
  }
  ...
  function renderGroups(detailsTruncated=false){
    ...
    byId('baDupBody').innerHTML=`<section class="ba-dup-overview"><div class="ba-dup-metric"><b>${esc(formatCount(state.groups.length))}</b><span>${esc(t('groups'))}</span></div><div class="ba-dup-metric"><b>${esc(formatCount(totalExtras()))}</b><span>${esc(t('extras'))}</span></div><div class="ba-dup-metric"><b>${esc(formatBytes(totalReclaimable()))}</b><span>${esc(t('reclaimable'))}</span></div></section><section class="ba-dup-trust${trust.button?' has-action':''}"><i>${svg('shield')}</i><div><strong>${esc(trust.title)}</strong><small>${esc(trust.body)}</small></div>${trust.button?`<button class="ba-dup-pro-scan" id="baDupVerifyAll" type="button">${esc(t('verifyAll'))}${ENT?.isPro?.()?'':` <b>${esc(t('pro'))}</b>`}</button>`:''}</section><section class="ba-dup-trust"><i>${svg('duplicate')}</i><div><strong>${esc(t('trustTitle'))}</strong><small>${esc(t('trustBody'))}</small></div></section>${hiddenControlHtml()}${stale?`<div class="ba-dup-alert"><strong>${esc(t('staleTitle'))}</strong><br>${esc(t('staleBody'))}</div>`:''}${detailsTruncated?`<div class="ba-dup-alert info">${esc(t('partial'))}</div>`:''}<div class="ba-dup-toolbar"><div class="ba-dup-toolbar-copy"><strong id="baDupToolbarSelected">${esc(selectedCount?t('selectionPicked',{count:formatCount(selectedCount)}):t('selectionPrompt'))}</strong><small>${esc(t('showing',{shown:formatCount(shown),total:formatCount(state.groups.length)}))}</small></div><button class="ba-dup-chip" id="baDupClearAll" type="button">${esc(t('clearAll'))}</button><button class="ba-dup-chip bulk" id="baDupBulk" type="button">${esc(t(isPro?'bulkSelect':'bulkPro'))}</button></div>${!isPro?`<div class="ba-dup-pro-note">${esc(t('bulkFreeHint'))}</div>`:''}<div class="ba-dup-groups">${groupsHtml}</div>${shown<state.groups.length?`<button class="ba-dup-more" id="baDupMore" type="button">${esc(t('loadMore'))}</button>`:''}<div class="ba-dup-alert info">${esc(t('limit'))}</div><footer class="ba-dup-footer"><div class="ba-dup-footer-copy"><strong id="baDupFooterSelected">${esc(t('selectedSummary',{count:formatCount(selectedCount),bytes:formatBytes(bytes)}))}</strong><small>${esc(ageText(state.summary?.generatedAtMs))}</small></div><div class="ba-dup-footer-actions"><button class="ba-dup-secondary" id="baDupRefresh" type="button">${esc(stale?t('staleTitle'):t('checkAgain'))}</button><button class="ba-dup-primary" id="baDupReview" type="button"${selectedCount===0||stale?' disabled':''}>${esc(t('reviewSelected'))}</button></div></footer>`;
    bindGroupUi(); schedulePreviews();
  }
  function bindGroupUi(){
    byId('baDupVerifyAll')?.addEventListener('click',verifyAllAccessible); byId('baDupHiddenToggle')?.addEventListener('click',()=>HIDDEN?.toggle?.()); byId('baDupClearAll')?.addEventListener('click',()=>{state.selected.clear();updateSelectionUi();});
  ...
  function updateSelectionUi(){
    ...
    if(byId('baDupToolbarSelected'))byId('baDupToolbarSelected').textContent=count?t('selectionPicked',{count:formatCount(count)}):t('selectionPrompt');
  ...
  function restoreHomeStatusIfNeeded(){const summary=reviewSummary();if(summary?.available)return;document.querySelectorAll('[data-tool="duplicates"] small[data-duplicate-status="1"]').forEach((node)=>{node.removeAttribute('data-duplicate-status');node.textContent=lang()==='th'?'ค้นหาไฟล์ซ้ำ':lang()==='ja'?'重複を探す':lang()==='es'?'Buscar repetidos':lang()==='pt-BR'?'Encontrar repetições':'Find repeats';});}
  ...
  function requestPreview(cell){
    ...
    const token=`b32d${++state.mediaSeq}`;state.mediaPending.set(token,cell);let result={};
  ...
  function wrapMediaCallback(){const base=window.BearagnosticReviewMedia;if(!base||base.__duplicates32Wrapped)return false;window.BearagnosticReviewMedia=Object.freeze({...base,__duplicates32Wrapped:true,onMediaReady(token,raw){base.onMediaReady?.(token,raw);onDuplicateMedia(token,raw);}});return true;}
  ...
  window.addEventListener('bearagnostic:hiddenitemschange',()=>{state.groups=buildGroups(state.rawItems);state.keepByGroup=new Map(state.groups.map((g)=>[g.id,g.defaultKeepId]));state.selected.clear();state.visibleGroups=RENDER_BATCH;state.cachedActiveCandidateCount=state.groups.reduce((sum,g)=>sum+g.members.length,0);updateHomeStatus();if(state.open)renderGroups(Boolean(state.summary?.detailsTruncated));});
