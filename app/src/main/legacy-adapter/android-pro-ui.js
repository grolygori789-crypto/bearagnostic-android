(() => {
  ...
  const COPY = {
  "en": {
    "rowTitle": "Bearagnostic Pro",
    "rowFree": "Free plan · Explore the Pro toolkit",
    "rowPro": "Lifetime access · Active",
    "eyebrow": "BEARAGNOSTIC PRO",
    "title": "Go deeper. See more. Stay in control.",
    ...
    "deep": "Deep Scan",
    "deepSub": "Full streaming reads of readable files plus exact duplicate verification across the accessible scope.",
    "custom": "Custom Scan",
    "customSub": "Choose Downloads, Photos, Videos, Documents or Music and decide whether to verify exact duplicates.",
    "planned": "Planned Pro toolkit",
    "plannedSub": "These are roadmap capabilities, not claimed as finished in this build.",
    "planned1": "Advanced exact duplicate workflow",
    "planned2": "Advanced media review & filters",
    "planned3": "Historical Insights & What Changed",
    "planned4": "Full cleanup history",
    "planned5": "Custom exclusions",
    "planned6": "Scheduled checkup reminders",
    "safetyTitle": "Safety stays free",
    "safetyBody": "Risk explanations, Protected logic, confirmation, keep-one-copy safeguards and truthful scan coverage remain available to everyone.",
    "modelTitle": "Simple ownership",
    "modelBody": "One-time lifetime upgrade · No subscription · No ads · No Bearagnostic account required.",
    ...
    "activeSub": "This build currently has access to Pro capabilities.",
    "close": "Close",
    ...
    "debugReset": "Reset",
    "planTitle": "Plan",
    "planSub": "Access level for this installation",
    "planFree": "Free",
    "planPro": "Pro · Lifetime",
    "planExplore": "Explore Pro",
    "planView": "View Pro",
    "proTag": "PRO",
    "proUnlocked": "PRO ✓"
  },
  "th": {
    "rowTitle": "Bearagnostic Pro",
    "rowFree": "แผน Free · ดูเครื่องมือ Pro",
    "rowPro": "สิทธิ์ตลอดชีพ · เปิดใช้งานแล้ว",
    "eyebrow": "BEARAGNOSTIC PRO",
    "title": "ตรวจได้ลึกขึ้น เห็นมากขึ้น และยังควบคุมทุกอย่างเอง",
    ...
    "freeBadge": "แผน FREE",
    "proBadge": "PRO เปิดใช้งานแล้ว",
    "available": "ความสามารถที่มีอยู่ในแอปตอนนี้",
    "deep": "Deep Scan",
    "deepSub": "อ่านเนื้อหาไฟล์ที่อ่านได้แบบ streaming จนครบ และยืนยันไฟล์ซ้ำแบบ exact ทั่วขอบเขตที่เข้าถึงได้",
    "custom": "Custom Scan",
    "customSub": "เลือก Downloads, Photos, Videos, Documents หรือ Music และกำหนดว่าจะยืนยันไฟล์ซ้ำแบบ exact หรือไม่",
    "planned": "เครื่องมือ Pro ในแผนพัฒนา",
    "plannedSub": "รายการด้านล่างเป็น roadmap และยังไม่อ้างว่าเสร็จแล้วใน build นี้",
    "planned1": "ระบบจัดการไฟล์ซ้ำแบบ exact ขั้นสูง",
    "planned2": "Media Review และตัวกรองขั้นสูง",
    "planned3": "Insights ย้อนหลังและ What Changed",
    "planned4": "ประวัติการทำความสะอาดแบบเต็ม",
    "planned5": "กำหนดตำแหน่งที่ไม่ต้องตรวจเอง",
    "planned6": "การเตือนให้ตรวจเครื่องตามกำหนด",
    "safetyTitle": "ความปลอดภัยใช้ฟรีเสมอ",
    "safetyBody": "คำอธิบายความเสี่ยง ระบบ Protected การยืนยันก่อนลบ การเก็บไฟล์ซ้ำไว้อย่างน้อยหนึ่งสำเนา และสถานะขอบเขตการสแกนที่ตรงจริง จะไม่ถูกล็อกหลัง Pro",
    "modelTitle": "ซื้อครั้งเดียว เข้าใจง่าย",
    "modelBody": "อัปเกรดตลอดชีพครั้งเดียว · ไม่มีรายเดือน · ไม่มีโฆษณา · ไม่ต้องมีบัญชี Bearagnostic",
    ...
    "activeSub": "Build นี้มีสิทธิ์ใช้ความสามารถ Pro แล้ว",
    "close": "ปิด",
    ...
    "debugReset": "รีเซ็ต",
    "planTitle": "แผนการใช้งาน",
    "planSub": "ระดับสิทธิ์ของการติดตั้งนี้",
    "planFree": "Free",
    "planPro": "Pro · ตลอดชีพ",
    "planExplore": "ดู Pro",
    "planView": "ดูสิทธิ์ Pro",
    "proTag": "PRO",
    "proUnlocked": "PRO ✓"
  },
  "ja": {
    "rowTitle": "Bearagnostic Pro",
    "rowFree": "Free プラン · Pro ツールを見る",
    "rowPro": "買い切りアクセス · 有効",
    "eyebrow": "BEARAGNOSTIC PRO",
    "title": "より深く確認し、もっと把握し、操作は自分の手に。",
    "lead": "Free でも実用性は保ちます。Pro は広告・独自アカウント・サブスクリプションなしで、より深い診断と高度なコントロールを追加します。",
    "freeBadge": "FREE プラン",
    "proBadge": "PRO 有効",
    "available": "現在のアプリで利用できる機能",
    "deep": "Deep Scan",
    "deepSub": "読み取り可能なファイルをストリーミングで最後まで読み、アクセス可能範囲で完全一致の重複を検証します。",
    "custom": "Custom Scan",
    "customSub": "Downloads、Photos、Videos、Documents、Music を選び、完全一致の重複検証を行うか指定できます。",
    "planned": "Pro の開発ロードマップ",
    "plannedSub": "以下は今後の予定で、このビルドで完成済みとは表示しません。",
    "planned1": "高度な完全一致重複ワークフロー",
    "planned2": "高度なメディアレビューとフィルター",
    "planned3": "履歴 Insights と What Changed",
    "planned4": "完全なクリーンアップ履歴",
    "planned5": "カスタム除外設定",
    "planned6": "定期チェック通知",
    "safetyTitle": "安全機能は常に無料",
    "safetyBody": "リスク説明、Protected 判定、削除確認、最低1コピーを残す保護、正確なスキャン範囲表示はすべてのユーザーに提供します。",
    "modelTitle": "シンプルな所有モデル",
    "modelBody": "一度の買い切り · サブスクなし · 広告なし · Bearagnostic アカウント不要",
    ...
    "activeSub": "このビルドでは Pro 機能を利用できます。",
    "close": "閉じる",
  ...
  "es": {
    "rowTitle": "Bearagnostic Pro",
    "rowFree": "Plan Gratis · Explora las herramientas Pro",
    "rowPro": "Acceso de por vida · Activo",
    "eyebrow": "BEARAGNOSTIC PRO",
    "title": "Ve más a fondo. Descubre más. Mantén el control.",
    "lead": "Free sigue siendo realmente útil. Pro añade diagnósticos más profundos y control avanzado sin anuncios, cuentas ni suscripción.",
    "freeBadge": "PLAN GRATIS",
    "proBadge": "PRO ACTIVO",
    "available": "Disponible en la app actual",
    "deep": "Deep Scan",
    "deepSub": "Lectura completa por streaming de archivos legibles y verificación de duplicados exactos en todo el ámbito accesible.",
    "custom": "Custom Scan",
    "customSub": "Elige Descargas, Fotos, Vídeos, Documentos o Música y decide si quieres verificar duplicados exactos.",
    "planned": "Herramientas Pro previstas",
    "plannedSub": "Estas funciones están en la hoja de ruta y no se presentan como terminadas en esta build.",
    "planned1": "Flujo avanzado de duplicados exactos",
    "planned2": "Revisión multimedia y filtros avanzados",
    "planned3": "Insights históricos y What Changed",
    "planned4": "Historial completo de limpiezas",
    "planned5": "Exclusiones personalizadas",
    "planned6": "Recordatorios programados de revisión",
    "safetyTitle": "La seguridad sigue siendo gratis",
    "safetyBody": "Las explicaciones de riesgo, la lógica de protección, la confirmación, las salvaguardas de conservar una copia y la cobertura real del análisis siguen disponibles para todos.",
    "modelTitle": "Propiedad sencilla",
    "modelBody": "Actualización única de por vida · Sin suscripción · Sin anuncios · No requiere cuenta de Bearagnostic.",
    "billingPending": "La configuración de compras de Google Play aún no está activa intencionalmente en esta build de desarrollo.",
    "billingPendingSub": "El siguiente lote de Billing proporcionará a esta capa de acceso el precio local de Play y el ciclo de compra, restauración y propiedad.",
    "activeTitle": "Bearagnostic Pro está activo",
    "activeSub": "Esta build tiene actualmente acceso a funciones Pro.",
    "close": "Cerrar",
    "debugTitle": "PRUEBA DE ACCESO DE DESARROLLO",
    "debugBody": "Solo para builds Debug. Este control nunca aparece en una build de lanzamiento.",
    "debugFree": "Probar como GRATIS",
    "debugPro": "Probar como PRO",
    "debugReset": "Restablecer",
    "planTitle": "Plan",
    "planSub": "Nivel de acceso para esta instalación",
    "planFree": "Gratis",
    "planPro": "Pro · De por vida",
    "planExplore": "Explorar Pro",
    "planView": "Ver Pro",
    "proTag": "PRO",
    "proUnlocked": "PRO ✓"
  },
  "pt-BR": {
    "rowTitle": "Bearagnostic Pro",
    "rowFree": "Plano Grátis · Explore as ferramentas Pro",
    "rowPro": "Acesso vitalício · Ativo",
    "eyebrow": "BEARAGNOSTIC PRO",
    "title": "Vá mais fundo. Veja mais. Mantenha o controle.",
    "lead": "O Free continua realmente útil. O Pro adiciona diagnósticos mais profundos e controle avançado sem anúncios, contas ou assinatura.",
    "freeBadge": "PLANO GRÁTIS",
    "proBadge": "PRO ATIVO",
    "available": "Disponível no app atual",
    "deep": "Deep Scan",
    "deepSub": "Leitura completa por streaming dos arquivos legíveis e verificação de duplicados exatos em todo o escopo acessível.",
    "custom": "Custom Scan",
    "customSub": "Escolha Downloads, Fotos, Vídeos, Documentos ou Música e decida se deseja verificar duplicados exatos.",
    "planned": "Ferramentas Pro planejadas",
    "plannedSub": "Estes recursos estão no roadmap e não são apresentados como concluídos nesta build.",
    "planned1": "Fluxo avançado de duplicados exatos",
    "planned2": "Revisão de mídia e filtros avançados",
    "planned3": "Insights históricos e What Changed",
    "planned4": "Histórico completo de limpezas",
    "planned5": "Exclusões personalizadas",
    "planned6": "Lembretes programados de verificação",
    "safetyTitle": "A segurança continua grátis",
    "safetyBody": "Explicações de risco, lógica de proteção, confirmação, salvaguardas de manter uma cópia e cobertura real do scan continuam disponíveis para todos.",
    "modelTitle": "Propriedade simples",
    "modelBody": "Upgrade único vitalício · Sem assinatura · Sem anúncios · Não exige conta do Bearagnostic.",
    "billingPending": "A configuração de compras do Google Play ainda não está ativa de propósito nesta build de desenvolvimento.",
    "billingPendingSub": "O próximo lote de Billing fornecerá a esta camada de acesso o preço local do Play e o ciclo de compra, restauração e propriedade.",
    "activeTitle": "Bearagnostic Pro está ativo",
    "activeSub": "Esta build tem acesso aos recursos Pro no momento.",
    "close": "Fechar",
    "debugTitle": "TESTE DE ACESSO DE DESENVOLVIMENTO",
    "debugBody": "Somente em builds Debug. Este controle nunca aparece em uma build de lançamento.",
    "debugFree": "Testar como GRÁTIS",
    "debugPro": "Testar como PRO",
    "debugReset": "Redefinir",
    "planTitle": "Plano",
    "planSub": "Nível de acesso desta instalação",
    "planFree": "Grátis",
    "planPro": "Pro · Vitalício",
    "planExplore": "Explorar Pro",
    "planView": "Ver Pro",
    "proTag": "PRO",
    "proUnlocked": "PRO ✓"
