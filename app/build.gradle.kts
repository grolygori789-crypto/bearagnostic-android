...
val prepareLegacyFrontend by tasks.registering {
    ...
    inputs.files(androidAdapter, androidReview, androidSupport, androidScanTrust, androidLiveScan, androidReviewMedia, androidPremiumColor, androidEntitlement, androidProUi)
    ...
    doLast {
        ...
        val androidTags = buildString {
            ...
            // before the Android interaction adapter handles them. Pro UI loads last.
            append("  <script src=\"./js/android-entitlement.js?v=26\"></script>\n")
            append("  <script src=\"./js/android-native.js?v=26\"></script>\n")
            append("  <script src=\"./js/android-review.js?v=26\"></script>\n")
            append("  <script src=\"./js/android-support.js?v=26\"></script>\n")
            append("  <script src=\"./js/android-scan-trust.js?v=26\"></script>\n")
            append("  <script src=\"./js/android-live-scan.js?v=26\"></script>\n")
            append("  <script src=\"./js/android-review-media.js?v=26\"></script>\n")
            append("  <script src=\"./js/android-premium-color.js?v=26\"></script>\n")
            append("  <script src=\"./js/android-pro-ui.js?v=26\"></script>\n")
        }
